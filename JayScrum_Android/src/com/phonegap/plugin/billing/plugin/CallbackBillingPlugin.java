...
import com.jaystack.jayscrum.MainActivity;
...
public class CallbackBillingPlugin extends Plugin {
	...
	private PluginResult _requestPurchase(String productId) {
		try {
			...
			MainActivity.eInstance.startRequestingPurchase(productId, this);
	...
	private PluginResult _getPurchasedItems() {
		...
		try {
			JSONArray items = null;//CallbackBillingActivity.eInstance.getPurchasedItems();
			if (items != null) {
