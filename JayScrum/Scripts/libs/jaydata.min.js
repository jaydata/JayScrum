...
(function(){"undefined"===typeof window&&(window=this);$data=window.$data||(window.$data={})})(this);"undefined"===typeof console&&(console={warn:function(){},error:function(){},log:function(){},dir:function(){},time:function(){},timeEnd:function(){}});console.warn||(console.warn=function(){});console.error||(console.error=function(){});(function(a){a.__namespace=true;a.version="JayData 0.0.0";a.versionNumber="0.0.0";a.root={}})($data);
...
JAYLINT=function(){function a(){return this}function b(){}function c(a){return Db[a]||"\\u"+("0000"+a.charCodeAt().toString(16)).slice(-4)}function d(a){Object.keys(a).forEach(function(b){Q[b]=a[b]})}function f(){if(!k.safe){if(k.rhino){d(Eb);k.rhino=false}if(k.devel){d(Fb);k.devel=false}if(k.browser){d(Gb);k.browser=false}if(k.windows){d(Hb);k.windows=false}if(k.node){d(Ib);k.node=false;La=true}if(k.widget){d(Jb);k.widget=false}}}function i(a,b,c){throw{name:"JSLintError",line:b,character:c,message:H.scanned_a_b.supplant({a:a,
b:Math.floor(b/za.length*100)})};}function e(a,b,c,d,e,j){var f,m,b=b||g;m=b.line||0;f=b.from||0;a={id:"(error)",raw:H[a]||a,evidence:za[m-1]||"",line:m,character:f,a:c||b.value,b:d,c:e,d:j};a.reason=a.raw.supplant(a);JAYLINT.errors.push(a);k.passfail&&i(H.stopping,m,f);Ma=Ma+1;Ma>=k.maxerr&&i(H.too_many,m,f);return a}function j(a,b,c,d,g,j,f){return e(a,{line:b,from:c},d,g,j,f)}function m(a,b,c,d,g,j){a=e(a,b,c,d,g,j);i(H.stopping,a.line,a.character)}function r(a,b,c,d,g,e,j){return m(a,{line:b,
from:c},d,g,e,j)}function o(a){!k.white&&g.from!==a&&e("expected_a_at_b_c",g,g.value,a,g.from)}function z(a,b,c){if(a[b]!==c){e("expected_a_b",a,c,a[b]);return true}return false}function C(a,b,c){c=c||a.value;if(q===X){k.safe&&e("adsafe_a",a,c);if(typeof X[c]!=="string"){a.writeable=typeof Q[c]==="boolean"?Q[c]:true;a.funct=q;Aa[c]=a}b==="becoming"&&(b="var")}else if(typeof q[c]==="string")if(q[c]==="undef"){k.undef||e("used_before_a",a,c);b="var"}else e("already_defined",a,c);else{a.funct=q;a.writeable=
true;E[c]=a}q[c]=b}function s(a){for(var b,c=0,a=a||0;c<=a;){(b=Ba[c])||(b=Ba[c]=Ca.token());c=c+1}return b}function l(a){a=a||n;if(a.comments){for(var b=a.prev;b.comments===null;)b=b.prev;b.comments=b.comments?b.comments.concat(a.comments):a.comments}a.comments=null}function h(a,b){if(v){if(ea&&g.line!==n.line){if((ea!==v||!g.edge)&&g.from===v.at-(g.edge?k.indent:0)){for(var c=v;;){c.at=c.at-k.indent;if(c===ea)break;c=c.was}c.open=false}ea=null}if(v.open)if(g.edge)g.edge==="label"?o(1):g.edge===
"case"?o(v.at-k.indent):(v.mode!=="array"||g.line!==n.line)&&o(v.at);else{if(g.line!==n.line){g.from<v.at+(v.mode==="expression"?0:k.indent)&&o(v.at+k.indent);v.wrap=true}}else if(g.line!==n.line)if(g.edge)o(v.at);else{v.wrap=true;v.mode==="statement"||v.mode==="var"?o(v.at+k.indent):g.from<v.at+(v.mode==="expression"?0:k.indent)&&o(v.at+k.indent)}}switch(n.id){case "(number)":g.id==="."&&e("trailing_decimal_a");break;case "-":(g.id==="-"||g.id==="--")&&e("confusing_a");break;case "+":(g.id==="+"||
g.id==="++")&&e("confusing_a")}if(n.id==="(string)"||n.identifier)$a=n.value;a&&g.id!==a&&(b?e("expected_a_b_from_c_d",g,a,b.id,b.line,g.value):(!g.identifier||g.value!==a)&&e("expected_a_b",g,a,g.value));U=n;n=g;g=Ba.shift()||Ca.token();n.id==="(end)"&&l()}function fa(){if(k.adsafe)k.safe=true;if(k.safe){k.browser=k["continue"]=k.css=k.debug=k.devel=k.evil=k.forin=k.newcap=k.nomen=k.on=k.rhino=k.sloppy=k.sub=k.undef=k.widget=k.windows=false;delete Q.Array;delete Q.Date;delete Q.Function;delete Q.Object;
delete Q.eval;d({ADSAFE:false,lib:false})}}function ga(){var a=this.id,b=Da;g.line===n.line&&g.from===n.thru&&e("missing_space_a_b",g,n.value,g.value);Da=true;k.white=true;(Ba.length>0||g.comments)&&e("unexpected_a",this);switch(a){case "/*properties":case "/*property":case "/*members":case "/*member":a:for(ha||(ha={});;){if(g.id!=="(string)"&&!g.identifier)break a;ha[g.value]=true;h();if(g.id!==",")break a;h(",")}break;case "/*jslint":for(k.safe&&e("adsafe_a",this);g.id==="(string)"||g.identifier;){a=
g.value;h();g.id!==":"&&m("expected_a_b",g,":",g.value);h(":");switch(a){case "indent":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&m("expected_small_a");k.indent=a;break;case "maxerr":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<=0||Math.floor(a)!==a)&&m("expected_small_a",g);k.maxerr=a;break;case "maxlen":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&m("expected_small_a");k.maxlen=a;break;default:g.id==="true"?k[a]=true:g.id==="false"?k[a]=
false:m("unexpected_a");if(a==="adsafe"){k.adsafe=k.safe=true;fa()}else a==="safe"&&fa()}h();g.id===","&&h(",")}f();break;case "/*globals":case "/*global":k.safe&&e("adsafe_a",this);a:for(var c;;){if(g.id!=="(string)"&&!g.identifier)break a;a=g.value;h();c=false;if(g.id===":"){h(":");switch(g.id){case "true":c=Q[a]!==false;h("true");break;case "false":h("false");break;default:m("unexpected_a")}}Q[a]=c;if(g.id!==",")break a;h(",")}break;default:m("unpexpected_a",this)}Da=b;h("*/")}function x(a){g.edge=
!v||v.open&&(a||true)}function K(a){var b,c;if(typeof a==="number")v={at:a,open:true,was:c};else if(v){c=v;b=a==="var"||g.line!==n.line&&a!=="statement";v={at:(b||a==="control"?c.at+k.indent:c.at)+(c.wrap?k.indent:0),mode:a,open:b,was:c};a==="var"&&b&&(ea=v)}else v={at:1,mode:"statement",open:true}}function A(a,b){if(a){if(v&&v.open){v.at=v.at-k.indent;x()}h(a,b)}if(v)v=v.was}function y(a,b){b=b||g;b.id!=="(end)"&&!k.white&&(n.line!==b.line||n.thru+1!==b.from)&&e("expected_space_a_b",b,n.value,b.value)}
function ua(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!k.white&&a.thru+1!==b.from)&&e("expected_space_a_b",b,a.value,b.value)}function u(a,b){a=a||n;b=b||g;(!k.white||t==="styleproperty"||t==="style")&&a.thru!==b.from&&a.line===b.line&&e("unexpected_space_a_b",b,a.value,b.value)}function B(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!k.white&&a.thru!==b.from)&&e("unexpected_space_a_b",b,a.value,b.value)}function J(a,b){if(!k.white){a=a||n;b=b||g;a.thru===b.from&&a.line===b.line&&
e("missing_space_a_b",b,a.value,b.value)}}function G(){if(g.id!==",")j("expected_a_b",n.line,n.thru,",",g.value);else{k.white||B();h(",");l();J()}}function V(){if(g.id!==";")j("expected_a_b",n.line,n.thru,";",g.value);else{k.white||B();h(";");l();Kb[g.id]!==true&&J()}}function Na(){if(g.value==="use strict"){na&&e("unnecessary_use");x();h();V();na=true;k.newcap=false;k.undef=false;return true}return false}function S(a,b){if(a===b)return true;if(Array.isArray(a)){if(Array.isArray(b)&&a.length===b.length){var c;
...
b.second.value&&b.second.id==="(string)";if(a.id==="["&&a.arity==="infix"&&b.id===".")return a.second.value===b.second.value&&a.second.id==="(string)"}return false}function w(a,b){var c;g.id==="(end)"&&m("unexpected_a",n,g.id);h();k.safe&&E[n.value]&&E[n.value]===Aa[n.value]&&g.id!=="("&&g.id!=="."&&e("adsafe",n);if(b){$a="anonymous";q["(verb)"]=n.value}if(b===true&&n.fud)c=n.fud();else{if(n.nud)c=n.nud();else{if(g.id==="(number)"&&n.id==="."){e("leading_decimal_a",n,g.value);h();return n}m("expected_identifier_a",
n,n.id)}for(;a<g.lbp;){h();n.led?c=n.led(c):m("expected_operator_a",n,n.id)}}return c}function Ea(a,b){var c=Y[a];if(!c||typeof c!=="object")Y[a]=c={id:a,lbp:b,value:a};return c}function M(a){return Ea(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Ea(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;a.value=a;return oa(b)}function R(a,b){var c=M(a);c.identifier=c.reserved=true;c.fud=b;return c}function Oa(a,b){R(a,b).labeled=true}function Pa(a,b){R(a,b).disrupt=true}function rb(a){var b=
a.id.charAt(0);if(b>="a"&&b<="z"||b>="A"&&b<="Z")a.identifier=a.reserved=true;return a}function P(a,b,c){var d=Ea(a,150);rb(d);d.nud=typeof b==="function"?b:function(){a==="typeof"?y():B();this.first=w(150);this.arity="prefix";if(this.id==="++"||this.id==="--")k.plusplus?(!this.first.identifier||this.first.reserved)&&this.first.id!=="."&&this.first.id!=="["&&e("bad_operand",this):e("unexpected_a",this);this.type=c;return this};return d}function ia(a,b,c){a=M(a);a.arity=a.type=b;if(c)a.nud=c;return a}
function bb(a){return(a=a.identifier&&E[a.value]||a)&&a.type}function L(a,b,c){var d="",g,j,f;if(typeof a!=="string"){j=a.identifier&&E[a.value]||a;a=j.type}f=b.identifier&&E[b.value]||b;g=f.type;if(a)g?a===g?d=a:k.type||e("type_inconsistency_a_b",c||b,a,g):f.type=d=a;else if(g){if(j)j.type=g;d=g}return d}function F(a,b){var c=M(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function va(b,c,d){b=F(b);b.type=c;b.value=d;b.nud=a;return b}function cb(a,b){return F(a,function(){typeof b===
"function"&&b(this);return this})}function N(a,b,c,d,g){a=Ea(a,b);rb(a);a.led=function(a){this.arity="infix";if(!g){J(U,n);J()}!k.bitwise&&this.bitwise&&e("unexpected_a",this);if(typeof c==="function")return c(a,this);this.first=a;this.second=w(b);return this};if(d)a.type=d;return a}function aa(a,b){a.assign&&e(b||H.conditional_assignment,a);return a}function ba(a,b){switch(a.id){case "[":case "-":a.arity!=="infix"&&e(b||H.weird_condition,a);break;case "false":case "function":case "Infinity":case "NaN":case "null":case "true":case "undefined":case "void":case "(number)":case "(regexp)":case "(string)":case "{":e(b||
H.weird_condition,a);break;case "(":a.first.id==="."&&Lb[a.first.second.value]===true&&e(b||H.weird_condition,a)}return a}function sb(a){switch(a.arity){case "prefix":switch(a.id){case "{":case "[":e("unexpected_a",a);break;case "!":e("confusing_a",a)}break;case "function":case "regexp":e("unexpected_a",a);break;default:a.id==="NaN"&&e("isnan",a)}return a}function ka(a,b){return N(a,100,function(a,c){sb(a);b&&!k.eqeq&&e("expected_a_b",c,b,c.id);var d=w(100);(S(a,d)||(a.id==="(string)"||a.id==="(number)")&&
(d.id==="(string)"||d.id==="(number)"))&&e("weird_relation",c);c.first=a;c.second=sb(d);L(a,c.second,c);return c},"boolean")}function Z(a,b){var c=N(a,20,function(a,b){var c;b.first=a;if(a.identifier)E[a.value]?E[a.value].writeable===false&&e("read_only",a):m("read_only");else if(k.safe){c=a;do{typeof Q[c.value]==="boolean"&&e("adsafe",c);c=c.first}while(c)}a===Y["function"]&&e("identifier_function",n);if(a.id==="."||a.id==="["){(!a.first||a.first.value==="arguments")&&e("bad_assignment",b);b.second=
w(19);b.id==="="&&S(b.first,b.second)&&e("weird_assignment",b)}else if(a.identifier&&!a.reserved){q[a.value]==="exception"&&e("assign_exception",a);b.second=w(19);b.id==="="&&S(b.first,b.second)&&e("weird_assignment",b);if(b.type){L(a,b);L(b,b.second,b)}else L(a,b.second,b)}return b});c.assign=true;if(b){if(Y[b].type)c.type=Y[b].type;if(Y[b].bitwise)c.bitwise=true}return c}function wa(a,b){var c=N(a,b,"number");c.bitwise=true;return c}function tb(a){a=Ea(a,150);a.led=function(a){B(U,n);k.plusplus?
(!a.identifier||a.reserved)&&a.id!=="."&&a.id!=="["&&e("bad_operand",this):e("unexpected_a",this);this.first=a;this.arity="suffix";return this};return a}function pa(){if(g.identifier){h();k.safe&&Qa[n.value]?e("adsafe_a",n):n.reserved&&!k.es5&&e("expected_identifier_a_reserved",n);return n.value}}function db(){var a,b=E;if(g.id===";"){e("unexpected_a");V()}else{if(g.identifier&&!g.reserved&&s().id===":"){x("label");a=g;h();l();h(":");l();E=Object.create(b);C(a,"label");g.labeled!==true?e("label_a_b",
g,a.value,g.value):eb.test(a.value+":")?e("url",a):q===X&&m("unexpected_a",n);g.label=a}x();K("statement");if(a=w(0,true))if(a.arity==="statement")a.id==="switch"||a.block&&a.id!=="do"?J():V();else{a.id==="("?a.first.id==="new"&&e("bad_new"):!a.assign&&a.id!=="delete"&&a.id!=="++"&&a.id!=="--"&&e("assignment_function_expression",n);V()}A();E=b;return a}}function qa(){for(var a=[],b,c;g.postscript!==true;)if(g.id===";"){e("unexpected_a",g);V()}else{if(g.value==="use strict"){(!La||q!==X||a.length>
0)&&e("function_strict");Na()}if(b){e("unreachable_a_b",g,g.value,b.value);b=null}if(c=db()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ca(a){var b,c=g,d=Fa,j=E,f=na;Fa=a;E=Object.create(E);J();if(g.id==="{"){h("{");K();!a&&!Na()&&!f&&!k.sloppy&&q["(context)"]===X&&e("missing_use_strict");b=qa();na=f;A("}",c);l()}else if(a){e("expected_a_b",g,"{",g.value);b=[db()];b.disrupt=b[0].disrupt}else m("expected_a_b",g,"{",g.value);q["(verb)"]=null;E=j;Fa=d;a&&b.length===0&&e("empty_block");
return b}function Ra(a){ha&&typeof ha[a]!=="boolean"&&e("unexpected_property_a",n,a);ra[a]=typeof ra[a]==="number"?ra[a]+1:1}function fb(){var a=pa(true);if(!a)if(g.id==="(string)"){a=g.value;k.safe&&(Qa[a]?e("adsafe_a"):(a.charAt(0)==="_"||a.charAt(a.length-1)==="_")&&e("dangling_a"));h()}else if(g.id==="(number)"){a=g.value.toString();h()}return a}function I(a){var b=0;if(a)if(Array.isArray(a))a.forEach(function(a){b=b+I(a)});else switch(a.arity){case "statement":switch(a.id){case "if":b=b+(I(a.first)+
...
b+I(a.first);break;case "case":case "infix":b=b+(I(a.first)+I(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(I(a.first)+I(a.second)+I(a.third))}return b}function Sa(a,b){var d=q,e=k,j=ha,f=E;q={"(name)":b||"'"+($a||"").replace(ub,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":E,"(token)":a};ha=j&&Object.create(j);k=Object.create(e);E=Object.create(f);Ta.push(q);(a.name=b)&&C(a,"function",b);a.writeable=false;var i=q,m;a:{var r=g,o=[];h("(");K();
l();u();if(g.id===")"){u();A(")",r);l();m=void 0}else for(;;){x();pa();o.push(n);C(n,k.unparam?"parameter":"unparam");if(g.id===",")G();else{u();A(")",r);l();m=o;break a}}}a.first=i["(params)"]=m;a.type="function";y();a.block=ca(false);q["(complexity)"]=I(a.block)+1;q=d;k=e;ha=j;E=f}function gb(){function a(){var b=g,c={};h("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){e("unexpected_a",g);G()}g.id!=="(string)"&&e("expected_string_a");c[g.value]===true?e("duplicate_a"):g.value==="__proto__"?
e("dangling_a"):c[g.value]=true;h();h(":");gb();if(g.id!==",")break;G();if(g.id==="}"){e("unexpected_a",n);break}}h("}",b)}function b(){var a=g;h("[");if(g.id!=="]")for(;g.id!=="(end)";){for(;g.id===",";){e("unexpected_a",g);G()}gb();if(g.id!==",")break;G();if(g.id==="]"){e("unexpected_a",n);break}}h("]",a)}switch(g.id){case "{":a();break;case "[":b();break;case "true":case "false":case "null":case "(number)":case "(string)":h();break;case "-":h("-");B();h("(number)");break;default:m("unexpected_a")}}
function hb(){if(g.identifier){h();return true}}function Ua(){if(g.id==="-"){h("-");B()}if(g.id==="(number)"){h("(number)");return true}}function ib(){if(g.id==="(string)"){h();return true}}function ja(){var a,b,c,d;if(g.identifier){d=g.value;if(d==="rgb"||d==="rgba"){h();c=g;h("(");for(a=0;a<3;a=a+1){a&&G();b=g.value;if(g.id!=="(string)"||b<0){e("expected_positive_a",g);h()}else{h();if(g.id==="%"){h("%");b>100&&e("expected_percent_a",n,b)}else b>255&&e("expected_small_a",n,b)}}if(d==="rgba"){G();
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&e("expected_fraction_a",g);h();if(g.id==="%"){e("unexpected_a");h("%")}}h(")",c);return true}if(Mb[g.value]===true){h();return true}}else if(g.id==="(color)"){h();return true}return false}function D(){if(g.id==="-"){h("-");B()}if(g.id==="(number)"){h();if(g.id!=="(string)"&&vb[g.value]===true){B();h()}else+n.value!==0&&e("expected_linear_a");return true}return false}function xa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":h();return true}else return D()}
function Ga(){if(g.identifier){if(g.value==="auto"){h();return true}}else return D()}function sa(){var a,b;if(g.identifier&&g.value==="url"){g=Ca.range("(",")");b=g.value;a=b.charAt(0);if(a==='"'||a==="'")if(b.slice(-1)!==a)e("bad_url");else{b=b.slice(1,-1);b.indexOf(a)>=0&&e("bad_url")}b||e("missing_url");k.safe&&wb.test(b)&&m("adsafe_a",g,b);Ha.push(b);h();return true}return false}function jb(a){var b=0,c,d,e,j=0;switch(typeof a){case "function":return a();case "string":if(g.identifier&&g.value===
a){h();return true}return false}for(;;){if(b>=a.length)return false;e=a[b];b=b+1;if(typeof e==="boolean")break;else if(typeof e==="number"){c=e;e=a[b];b=b+1}else c=1;for(d=false;c>0;)if(jb(e)){d=true;c=c-1}else break;if(d)return true}j=b;for(c=[];;){e=false;for(b=j;b<a.length;b=b+1)if(!c[b]&&jb(Va[a[b]])){e=d=true;c[b]=true;break}if(!e)return d}}function xb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){e("unexpected_a");V()}for(a=void 0;g.id==="*"||g.id==="#"||
g.value==="_";){k.css||e("unexpected_a");h()}if(g.id==="-"){k.css||e("unexpected_a");h("-");g.identifier||e("expected_nonstandard_style_attribute");h();a=kb}else{if(g.identifier)if(Object.prototype.hasOwnProperty.call(Va,g.value))a=Va[g.value];else{a=kb;k.css||e("unrecognized_style_attribute_a")}else e("expected_style_attribute");h()}h(":");if(g.identifier&&g.value==="inherit")h();else if(!jb(a)){e("unexpected_a");h()}if(g.id==="!"){h("!");B();g.identifier&&g.value==="important"?h():e("expected_a_b",
g,"important",g.value)}g.id==="}"||g.id===T?e("expected_a_b",g,";",g.value):V()}}function lb(){if(g.identifier){Object.prototype.hasOwnProperty.call(mb,k.cap?g.value.toLowerCase():g.value)||e("expected_tagname_a");h()}else switch(g.id){case ">":case "+":h();lb();break;case ":":h(":");switch(g.value){case "active":case "after":case "before":case "checked":case "disabled":case "empty":case "enabled":case "first-child":case "first-letter":case "first-line":case "first-of-type":case "focus":case "hover":case "last-child":case "last-of-type":case "link":case "only-of-type":case "root":case "target":case "visited":h();
break;case "lang":h();h("(");g.identifier||e("expected_lang_a");h(")");break;case "nth-child":case "nth-last-child":case "nth-last-of-type":case "nth-of-type":h();h("(");if(g.id==="(number)"){h();if(g.value==="n"&&g.identifier){B();h();if(g.id==="+"){B();h("+");B();h("(number)")}}}else g.identifier&&(g.value==="odd"||g.value==="even")?h():e("unexpected_a");h(")");break;case "not":h();h("(");g.id===":"&&s(0).value==="not"&&e("not");lb();h(")");break;default:e("expected_pseudo_a")}break;case "#":h("#");
g.identifier||e("expected_id_a");h();break;case "*":h("*");break;case ".":h(".");g.identifier||e("expected_class_a");h();break;case "[":h("[");g.identifier||e("expected_attribute_a");h();if(g.id==="="||g.value==="~="||g.value==="$="||g.value==="|="||g.id==="*="||g.id==="^="){h();g.id!=="(string)"&&e("expected_string_a");h()}h("]");break;default:m("expected_selector_a")}}function yb(){for(;g.id!=="</"&&g.id!=="(end)";){a:for(g.id==="{"&&e("expected_style_pattern");;){lb();if(g.id==="</"||g.id==="{"||
g.id==="(end)")break a;g.id===","&&G()}t="styleproperty";if(g.id===";")V();else{h("{");xb();t="style";h("}")}}}function zb(){for(;g.id==="@";){s();h("@");if(g.identifier)switch(g.value){case "import":h();if(!sa()){e("expected_a_b",g,"url",g.value);h()}V();break;case "media":for(h();;){(!g.identifier||Ab[g.value]===true)&&m("expected_media_a");h();if(g.id!==",")break;G()}h("{");yb();h("}");break;default:e("expected_at_a")}else e("expected_at_a")}yb()}var W,Ia,Ja,la,$a,Wa,Nb={"<":true,"<=":true,"==":true,
...
function(){return this>="a"&&this<="z\uffff"||this>="A"&&this<="Z\uffff"};if(typeof String.prototype.isDigit!=="function")String.prototype.isDigit=function(){return this>="0"&&this<="9"};if(typeof String.prototype.supplant!=="function")String.prototype.supplant=function(a){return this.replace(/\{([^{}]*)\}/g,function(b,c){var d=a[c];return typeof d==="string"||typeof d==="number"?d:b})};Ca=function(){function a(b,c,d,g){c={comment:b,quote:c,at:g,line:d};Da||qb||t&&t!=="script"&&t!=="style"&&t!=="styleproperty"?
j("unexpected_comment",d,e):t==="script"&&/<\//i.test(l)?j("unexpected_a",d,e,"</"):k.safe&&Sb.test(b)&&j("dangerous_comment",d,g);ta.comments?ta.comments.push(c):ta.comments=[c];JAYLINT.comments.push(c)}function b(){var a;if(h>=za.length)return false;e=1;l=za[h];h=h+1;a=l.search(/ \t/);a>=0&&j("mixed",h,a+1);l=l.replace(/\t/g,Za);a=l.search(Vb);a>=0&&j("unsafe",h,a);k.maxlen&&k.maxlen<l.length&&j("too_long",h,l.length);return true}function c(a,b,d){var g;(a==="(string)"||a==="(range)")&&eb.test(b)&&
j("url",h,i);g=Object.create(Y[a==="(punctuator)"||a==="(identifier)"&&Object.prototype.hasOwnProperty.call(Y,b)?b:a]||Y["(error)"]);if(a==="(identifier)"){g.identifier=true;b==="__iterator__"||b==="__proto__"?r("reserved_a",h,i,b):!k.nomen&&(b.charAt(0)==="_"||b.charAt(b.length-1)==="_")&&j("dangling_a",h,i,b)}if(b!==void 0)g.value=b;if(d)g.quote=d;g.line=h;g.from=i;g.thru=e;g.prev=ta;pb=(a=g.id)&&("(,=:[!&|?{};".indexOf(a.charAt(a.length-1))>=0||a==="return");return ta=ta.next=g}function d(a){function g(a){var b=
parseInt(l.substr(p+1,a),16);p=p+a;b>=32&&b<=126&&b!==34&&b!==92&&b!==39&&j("unexpected_a",h,e,"\\");e=e+a;f=String.fromCharCode(b)}var f,p,m="";ma&&a!=='"'&&j("expected_a",h,e,'"');if(T===a||t==="scriptstring"&&!T)return c("(punctuator)",a);for(p=0;;){for(;p>=l.length;){p=0;(t!=="html"||!b())&&r("unclosed",h,i)}f=l.charAt(p);if(f===a){e=e+1;l=l.slice(p+1);return c("(string)",m,a)}if(f<" "){if(f==="\n"||f==="\r")break;j("control_a",h,e+o,l.slice(0,o))}else if(f===T)j("bad_html",h,e+p);else if(f===
"<")k.safe&&t==="html"?j("adsafe_a",h,e+o,f):l.charAt(o+1)==="/"&&(t||k.safe)?j("expected_a_b",h,e,"<\\/","</"):l.charAt(o+1)==="!"&&(t||k.safe)&&j("unexpected_a",h,e,"<!");else if(f==="\\")if(t==="html")k.safe&&j("adsafe_a",h,e+o,f);else if(t==="styleproperty"){p=p+1;e=e+1;f=l.charAt(p);f!==a&&j("unexpected_a",h,e,"\\")}else{p=p+1;e=e+1;f=l.charAt(p);switch(f){case "":k.es5||j("es5",h,e);b();p=-1;break;case T:j("bad_html",h,e+p);break;case "'":ma&&j("unexpected_a",h,e,"\\'");break;case "u":g(4);
break;case "v":ma&&j("unexpected_a",h,e,"\\v");f="\v";break;case "x":ma&&j("unexpected_a",h,e,"\\x");g(2);break;default:f=Ob[f];typeof f!=="string"&&j("unexpected_a",h,e,"\\")}}m=m+f;e=e+1;p=p+1}}function g(){for(var a,b,d=0,p=0;;){a=true;f=l.charAt(p);p=p+1;switch(f){case "":r("unclosed_regexp",h,i);return;case "/":d>0&&j("unescaped_a",h,i+p,"/");f=l.slice(0,p-1);for(d=Object.create(Pb);d[l.charAt(p)]===true;){d[l.charAt(p)]=false;p=p+1}l.charAt(p).isAlpha()&&r("unexpected_a",h,i,l.charAt(p));e=
e+p;l=l.slice(p);p=l.charAt(0);(p==="/"||p==="*")&&r("confusing_regexp",h,i);return c("(regexp)",f);case "\\":f=l.charAt(p);f<" "?j("control_a",h,i+p,""+f):f==="<"&&j(H.unexpected_a,h,i+p,"\\");p=p+1;break;case "(":d=d+1;a=false;if(l.charAt(p)==="?"){p=p+1;switch(l.charAt(p)){case ":":case "=":case "!":p=p+1;break;default:j(H.expected_a_b,h,i+p,":",l.charAt(p))}}break;case "|":a=false;break;case ")":d===0?j("unescaped_a",h,i+p,")"):d=d-1;break;case " ":for(o=1;l.charAt(p)===" ";){p=p+1;o=o+1}o>1&&
j("use_braces",h,i+p,o);break;case "[":f=l.charAt(p);if(f==="^"){p=p+1;k.regexp?l.charAt(p)==="]"&&r("unescaped_a",h,i+p,"^"):j("insecure_a",h,i+p,f)}b=false;if(f==="]"){j("empty_class",h,i+p-1);b=true}a:do{f=l.charAt(p);p=p+1;switch(f){case "[":case "^":j("unescaped_a",h,i+p,f);b=true;break;case "-":if(b)b=false;else{j("unescaped_a",h,i+p,"-");b=true}break;case "]":b||j("unescaped_a",h,i+p-1,"-");break a;case "\\":f=l.charAt(p);f<" "?j(H.control_a,h,i+p,""+f):f==="<"&&j(H.unexpected_a,h,i+p,"\\");
p=p+1;b=true;break;case "/":j("unescaped_a",h,i+p-1,"/");b=true;break;case "<":if(t==="script"){f=l.charAt(p);(f==="!"||f==="/")&&j(H.html_confusion_a,h,i+p,f)}b=true;break;default:b=true}}while(f);break;case ".":k.regexp||j("insecure_a",h,i+p,f);break;case "]":case "?":case "{":case "}":case "+":case "*":j("unescaped_a",h,i+p,f);break;case "<":if(t==="script"){f=l.charAt(p);(f==="!"||f==="/")&&j(H.html_confusion_a,h,i+p,f)}}if(a)switch(l.charAt(p)){case "?":case "+":case "*":p=p+1;l.charAt(p)===
"?"&&(p=p+1);break;case "{":p=p+1;f=l.charAt(p);(f<"0"||f>"9")&&j(H.expected_number_a,h,i+p,f);p=p+1;for(b=+f;;){f=l.charAt(p);if(f<"0"||f>"9")break;p=p+1;b=+f+b*10}a=b;if(f===","){p=p+1;a=Infinity;f=l.charAt(p);if(f>="0"&&f<="9"){p=p+1;for(a=+f;;){f=l.charAt(p);if(f<"0"||f>"9")break;p=p+1;a=+f+a*10}}}l.charAt(p)!=="}"?j(H.expected_a_b,h,i+p,"}",f):p=p+1;l.charAt(p)==="?"&&(p=p+1);b>a&&j(H.not_greater,h,i+p,b,a)}}f=l.slice(0,p-1);e=e+p;l=l.slice(p);return c("(regexp)",f)}var e,f,i,m,h,o,l;return{init:function(a){za=
typeof a==="string"?a.replace(Ub,"\n").replace(Tb,"\n").split("\n"):a;h=0;b();i=1},range:function(a,b){var d,g="";i=e;for(l.charAt(0)!==a&&r("expected_a_b",h,e,a,l.charAt(0));;){l=l.slice(1);e=e+1;d=l.charAt(0);switch(d){case "":r("missing_a",h,e,d);break;case b:l=l.slice(1);e=e+1;return c("(range)",g);case T:case "\\":j("unexpected_a",h,e,d)}g=g+d}},token:function(){for(var o,k,s;;){for(;!l;)if(!b())return c("(end)");for(;t==="outer";){k=l.search(Yb);if(k===0)break;else if(k>0){e=e+1;l=l.slice(k);
break}else if(!b())return c("(end)","")}o=(ac[t]||$b).exec(l);s=void 0;if(o){m=o[0].length;s=o[1];f=s.charAt(0);l=l.slice(m);i=e+m-s.length;e=e+m}else s=void 0;if(s){o=s.charAt(0);if(o.isAlpha()||o==="_"||o==="$")return c("(identifier)",s);if(o.isDigit()){k=s;o=void 0;t!=="style"&&t!=="styleproperty"&&l.charAt(0).isAlpha()&&j("expected_space_a_b",h,e,f,l.charAt(0));if(f==="0"){o=k.charAt(1);o.isDigit()?n.id!=="."&&t!=="styleproperty"&&j("unexpected_a",h,e,k):ma&&(o==="x"||o==="X")&&j("unexpected_a",
h,e,"0x")}k.slice(k.length-1)==="."&&j("trailing_decimal_a",h,e,k);if(t!=="style"){o=+k;isFinite(o)||j("bad_number",h,e,k);k=o}return c("(number)",k)}switch(s){case '"':case "'":return d(s);case "//":a(l,"//",h,e);l="";break;case "/*":for(o="/*";;){k=l.search(Xb);if(k>=0)break;a(l,o,h,e);o="";b()||r("unclosed_comment",h,e)}a(l.slice(0,k),o,e,h);e=e+(k+2);l.charAt(k)==="/"&&r("nested_comment",h,e);l=l.slice(k+2);break;case "":break;case "/":n.id==="/="&&r(H.slash_equal,h,i);return pb?g():c("(punctuator)",
s);case "<\!--":for(m=h;;){k=l.indexOf("--");if(k>=0)break;k=l.indexOf("<!");k>=0&&r("nested_comment",h,e+k);b()||r("unclosed_comment",m,o)}m=l.indexOf("<!");m>=0&&m<k&&r("nested_comment",h,e+m);e=e+k;l.charAt(k+2)!==">"&&r("expected_a",h,e,"--\>");e=e+3;l=l.slice(k+3);break;case "#":if(t==="html"||t==="styleproperty"){for(;;){o=l.charAt(0);if((o<"0"||o>"9")&&(o<"a"||o>"f")&&(o<"A"||o>"F"))break;e=e+1;l=l.slice(1);s=s+o}s.length!==4&&s.length!==7&&j("bad_color_a",h,i+m,s);return c("(color)",s)}return c("(punctuator)",
s);default:if(t==="outer"&&o==="&"){e=e+1;for(l=l.slice(1);;){o=l.charAt(0);e=e+1;l=l.slice(1);if(o===";")break;o>="0"&&o<="9"||o>="a"&&o<="z"||o==="#"||r("bad_entity",h,i+m,e)}break}return c("(punctuator)",s)}}else{for(;l&&l<"!";)l=l.slice(1);if(l){if(t==="html")return c("(error)",l.charAt(0));r("unexpected_a",h,e,l.charAt(0))}}}}}}();Y["(identifier)"]={lbp:0,identifier:true,nud:function(){var a=this.value,b=E[a];if(typeof b!=="object"){b=Q[a];if(typeof b==="boolean"){Aa[a]=b={value:a,writeable:b,
funct:X};X[a]="var"}else{k.undef||e("used_before_a",n);E[a]=b={value:a,writeable:true,funct:q};q[a]="undef"}}b=b.funct;if(q===b)switch(q[a]){case "becoming":e("unexpected_a",n);q[a]="var";break;case "unused":q[a]="var";break;case "unparam":q[a]="parameter";break;case "unction":q[a]="function";break;case "label":e("a_label",n,a)}else switch(q[a]){case "closure":case "function":case "var":case "unused":e("a_scope",n,a);break;case "label":e("a_label",n,a);break;case "outer":case "global":break;default:switch(b[a]){case "function":case "unction":case "var":case "unused":case "becoming":case "closure":case "parameter":b[a]=
"closure";q[a]=b===X?"global":"outer";break;case "unparam":b[a]="parameter";q[a]="outer";break;case "undef":q[a]="undef";break;case "label":e("a_label",n,a)}}return this},led:function(){m("expected_operator_a")}};ia("(array)","array");ia("(color)","color");ia("(function)","function");ia("(number)","number",a);ia("(object)","object");ia("(string)","string",a);ia("(boolean)","boolean",a);ia("(range)","range");ia("(regexp)","regexp",a);ab("(begin)");ab("(end)");ab("(error)");oa(M("</"));M("<!");M("<\!--");
M("--\>");oa(M("}"));M(")");M("]");oa(M('"'));oa(M("'"));M(";");M(":");M(",");M("#");M("@");M("*/");oa(F("case"));F("catch");oa(F("default"));F("else");F("finally");cb("arguments",function(a){na&&q===X?e("strict",a):k.safe&&e("adsafe",a)});cb("eval",function(a){k.safe&&e("adsafe",a)});va("false","boolean",false);va("Infinity","number",Infinity);va("NaN","number",NaN);va("null","",null);cb("this",function(a){na&&(q["(statement)"]&&q["(name)"].charAt(0)>"Z"||q===X)?e("strict",a):k.safe&&e("adsafe",
a)});va("true","boolean",true);va("undefined","",void 0);N("?",30,function(a,b){b.first=ba(aa(a));b.second=w(0);J();var c=g;h(":");l();J();b.third=w(10);b.arity="ternary";b.type=L(b.second,b.third);S(b.second,b.third)?e("weird_ternary",c):S(b.first,b.second)&&e("use_or",b);return b});N("||",40,function(a,b){function c(a){a.id==="&&"&&!a.paren&&e("and",a);return a}b.first=c(ba(aa(a)));b.second=c(aa(w(40)));S(b.first,b.second)&&e("weird_condition",b);return b});N("&&",50,function(a,b){b.first=ba(aa(a));
b.second=aa(w(50));S(b.first,b.second)&&e("weird_condition",b);return b});P("void",function(){this.first=w(0);if(this.first.id!=="(number)"||this.first.value){e("unexpected_a",this);return this}this.type="undefined";return this});wa("|",70);wa("^",80);wa("&",90);ka("==","===");ka("===");ka("!=","!==");ka("!==");ka("<");ka(">");ka("<=");ka(">=");wa("<<",120);wa(">>",120);wa(">>>",120);N("in",120,function(a,b){e("infix_in",b);b.left=a;b.right=w(130);return b},"boolean");N("instanceof",120,null,"boolean");
N("+",130,function(a,b){a.value||(a.id==="(number)"?e("unexpected_a",a):a.id==="(string)"&&e("expected_a_b",a,"String","''"));var c=w(130);c.value||(c.id==="(number)"?e("unexpected_a",c):c.id==="(string)"&&e("expected_a_b",c,"String","''"));if(a.id===c.id&&(a.id==="(string)"||a.id==="(number)")){a.value=a.value+c.value;a.thru=c.thru;a.id==="(string)"&&eb.test(a.value)&&e("url",a);l(c);l(b);return a}b.first=a;b.second=c;b.type=L(a,c,b);return b});P("+","num");P("+++",function(){e("confusing_a",n);
this.first=w(150);this.arity="prefix";return this});N("+++",130,function(a){e("confusing_a",n);this.first=a;this.second=w(130);return this});N("-",130,function(a,b){(a.id==="(number)"&&a.value===0||a.id==="(string)")&&e("unexpected_a",a);var c=w(130);(c.id==="(number)"&&c.value===0||c.id==="(string)")&&e("unexpected_a",a);if(a.id===c.id&&a.id==="(number)"){a.value=a.value-c.value;a.thru=c.thru;l(c);l(b);return a}b.first=a;b.second=c;return b},"number");P("-");P("---",function(){e("confusing_a",n);
this.first=w(150);this.arity="prefix";return this});N("---",130,function(a){e("confusing_a",n);this.first=a;this.second=w(130);return this});N("*",140,function(a,b){(a.id==="(number)"&&(a.value===0||a.value===1)||a.id==="(string)")&&e("unexpected_a",a);var c=w(140);(c.id==="(number)"&&(c.value===0||c.value===1)||c.id==="(string)")&&e("unexpected_a",c);if(a.id===c.id&&a.id==="(number)"){a.value=a.value*c.value;a.thru=c.thru;l(c);l(b);return a}b.first=a;b.second=c;return b},"number");N("/",140,function(a,
b){(a.id==="(number)"&&a.value===0||a.id==="(string)")&&e("unexpected_a",a);var c=w(140);(c.id==="(number)"&&(c.value===0||c.value===1)||c.id==="(string)")&&e("unexpected_a",c);if(a.id===c.id&&a.id==="(number)"){a.value=a.value/c.value;a.thru=c.thru;l(c);l(b);return a}b.first=a;b.second=c;return b},"number");N("%",140,function(a,b){(a.id==="(number)"&&(a.value===0||a.value===1)||a.id==="(string)")&&e("unexpected_a",a);var c=w(140);(c.id==="(number)"&&c.value===0||c.id==="(string)")&&e("unexpected_a",
c);if(a.id===c.id&&a.id==="(number)"){a.value=a.value%c.value;a.thru=c.thru;l(c);l(b);return a}b.first=a;b.second=c;return b},"number");tb("++");P("++");tb("--");P("--");P("delete",function(){y();var a=w(0);(!a||a.id!=="."&&a.id!=="[")&&e("deleted");this.first=a;return this});P("~",function(){B();k.bitwise||e("unexpected_a",this);w(150);return this},"number");P("!",function(){B();this.first=ba(w(150));this.arity="prefix";Nb[this.first.id]===true&&e("confusing_a",this);return this},"boolean");P("typeof",
null,"string");P("new",function(){y();var a=w(160),b;this.first=a;if(a.id!=="function")if(a.identifier)switch(a.value){case "Object":e("use_object",n);break;case "Array":if(g.id==="("){b=g;b.first=this;h("(");if(g.id!==")"){b.second=w(0);if(b.second.id!=="(string)"||!b.second.value){ba(b.second,H.use_array);a=false}else a=true;for(;g.id!==")"&&g.id!=="(end)";){if(a){e("use_array",b);a=false}h()}}else e("use_array",n);h(")",b);l();return b}e("use_array",n);break;case "Number":case "String":case "Boolean":case "Math":case "JSON":e("not_a_constructor",
a);break;case "Function":k.evil||e("function_eval");break;case "Date":case "RegExp":break;default:if(a.id!=="function"){a=a.value.charAt(0);!k.newcap&&(a<"A"||a>"Z")&&e("constructor_name_a",n)}}else a.id!=="."&&a.id!=="["&&a.id!=="("&&e("bad_constructor",n);else e("weird_new",this);g.id!=="("&&e("missing_a",g,"()");return this});N("(",160,function(a,b){v&&v.mode==="expression"?u(U,n):B(U,n);!a.immed&&a.id==="function"&&e("wrap_immediate");var c=[];if(a){L("function",a);a.identifier?a.value.match(/^[A-Z]([A-Z0-9_$]*[a-z][A-Za-z0-9_$]*)?$/)&&
a.value!=="Number"&&a.value!=="String"&&a.value!=="Boolean"&&a.value!=="Date"&&(a.value==="Math"||a.value==="JSON"?e("not_a_function",a):a.value==="Object"?e("use_object",n):(a.value==="Array"||!k.newcap)&&e("missing_a",a,"new")):a.id==="."&&(k.safe&&a.first.value==="Math"&&a.second==="random"?e("adsafe",a):a.second.value==="split"&&a.first.id==="(string)"&&e("use_array",a.second))}K();if(g.id!==")")for(u();;){x();c.push(w(10));if(g.id!==",")break;G()}u();A(")",b);if(typeof a==="object"){a.value===
...
a)})}else(a.second.value==="toString"||a.second.value==="stringify")&&L("string",b);else a.identifier&&a.value==="String"&&L("string",b);return b},"",true);P("(",function(){K("expression");l();u();x();if(g.id==="function")g.immed=true;var a=w(0);a.paren=true;u();A(")",this);l();a.id==="function"&&(g.id==="("?e("move_invocation"):e("bad_wrap",this));return a});N(".",170,function(a,b){u(U,n);u();var c=pa();typeof c==="string"&&Ra(c);b.first=a;b.second=n;if(a&&a.value==="arguments"&&(c==="callee"||c===
"caller"))e("avoid_a",a,"arguments."+c);else if(!k.evil&&a&&a.value==="document"&&(c==="write"||c==="writeln"))e("write_is_wrong",a);else if(k.adsafe){if(!Ja&&a.value==="ADSAFE")if(c==="id"||c==="lib")e("adsafe",b);else if(c==="go"){t!=="script"?e("adsafe",b):(la||g.id!=="("||s(0).id!=="(string)"||s(0).value!==W||s(1).id!==",")&&m("adsafe_a",b,"go");la=true;Ia=false}Ja=false}if(!k.evil&&(c==="eval"||c==="execScript"))e("evil");else if(k.safe)for(;;){Qa[c]===true&&e("adsafe_a",n,c);if(typeof Q[a.value]!==
"boolean"||g.id==="(")break;if(Rb[c]===true){g.id==="."&&e("adsafe",b);break}if(g.id!=="."){e("adsafe",b);break}h(".");n.first=b;n.second=c;b=n;c=pa();typeof c==="string"&&Ra(c)}c==="length"&&L("number",b);return b},"",true);N("[",170,function(a,b){var c=bb(a),d;B(U,n);u();K();x();d=w(0);switch(bb(d)){case "number":d.id==="(number)"&&a.id==="arguments"&&e("use_param",a);c||L("array",a);break;case "string":if(d.id==="(string)"){if(k.safe&&(Qa[d.value]||d.value.charAt(0)==="_"||d.value.slice(-1)===
"_"))e("adsafe_subscript_a",d);else if(!k.evil&&(d.value==="eval"||d.value==="execScript"))e("evil",d);else if(!k.sub&&Cb.test(d.value)){c=Y[d.value];(!c||!c.reserved)&&e("subscript",d)}Ra(d.value)}else k.safe&&d.id!=="typeof"&&e("adsafe_subscript_a",d);L("object",a);break;case void 0:switch(bb(a)){case "array":L("number",d);break;case "object":L("string",d);break;case "string":k.type||e("use_charAt",b);b.type="string"}k.safe&&e("adsafe_subscript_a",d);break;default:k.safe?e("adsafe_subscript_a",
d):e("bad_type")}A("]",b);l();u(U,n);b.first=a;b.second=d;return b},"",true);P("[",function(){this.arity="prefix";this.first=[];this.type="array";for(K("array");g.id!=="(end)";){for(;g.id===",";){e("unexpected_a",g);h(",");l()}if(g.id==="]")break;v.wrap=false;x();this.first.push(w(10));if(g.id===","){G();if(g.id==="]"&&!k.es5){e("unexpected_a",n);break}}else break}A("]",this);l();return this},170);Z("=");Z("+=","+");Z("-=","-");Z("*=","*");Z("/=","/").nud=function(){m("slash_equal")};Z("%=","%");
Z("&=","&");Z("|=","|");Z("^=","^");Z("<<=","<<");Z(">>=",">>");Z(">>>=",">>>");P("{",function(){var a,b,c,d,f,j={};this.arity="prefix";this.first=[];this.type="object";for(K();g.id!=="}";){v.wrap=false;x();if(g.value==="get"&&s().id!==":"){k.es5||e("es5");a=g;h("get");ua();d=g;(b=fb())||m("missing_property");a.value="";Sa(a);q["(loopage)"]&&e("function_loop",a);(c=a.first)&&e("parameter_a_get_b",c[0],c[0].value,b);G();f=g;f.value="";J();x();h("set");ua();c=fb();b!==c&&m("expected_a_b",n,b,c||g.value);
Sa(f);c=f.first;!c||c.length!==1?m("parameter_set_a",f,"value"):c[0].value!=="value"&&m("expected_a_b",c[0],"value",c[0].value);d.first=[a,f]}else{d=g;b=fb();typeof b!=="string"&&m("missing_property");h(":");l();J();d.first=w(10)}this.first.push(d);j[b]===true&&e("duplicate_a",g,b);j[b]=true;Ra(b);if(g.id!==",")break;for(;;){G();if(g.id!==",")break;e("unexpected_a",g)}g.id==="}"&&!k.es5&&e("unexpected_a",n)}A("}",this);l();return this});R("{",function(){l();e("statement_block");this.arity="statement";
this.block=qa();this.disrupt=this.block.disrupt;h("}",this);l();return this});R("/*global",ga);R("/*globals",ga);R("/*jslint",ga);R("/*member",ga);R("/*members",ga);R("/*property",ga);R("/*properties",ga);R("var",function(){var a,b,c;q["(vars)"]&&!k.vars?e("combine_var"):q!==X&&(q["(vars)"]=true);this.arity="statement";this.first=[];for(K("var");;){c=g;b=pa();C(c,"becoming");if(g.id==="="){a=g;a.first=c;J();h("=");J();g.id==="undefined"&&e("unnecessary_initialize",n,b);s(0).id==="="&&g.identifier&&
m("var_a_not");a.second=w(0);a.arity="infix";this.first.push(a);if(a.second.type)c.type=a.second.type}else this.first.push(c);q[b]==="becoming"&&(q[b]="unused");if(g.id!==",")break;G();v.wrap=false;if(ea&&g.line===n.line&&this.first.length===1){ea=null;v.open=false;v.at=v.at-k.indent}J();x()}ea=null;A();return this});R("function",function(){y();Fa&&e("function_block",n);var a=g,b=pa();C(a,"unction");u();Sa(this,b);g.id==="("&&g.line===n.line&&m("function_statement");this.arity="statement";return this});
P("function",function(){y();var a=pa();a?u():a="";Sa(this,a);q["(loopage)"]&&e("function_loop");this.arity="function";return this});R("if",function(){var a=g;y();h("(");K("control");l();u();x();this.arity="statement";this.first=ba(aa(w(0)));u();A(")",a);l();y();this.block=ca(true);if(g.id==="else"){y();h("else");l();y();this["else"]=g.id==="if"||g.id==="switch"?db(true):ca(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});R("try",function(){var a,b,c;k.adsafe&&e("adsafe_a",
this);y();this.arity="statement";this.block=ca(false);if(g.id==="catch"){y();h("catch");l();y();c=g;h("(");K("control");l();u();x();b=E;E=Object.create(b);this.first=a=g.value;g.identifier?C(g,"exception"):e("expected_identifier_a",g);h();u();A(")",c);l();y();this.second=ca(false);E=b}if(g.id==="finally"){l();y();h("finally");l();y();this.third=ca(false)}else this.second||m("expected_a_b",g,"catch",g.value);return this});Oa("while",function(){y();var a=g;q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=
q["(loopage)"]+1;h("(");K("control");l();u();x();this.arity="statement";this.first=aa(w(0));this.first.id!=="true"&&ba(this.first,H.unexpected_a);u();A(")",a);l();y();this.block=ca(true);this.block.disrupt&&e("strange_loop",U);q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});F("with");Oa("switch",function(){var a,b=g,c=true;q["(breakage)"]=q["(breakage)"]+1;y();h("(");l();u();K();this.arity="statement";this.first=ba(aa(w(0)));u();A(")",b);l();y();h("{");K();for(this.second=
[];g.id==="case";){b=g;b.first=[];b.arity="case";J();x("case");for(h("case");;){y();a=w(0);b.first.push(a);a.id==="NaN"&&e("unexpected_a",a);B();h(":");l();if(g.id!=="case")break;J();x("case");h("case");l()}J();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];a.disrupt?a.id==="break"&&(c=false):e("missing_a_after_b",g,"break","case")}else e("empty_case");this.second.push(b)}this.second.length===0&&e("missing_a",g,"case");if(g.id==="default"){J();b=g;b.arity="case";x("case");
h("default");l();B();h(":");l();J();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];if(c&&a.disrupt&&a.id!=="break")this.disrupt=true}this.second.push(b)}q["(breakage)"]=q["(breakage)"]-1;J();A("}",this);return this});R("debugger",function(){k.debug||e("unexpected_a",this);this.arity="statement";return this});Oa("do",function(){q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=q["(loopage)"]+1;y();this.arity="statement";this.block=ca(true);this.block.disrupt&&e("strange_loop",
U);y();h("while");l();var a=g;y();h("(");K();l();u();x();this.first=ba(aa(w(0)),H.unexpected_a);u();A(")",a);l();q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});Oa("for",function(){var a,b,c=false;a=g;var d;this.arity="statement";q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=q["(loopage)"]+1;h("(");K("control");l();J(this,a);u();g.id==="var"&&m("move_var");x();if(s(0).id==="in"){b=g;switch(q[b.value]){case "unused":q[b.value]="var";break;case "closure":case "var":break;
default:e("bad_in_a",b)}L("string",b);h();d=g;h("in");d.first=b;d.second=w(20);L("object",d.second);A(")",a);l();this.first=d;a=ca(true);if(!k.forin){if(a.length===1&&typeof a[0]==="object"&&a[0].value==="if"&&!a[0]["else"]){for(b=a[0].first;b.id==="&&";)b=b.first;switch(b.id){case "===":case "!==":c=b.first.id==="["?b.first.first.value===d.second.value&&b.first.second.value===d.first.value:b.first.id==="typeof"&&b.first.first.id==="["&&b.first.first.first.value===d.second.value&&b.first.first.second.value===
...
"call"&&b.second[0].value===d.second.value&&b.second[1].value===d.first.value)}}c||e("for_if",this)}}else{if(g.id!==";"){x();for(this.first=[];;){this.first.push(w(0,"for"));if(g.id!==",")break;G()}}V();if(g.id!==";"){x();this.second=aa(w(0));this.second.id!=="true"&&ba(this.second,H.unexpected_a)}V(n);g.id===";"&&m("expected_a_b",g,")",";");if(g.id!==")"){this.third=[];for(x();;){this.third.push(w(0,"for"));if(g.id!==",")break;G()}}u();A(")",a);l();y();a=ca(true)}a.disrupt&&e("strange_loop",U);this.block=
a;q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});Pa("break",function(){var a=g.value;this.arity="statement";q["(breakage)"]===0&&e("unexpected_a",this);if(g.identifier&&n.line===g.line){ua();q[a]!=="label"?e("not_a_label",g):E[a].funct!==q&&e("not_a_scope",g);this.first=g;h()}return this});Pa("continue",function(){k["continue"]||e("unexpected_a",this);var a=g.value;this.arity="statement";q["(breakage)"]===0&&e("unexpected_a",this);if(g.identifier&&n.line===g.line){ua();
q[a]!=="label"?e("not_a_label",g):E[a].funct!==q&&e("not_a_scope",g);this.first=g;h()}return this});Pa("return",function(){this.arity="statement";if(g.id!==";"&&g.line===n.line){ua();(g.id==="/"||g.id==="(regexp)")&&e("wrap_regexp");this.first=w(20)}return this});Pa("throw",function(){this.arity="statement";ua();this.first=w(20);return this});F("class");F("const");F("enum");F("export");F("extends");F("import");F("super");F("let");F("yield");F("implements");F("interface");F("package");F("private");
F("protected");F("public");F("static");kb=[sa,function(){for(;;)if(g.identifier)switch(g.value.toLowerCase()){case "url":sa();break;case "expression":e("unexpected_a");h();break;default:h()}else{if(g.id===";"||g.id==="!"||g.id==="(end)"||g.id==="}")return true;h()}}];ya=["none","dashed","dotted","double","groove","hidden","inset","outset","ridge","solid"];ob=["auto","always","avoid","left","right"];Ab={all:true,braille:true,embossed:true,handheld:true,print:true,projection:true,screen:true,speech:true,
...
"border-right-width":xa,"border-spacing":[2,D],"border-style":[4,ya],"border-top":[true,"border-top-color","border-top-style","border-top-width"],"border-top-color":ja,"border-top-style":ya,"border-top-width":xa,"border-width":[4,xa],bottom:[D,"auto"],"caption-side":["bottom","left","right","top"],clear:["both","left","none","right"],clip:[function(){var a;if(g.identifier&&g.value==="rect"){h();h("(");for(a=0;a<4;a=a+1)if(!D()){e("expected_number_a");break}h(")");return true}return false},"auto"],
color:ja,content:["open-quote","close-quote","no-open-quote","no-close-quote",ib,sa,function(){if(g.identifier&&g.value==="counter"){h();h("(");h();if(g.id===","){G();g.id!=="(string)"&&e("expected_string_a");h()}h(")");return true}if(g.identifier&&g.value==="counters"){h();h("(");g.identifier||e("expected_name_a");h();if(g.id===","){G();g.id!=="(string)"&&e("expected_string_a");h()}if(g.id===","){G();g.id!=="(string)"&&e("expected_string_a");h()}h(")");return true}return false},function(){if(g.identifier&&
g.value==="attr"){h();h("(");g.identifier||e("expected_name_a");h();h(")");return true}return false}],"counter-increment":[hb,"none"],"counter-reset":[hb,"none"],cursor:[sa,"auto","crosshair","default","e-resize","help","move","n-resize","ne-resize","nw-resize","pointer","s-resize","se-resize","sw-resize","w-resize","text","wait"],direction:["ltr","rtl"],display:["block","compact","inline","inline-block","inline-table","list-item","marker","none","run-in","table","table-caption","table-cell","table-column",
"table-column-group","table-footer-group","table-header-group","table-row","table-row-group"],"empty-cells":["show","hide"],"float":["left","none","right"],font:["caption","icon","menu","message-box","small-caption","status-bar",true,"font-size","font-style","font-weight","font-family"],"font-family":function(){for(;g.id!==";";){!hb()&&!ib()&&e("expected_name_a");if(g.id!==",")return true;G()}},"font-size":["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",D],"font-size-adjust":["none",
Ua],"font-stretch":["normal","wider","narrower","ultra-condensed","extra-condensed","condensed","semi-condensed","semi-expanded","expanded","extra-expanded"],"font-style":["normal","italic","oblique"],"font-variant":["normal","small-caps"],"font-weight":["normal","bold","bolder","lighter",Ua],height:[D,"auto"],left:[D,"auto"],"letter-spacing":["normal",D],"line-height":["normal",function(){if(g.id==="-"){h("-");B()}if(g.id==="(number)"){h();if(g.id!=="(string)"&&vb[g.value]===true){B();h()}return true}return false}],
...
"white-space":["normal","nowrap","pre","pre-line","pre-wrap","inherit"],width:[D,"auto"],"word-spacing":["normal",D],"word-wrap":["break-word","normal"],"z-index":["auto",Ua]};da=function(a,b){var c,j,i;JAYLINT.comments=[];JAYLINT.errors=[];JAYLINT.tree="";nb=ta=U=n=g=Object.create(Y["(begin)"]);Q={};d(Qb);if(b){k=Object.create(b);if(j=k.predef)if(Array.isArray(j))for(c=0;c<j.length;c=c+1)Q[j[c]]=true;else typeof j==="object"&&d(j);fa()}else k={};k.indent=+k.indent||0;k.maxerr=k.maxerr||50;W="";Ia=
Ja=la=false;Wa={};if(k.approved)for(c=0;c<k.approved.length;c=c+1)Wa[k.approved[c]]=k.approved[c];else Wa.test="test";Za="";for(c=0;c<k.indent;c=c+1)Za=Za+" ";Aa=E={};X=q={"(scope)":E,"(breakage)":0,"(loopage)":0};Ta=[q];Da=false;Ya={};Fa=false;v=null;ma=false;Ba=[];ra={};La=false;ha=null;pb=true;qb=false;O=null;na=false;Ha=[];ea=null;Ma=0;t="";Ca.init(a);f();try{h();if(g.id==="(number)")m("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var o,l,r,s,C=k.white,y,B,A,w;t="html";T="";for(O=null;;){switch(g.value){case "<":t=
"html";h("<");l={};B=g;B.identifier||e("bad_name_a",B);s=B.value;k.cap&&(s=s.toLowerCase());B.name=s;h();if(!O){O=[];c=s;c!=="html"&&!k.fragment&&(c==="div"&&k.adsafe?m("adsafe_fragment"):m("expected_a_b",n,"html",c));if(k.adsafe){c==="html"&&m("adsafe_html",n);k.fragment?c!=="div"&&m("adsafe_div",n):m("adsafe_fragment",n)}k.browser=true}A=mb[s];typeof A!=="object"&&m("unrecognized_tag_a",B,s);r=A.empty;for(B.type=s;;){if(g.id==="/"){h("/");g.id!==">"&&e("expected_a_b",g,">",g.value);break}if(g.id&&
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&e("expected_a_b",g,">",g.value);e("bad_name_a")}k.white=false;J();o=g.value;k.white=C;h();!k.cap&&o!==o.toLowerCase()&&e("attribute_case_a",n);o=o.toLowerCase();T="";Object.prototype.hasOwnProperty.call(l,o)&&e("duplicate_a",n,o);if(o.slice(0,2)==="on"){k.on||e("html_handlers");t="scriptstring";h("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);T=y;w=k.white;k.white=true;h(y);Na();qa();k.white=w;g.id!==y&&
m("expected_a_b",g,y,g.value);t="html";T="";h(y);A=false}else if(o==="style"){t="scriptstring";h("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);t="styleproperty";T=y;h(y);xb();t="html";T="";h(y);A=false}else if(g.id==="="){h("=");A=g.value;!g.identifier&&g.id!=='"'&&g.id!=="'"&&g.id!=="(string)"&&g.id!=="(string)"&&g.id!=="(color)"&&e("expected_attribute_value_a",n,o);h()}else A=true;l[o]=A;c=o;j=A;var u=i=void 0;if(c==="id"){i=typeof j==="string"?j.toUpperCase():"";Ya[i]===true&&e("duplicate_a",
g,j);if(/^[A-Za-z][A-Za-z0-9._:\-]*$/.test(j)){if(k.adsafe)if(W)j.slice(0,W.length)!==W?e("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(j)||e("adsafe_bad_id");else{W=j;/^[A-Z]+_$/.test(j)||e("adsafe_bad_id")}}else e("bad_id_a",g,j);u=j.search(Wb);u>=0&&e("unexpected_char_a_b",n,j.charAt(u),c);Ya[i]=true}else if(c==="class"||c==="type"||c==="name"){u=j.search(Zb);u>=0&&e("unexpected_char_a_b",n,j.charAt(u),c);Ya[i]=true}else if(c==="href"||c==="background"||c==="content"||c==="data"||c.indexOf("src")>=
0||c.indexOf("url")>=0){k.safe&&wb.test(j)&&m("bad_url",g,j);Ha.push(j)}else c==="for"?k.adsafe&&(W?j.slice(0,W.length)!==W?e("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(j)||e("adsafe_bad_id"):e("adsafe_bad_id")):c==="name"&&k.adsafe&&j.indexOf("_")>=0&&e("adsafe_name_a",g,j)}c=s;j=l;i=void 0;var D=mb[c],F=u=void 0;qb=false;D||m(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(O.length>0){c==="html"&&m("unexpected_a",n,c);if(F=D.parent)F.indexOf(" "+O[O.length-1].name+
" ")<0&&m("tag_a_in_b",n,c,F);else if(!k.adsafe&&!k.fragment){i=O.length;do{i<=0&&m("tag_a_in_b",n,c,"body");i=i-1}while(O[i].name!=="body")}}switch(c){case "div":k.adsafe&&O.length===1&&!W&&e("adsafe_missing_id");break;case "script":t="script";h(">");j.lang&&e("lang",n);k.adsafe&&O.length!==1&&e("adsafe_placement",n);if(j.src){k.adsafe&&(!Ia||!Wa[j.src])&&e("adsafe_source",n);j.type&&e("type",n)}else{K(g.from);x();Na();Ja=true;u=qa();if(k.adsafe){la&&m("adsafe_script",n);(u.length!==1||z(u[0],"id",
"(")||z(u[0].first,"id",".")||z(u[0].first.first,"value","ADSAFE")||z(u[0].second[0],"value",W))&&m("adsafe_id_go");switch(u[0].first.second.value){case "id":(Ia||la||u[0].second.length!==1)&&m("adsafe_id",g);Ia=true;break;case "go":la&&m("adsafe_go");(u[0].second.length!==2||z(u[0].second[1],"id","function")||!u[0].second[1].first||u[0].second[1].first.length!==2||z(u[0].second[1].first[0],"value","dom")||z(u[0].second[1].first[1],"value","lib"))&&m("adsafe_go",g);la=true;break;default:m("adsafe_id_go")}}v=
null}t="html";h("</");!g.identifier&&g.value!=="script"&&e("expected_a_b",g,"script",g.value);h();t="outer";break;case "style":t="style";h(">");zb();t="html";h("</");!g.identifier&&g.value!=="style"&&e("expected_a_b",g,"style",g.value);h();t="outer";break;case "input":switch(j.type){case "radio":case "checkbox":case "button":case "reset":case "submit":break;case "text":case "file":case "password":case "file":case "hidden":case "image":k.adsafe&&j.autocomplete!=="off"&&e("adsafe_autocomplete");break;
default:e("bad_type")}break;case "applet":case "body":case "embed":case "frame":case "frameset":case "head":case "iframe":case "noembed":case "noframes":case "object":case "param":k.adsafe&&e("adsafe_tag",g,c)}r||O.push(B);t="outer";h(">");break;case "</":t="html";h("</");g.identifier||e("bad_name_a");s=g.value;k.cap&&(s=s.toLowerCase());h();O||m("unexpected_a",g,"</"+s+">");(B=O.pop())||m("unexpected_a",g,"</"+s+">");B.name!==s&&m("expected_a_b",g,"</"+B.name+">","</"+s+">");g.id!==">"&&m("expected_a_b",
g,">",g.value);t="outer";h(">");break;case "<!":k.safe&&e("adsafe_a");for(t="html";;){h();if(g.id===">"||g.id==="(end)")break;g.value.indexOf("--")>=0&&m("unexpected_a",g,"--");g.value.indexOf("<")>=0&&m("unexpected_a",g,"<");g.value.indexOf(">")>=0&&m("unexpected_a",g,">")}t="outer";h(">");break;case "(end)":break a;default:g.id==="(end)"?m("missing_a",g,"</"+O[O.length-1].value+">"):h()}if(O&&O.length===0&&(k.adsafe||!k.fragment||g.id==="(end)"))break}g.id!=="(end)"&&m("unexpected_a")}k.adsafe&&
!la&&e("adsafe_go",this)}else switch(g.id){case "{":case "[":ma=true;gb();break;case "@":case "*":case "#":case ".":case ":":t="style";h();(n.id!=="@"||!g.identifier||g.value!=="charset"||n.line!==1||n.from!==1)&&m("css");h();g.id!=="(string)"&&g.value!=="UTF-8"&&m("css");h();V();zb();break;default:k.adsafe&&k.fragment&&m("expected_a_b",g,"<div>",g.value);K(1);g.id===";"&&!La&&V();Ja=true;i=qa();nb.first=i;JAYLINT.tree=nb;k.adsafe&&(i.length!==1||z(i[0],"id","(")||z(i[0].first,"id",".")||z(i[0].first.first,
"value","ADSAFE")||z(i[0].first.second,"value","lib")||i[0].second.length!==2||i[0].second[0].id!=="(string)"||z(i[0].second[1],"id","function"))&&m("adsafe_lib");i.disrupt&&e("weird_program",U)}v=null;h("(end)")}catch(G){G&&JAYLINT.errors.push({reason:G.message,line:G.line||g.line,character:G.character||g.from},null)}return JAYLINT.errors.length===0};da.data=function(){var a={functions:[]},b,c,d,e,g,f=[],j=[];if(da.errors.length)a.errors=da.errors;if(ma)a.json=true;if(Ha.length>0)a.urls=Ha;b=Object.keys(Aa).filter(function(a){return a.charAt(0)!==
"("?a:void 0});if(b.length>0)a.globals=b;for(c=1;c<Ta.length;c=c+1){g=Ta[c];b={};for(d=0;d<Ka.length;d=d+1)b[Ka[d]]=[];for(e in g)if(Object.prototype.hasOwnProperty.call(g,e)&&e.charAt(0)!=="("){d=g[e];if(d==="unction"||d==="unparam")d="unused";if(Array.isArray(b[d])){b[d].push(e);d==="unused"?j.push({name:e,line:g["(line)"],"function":g["(name)"]}):d==="undef"&&f.push({name:e,line:g["(line)"],"function":g["(name)"]})}}for(d=0;d<Ka.length;d=d+1)b[Ka[d]].length===0&&delete b[Ka[d]];b.name=g["(name)"];
b.param=g["(params)"];b.line=g["(line)"];b["(complexity)"]=g["(complexity)"];a.functions.push(b)}if(j.length>0)a.unused=j;if(f.length>0)a.undef=f;for(e in ra)if(typeof ra[e]==="number"){a.member=ra;break}return a};da.report=function(a){function b(a,c){var d,e;if(Array.isArray(c)){h.push("<div><i>"+a+"</i> ");c=c.sort().forEach(function(a){if(a!==e){e=a;h.push((d?", ":"")+e);d=true}});h.push("</div>")}else c&&h.push("<div><i>"+a+"</i> "+c+"</div>")}var d=da.data(),e,g,f,j;g="";var i,h=[];if(d.errors||
d.unused||d.undef){e=true;h.push("<div id=errors><i>Error:</i>");if(d.errors)for(f=0;f<d.errors.length;f=f+1)if(j=d.errors[f]){g=j.evidence||"";h.push("<p>Problem"+(isFinite(j.line)?" at line "+j.line+" character "+j.character:"")+": "+j.reason.entityify()+"</p><p class=evidence>"+(g&&(g.length>80?g.slice(0,77)+"...":g).entityify())+"</p>")}if(d.undef){g=[];for(f=0;f<d.undef.length;f=f+1)g[f]="<code><u>"+d.undef[f].name+"</u></code>&nbsp;<i>"+d.undef[f].line+" </i> <small>"+d.undef[f]["function"]+
"</small>";h.push("<p><i>Undefined variable:</i> "+g.join(", ")+"</p>")}if(d.unused){g=[];for(f=0;f<d.unused.length;f=f+1)g[f]="<code><u>"+d.unused[f].name+"</u></code>&nbsp;<i>"+d.unused[f].line+" </i> <small>"+d.unused[f]["function"]+"</small>";h.push("<p><i>Unused variable:</i> "+g.join(", ")+"</p>")}d.json&&h.push("<p>JSON: bad.</p>");h.push("</div>")}if(!a){h.push("<br><div id=functions>");d.urls&&b("URLs<br>",d.urls,"<br>");t==="style"?h.push("<p>CSS.</p>"):d.json&&!e?h.push("<p>JSON: good.</p>"):
d.globals?h.push("<div><i>Global</i> "+d.globals.sort().join(", ")+"</div>"):h.push("<div><i>No new global variables introduced.</i></div>");for(f=0;f<d.functions.length;f=f+1){e=d.functions[f];a=[];if(e.param)for(g=0;g<e.param.length;g=g+1)a[g]=e.param[g].value;h.push("<br><div class=function><i>"+e.line+"</i> "+e.name.entityify()+"("+a.join(", ")+")</div>");b("<big><b>Undefined</b></big>",e.undef);b("<big><b>Unused</b></big>",e.unused);b("Closure",e.closure);b("Variable",e["var"]);b("Exception",
e.exception);b("Outer",e.outer);b("Global",e.global);b("Label",e.label);b("Complexity",e["(complexity)"])}if(d.member){e=Object.keys(d.member);if(e.length){e=e.sort();g="<br><pre id=properties>/*properties ";j=13;for(f=0;f<e.length;f=f+1){a=e[f];i=Cb.test(a)?a:"'"+a.entityify().replace(ub,c)+"'";if(j+i.length>72){h.push(g+"<br>");g="    ";j=1}j=j+(i.length+2);d.member[a]===1&&(i="<i>"+i+"</i>");f<e.length-1&&(i=i+", ");g=g+i}h.push(g+"<br>*/</pre>")}h.push("</div>")}}return h.join("")};da.jslint=
...
0&&!c[0].type)c[0].type=a.Base;var d=b.split("."),i=d.splice(d.length-1,1)[0],s=window;d.forEach(function(a){s[a]||(s[a]={__namespace:true});s=s[a]});var l=null,l=this.classFunctionBuilder(i,c,f,e);l.fullName=b;l.namespace=d.join(".");this.buildType(l,c,e,f);l.name=i;Container.registerType(b,l);typeof intellisense!=="undefined"&&e&&e.constructor&&intellisense.annotate(l,e.constructor);return s[i]=this.classNames[b]=l},classFunctionBuilder:function(a,b,c,d){return(new Function("base","classDefinition",
"instanceDefinition","return function "+a+" (){ "+this.bodyBuilder(b,c,d)+" \n}; "))(b,c,d)},bodyBuilder:function(a,b,c){for(var d=b="",e="",f=0,i=a.length;f<i;f++){var l=a[f],h=f;if(h==0){if(l&&l.type){d=d+("    var baseArguments = $data.typeSystem.createCtorParams(arguments, base["+h+"].params, this); \n");d=d+("    "+l.type.fullName+".apply(this, baseArguments); \n")}}else if(l&&l.type&&l.propagateTo){e=e+("    "+(!e?"var ":"")+"propagationArguments = $data.typeSystem.createCtorParams(arguments, base["+
...
Guard.raise(new Exception("not inicialized"));f.apply(this[d],arguments)}}}Object.defineProperty(a,b,c)},addField:function(){Guard.raise("not implemented")},buildMethod:function(a,b,c){this.addMethod(b.classMember?a:a.prototype,b.name,b.method,c)},buildProperty:function(a,b,c){var d=b.classMember?a:a.prototype,e=b.createPropertyDescriptor(a);this.addProperty(d,b.name,e,c);if(!b.classMember&&a.__setPropertyfunctions==true){a=b.createGetMethod();this.addProperty(d,"get_"+b.name,a,c);a=b.createSetMethod();
...
"function")return a;a in b||Guard.raise(new Exception("Unable to resolve type:"+a));return d[b[a]]};this.getName=function(a){var b=this.getType(a),b=d.indexOf(b);b==-1&&Guard.raise("unknown type to request name for: "+a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return"";case a.Boolean:return false;default:return null}};this.registerType=function(a,e,i){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a===
"string"){var j=[];j.push(a);a=j}for(j=0;j<a.length;j++){var z=a[j].split("."),x={};x.shortName=z[z.length-1];x.fullName=a[j];a[j]=x}z=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(z,e);for(var j=0,K=a.length;j<K;j++){x=a[j];"create"+x.shortName in f?console&&console.warn("warning: short names overlap:"+x.shortName+", Container.create"+x.shortName+" has not been updated"):f["create"+x.shortName]=
typeof i==="function"?i:z;var A=d.indexOf(e);if(A==-1){A=d.push(e)-1;c[A]=x.fullName}x.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+x.fullName);b[x.fullName]=A}if(!e.name)e.name=a[0].shortName}}};b.registerType(["$data.Number","number","float","real","decimal"],a.Number);b.registerType(["$data.Integer","int","integer","int16","int32","int64"],a.Integer);b.registerType(["$data.String","string","text","character"],a.String);b.registerType(["$data.Array","array",
"Array","[]"],a.Array,function(){return a.Array.apply(void 0,arguments)});b.registerType(["$data.Date","datetime","date"],a.Date);b.registerType(["$data.Boolean","bool","boolean"],a.Boolean);b.registerType(["$data.Blob","blob"],a.Blob);b.registerType(["$data.Object","Object","object"],a.Object);b.registerType(["$data.Function","Function","function"],a.Function);b.registerType(["$data.ObjectID","ObjectID","objectId","objectid","ID","Id","id"],a.ObjectID)})(window);b.$C=function(){Class.define.apply(Class,
arguments)};a.Class.ConstructorParameter=ConstructorParameter=a.Class.define("ConstructorParameter",null,null,{constructor:function(a){this.paramIndex=a},paramIndex:{}})})($data,window);$data.defaultErrorCallback=function(){Guard.raise(new Exception("DEFAULT ERROR CALLBACK!","DefaultError",arguments))};$data.defaultSuccessCallback=function(){console.log("DEFAULT SUCCES CALLBACK")};$data.defaultNotifyCallback=function(){console.log("DEFAULT NOTIFY CALLBACK")};
...
a)},createCtorParams:function(a,b,c){if(b){for(var d=[],f=0,i=b.length;f<i;f++){var e=f;b[e]instanceof ConstructorParameter?d.push(a[b[e].paramIndex]):typeof b[e]==="function"?d.push(b[e].apply(c)):d.push(b[e])}return d}return a},writePropertyValues:function(a){a&&a.getType&&a.getType().memberDefinitions&&this.writeProperties(a,a.getType().memberDefinitions.asArray().filter(function(a){return(a.kind=="property"||a.kind=="navProperty"||a.kind=="complexProperty")&&!a.prototypeProperty}))},writeProperties:function(a,
b){for(var c={},d=0,f=b.length;d<f;d++){var i=b[d];c[i.name]=i.createPropertyDescriptor(null,i.value)}Object.defineProperties(a,c)},writeProperty:function(a,b,c){if(b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b){c=b.createPropertyDescriptor(null,c);Object.defineProperty(a,b.name,c)}}};$data.ASTNode=function(){};$data.FunctionASTNode=function(){};$data.FunctionASTNode.prototype=new $data.ASTNode;$data.ParameterASTNode=function(){};$data.MemberAccessASTNode=function(){};
...
Container.createPropertyExpression(c,d)},VisitCall:function(a,b){var c=$data.Expressions.ExpressionVisitor.prototype.VisitCall.apply(this,arguments),d=c.expression,f=c.member,i=c.args;if(function(a,b,c){return b instanceof $data.Expressions.ConstantExpression&&(!c||c instanceof $data.Expressions.ConstantExpression)&&a.every(function(a){return a instanceof $data.Expressions.ConstantExpression})}(i,f,d)){c=f.value;typeof c==="string"&&d.value&&(c=d.value[c]);typeof c!=="function"&&Guard.raise("Constant expression is not a method...");
d=a.implementation(d.value,c,i);return new $data.Expressions.ConstantExpression(d)}return c}},{});$C("$data.Expressions.AggregatedVisitor",$data.Expressions.ExpressionVisitor,null,{constructor:function(a){this.Visit=function(b,c){for(var d=0;d<a.length;d++){var f=a[d].Visit(b,c);if(f!==b)return f}return b}}});
...
for(var f=[],i=0;i<d.length;i++){var e=d[i];f.push(typeof e.value=="string"?"'"+e.value+"'":e.value)}c=c?"value = object.value[eNode.method]("+f.join(",")+");":"value = "+a.method+"("+f.join(",")+");";eval(c);return $data.Expressions.ExpressionNodeTypes.LiteralExpressionNode.create(true,"undefined",void 0)},VisitArrayAccess:function(a,b){var c=this.Visit(a.array,b),d=this.Visit(a.index,b),c=c.value[d.value];return $data.Expressions.ExpressionNodeTypes.LiteralExpressionNode.create(true,typeof c,c)}},
null);
...
a.source||d!==a.selector?Container.createEntityExpression(c,d):a},VisitEntityFieldExpression:function(a,b){var c=this.Visit(a.source,b),d=this.Visit(a.selector,b);return c!==a.source||d!==a.selector?Container.createEntityFieldExpression(c,d):a},VisitEntityFieldOperationExpression:function(a,b){var c=this.Visit(a.source,b),d=this.Visit(a.operation,b),f=a.parameters.map(function(a){return this.Visit(a)},this);return Container.createEntityFieldOperationExpression(c,d,f)},VisitParametricQueryExpression:function(a,
...
a.length==b}},"$data.Object":{required:function(a){return!Object.isNullOrUndefined(a)},customValidator:function(a,b){return Object.isNullOrUndefined(a)||typeof b=="function"?b(a):true}}}},fieldValidate:function(a,b,c,d,f){if(!(a.entityState==$data.EntityState.Modified&&a[b.name]==void 0)){var i=this.supportedValidations[f];i&&Object.keys(i).forEach(function(e){b[e]&&i[e]&&!i[e].call(a,c,this.getValidationValue(b,e))&&d.push(this.createValidationError(b,e,"Validation error!"))},this)}}},null);
...
$data.Class.define("$data.Access",null,null,{},{isAuthorized:function(a,b,c,d){console.log("isAuthorized",arguments);var f;a||(f="Access undefined");typeof a!=="number"&&(f="Invalid access type");b||(b={});if(!b.roles)b.roles={};c||(c={});c instanceof Array||typeof c==="object"||(f="Invald roles type");var i=new $data.PromiseHandler,e=i.createCallback(d),i=i.getPromise();if(f){e.error(f,"Access authorization");return i}if(b.roles instanceof Array){f={};for(var j=0;j<b.roles.length;j++)typeof b.roles[j]===
"string"&&(f[b.roles[j]]=true);b.roles=f}if(c instanceof Array){f={};for(j=0;j<c.length;j++)typeof c[j]==="string"&&(f[c[j]]=true);c=f}var m=arguments,r=function(a){a?e.success(a):e.error("Authorization failed",m)},o=Object.getOwnPropertyNames(c),j=0,z=function(d){d&&r(d);if(typeof c[o[j]]==="boolean"&&c[o[j]])if(b.roles[o[j]])r(true);else{j++;j<o.length?z():r(false)}else if(typeof c[o[j]]==="function"){d=c[o[j]].call(b);if(typeof d==="function")d.call(b,j<o.length?z:r);else if(d)r(true);else{j++;
...
f;for(f in a)d.indexOf(f)>-1&&(this[f]=Container.resolveType(c.getMember(f).type)===$data.Date&&typeof a[f]==="string"?new Date(a[f]):a[f])}},toString:function(){return this.getType().fullName+"("+(this.Id||this.Name||"")+")"},toJSON:function(){var a={},b=this;this.getType().memberDefinitions.getPublicMappedProperties().forEach(function(c){a[c.name]=b[c.name]});return a},equals:function(a){if(a.getType()!==this.getType())return false;for(var b=this.getType().memberDefinitions.getKeyProperties(),c=
0;c<b.length;c++)if(this[b[c].name]==a[b[c].name])return true;return false},propertyChanging:{dataType:$data.Event,storeOnObject:!0,monitorChanges:!1,notMapped:!0,enumerable:!1,prototypeProperty:!0,get:function(){var a=this.getType().memberDefinitions.getMember("propertyChanging");if(a){delete this.propertyChanging;delete a.get;delete a.set;Object.defineProperty(this,"propertyChanging",a.createPropertyDescriptor());return this.propertyChanging=new Event("propertyChanging",this)}},set:function(){}},
propertyChanged:{dataType:$data.Event,storeOnObject:!0,monitorChanges:!1,notMapped:!0,enumerable:!1,prototypeProperty:!0,get:function(){var a=this.getType().memberDefinitions.getMember("propertyChanged");if(a){delete this.propertyChanged;delete a.get;delete a.set;Object.defineProperty(this,"propertyChanged",a.createPropertyDescriptor());return this.propertyChanged=new Event("propertyChanged",this)}},set:function(){}},propertyValidationError:{dataType:$data.Event,storeOnObject:!0,monitorChanges:!1,
notMapped:!0,enumerable:!1,prototypeProperty:!0,get:function(){var a=this.getType().memberDefinitions.getMember("propertyValidationError");if(a){delete this.propertyValidationError;delete a.get;delete a.set;Object.defineProperty(this,"propertyValidationError",a.createPropertyDescriptor());return this.propertyValidationError=new Event("propertyValidationError",this)}},set:function(){}},storeProperty:function(a,b){var c=null;if(a.monitorChanges!=false&&(this._propertyChanging||this._propertyChanged||
"instancePropertyChanged"in this.constructor)){var d=this[a.name],c=new PropertyChangeEventData(a.name,d,b);this._propertyChanging&&this.propertyChanging.fire(c)}if(a.monitorChanges!=false&&(this._propertyValidationError||"instancePropertyValidationError"in this.constructor)){var f=$data.Validation.Entity.ValidateEntityField(this,a,b);if(f.length>0){d=this[a.name];d=new PropertyValidationEventData(a.name,d,b,f);this._propertyValidationError&&this.propertyValidationError.fire(d);"instancePropertyValidationError"in
this.constructor&&this.constructor.instancePropertyValidationError.fire(d,this);if(d.cancel==true)return}}if(a.storeOnObject==true){d="_"+a.name;this[d]?this[d]=b:Object.defineProperty(this,d,a.createStorePropertyDescriptor(b))}else this.initData[a.name]=b;this.isValidated=false;if(a.monitorChanges!=false&&this.entityState==$data.EntityState.Unchanged)this.entityState=$data.EntityState.Modified;if(a.monitorChanges!=false){if(!this.changedProperties)this.changedProperties=[];this.changedProperties.some(function(b){return b.name==
...
$data.Class.define("$data.EntityContext",null,null,{constructor:function(a,b){this.trackChanges=this.lazyLoad=false;this._entitySetReferences={};this._storageModel=[];var c=this;this._storageModel.getStorageModel=function(a){var b=Container.resolveType(a);return c._storageModel.filter(function(a){return a.LogicalType===b})[0]};if(typeof a.name==="string")a.name=[a.name];for(var d=0,f;!(f=$data.StorageProviderBase.getProvider(a.name[d]))&&d<a.name.length;)d++;if(f){this.storageProvider=new f(a,this);
this.storageProvider.setContext(this);this.stateManager=new $data.EntityStateManager(this);if(a.name in this.getType()._storageModelCache)this._storageModel=this.getType()._storageModelCache[a.name];else{this._initializeStorageModel();this.getType()._storageModelCache[a.name]=this._storageModel}}else Guard.raise(new Exception("Provider fallback failed!","Not Found"));this._initializeEntitySets(this.constructor);this._user=a&&a.user||b;this._isOK=false;d=$data.typeSystem.createCallbackSetting({success:this._successInitProvider});
this.storageProvider&&this.storageProvider.initializeStore(d)},getDataType:function(a){if(typeof a=="string"){var b=this[a];if(b===void 0||b===null)b=eval(a);return b}return a},_initializeEntitySets:function(a){a.inheritsFrom!==null&&a.inheritsFrom!==void 0&&this._initializeEntitySets(a.inheritsFrom);this._storageModel.forEach(function(a){this[a.ItemName]=new $data.EntitySet(a.LogicalType,this,a.ItemName,a.EventHandlers,a.Roles);this[a.ItemName].name=a.ItemName;this[a.ItemName].tableName=a.TableName;
this[a.ItemName].eventHandlers=a.EventHandlers;this._entitySetReferences[a.LogicalType.name]=this[a.ItemName];a.EntitySetReference=this[a.ItemName]},this)},_initializeStorageModel:function(){this.getType().memberDefinitions.asArray().forEach(function(a){if("dataType"in a){var b=Container.resolveType(a.dataType);if(b&&b.isAssignableTo&&b.isAssignableTo($data.EntitySet)){b=new $data.StorageModel;b.TableName=a.tableName||a.name;b.ItemName=a.name;b.LogicalType=Container.resolveType(a.elementType);b.LogicalTypeName=
b.LogicalType.name;b.PhysicalTypeName=$data.EntityContext._convertLogicalTypeNameToPhysical(b.LogicalTypeName);b.EventHandlers={beforeCreate:a.beforeCreate,beforeRead:a.beforeRead,beforeUpdate:a.beforeUpdate,beforeDelete:a.beforeDelete,afterCreate:a.afterCreate,afterRead:a.afterRead,afterUpdate:a.afterUpdate,afterDelete:a.afterDelete};var a=a.roles,c={};if(a instanceof Array)for(var d=0;d<a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;b.Roles=c;this._storageModel.push(b)}}},this);typeof intellisense===
"undefined"&&this._storageModel.forEach(function(a){var b={};a.Associations=a.Associations||[];a.ComplexTypes=a.ComplexTypes||[];a.LogicalType.memberDefinitions.getPublicMappedProperties().forEach(function(c){var f=Container.resolveType(c.dataType);if(this.storageProvider.supportedDataTypes.indexOf(f)>-1&&Object.isNullOrUndefined(c.inverseProperty)){var i=JSON.parse(JSON.stringify(c));i.dataType=f;b[c.name]=i}else{this._buildDbType_navigationPropertyComplite(c,f,a);if((f===$data.Array||f.isAssignableTo&&
f.isAssignableTo($data.EntitySet))&&c.inverseProperty&&c.inverseProperty!=="$$unbound")this._buildDbType_Collection_OneManyDefinition(b,a,f,c);else if(c.inverseProperty)if(c.inverseProperty==="$$unbound")f===$data.Array?this._buildDbType_Collection_OneManyDefinition(b,a,f,c):this._buildDbType_ElementType_OneManyDefinition(b,a,f,c);else(i=f.memberDefinitions.getMember(c.inverseProperty))?i.elementType?Container.resolveType(i.elementType)===a.LogicalType?this._buildDbType_ElementType_OneManyDefinition(b,
a,f,c):typeof intellisense==="undefined"&&Guard.raise(new Exception("Inverse property not valid, refereed item element type not match: "+a.LogicalTypeName,", property: "+c.name)):this._buildDbType_ElementType_OneOneDefinition(b,a,f,c):typeof intellisense==="undefined"&&Guard.raise(new Exception("Inverse property not valid"));else this._buildDbType_addComplexTypePropertyDefinition(b,a,f,c)}},this);this._buildDbType_modifyInstanceDefinition(b,a,this);var c={};c.convertTo=this._buildDbType_generateConvertToFunction(a,
this);this._buildDbType_modifyClassDefinition(c,a,this);a.PhysicalType=$data.Class.define(a.PhysicalTypeName,$data.Entity,null,b,c)},this)},_buildDbType_navigationPropertyComplite:function(a,b,c){if(a.inverseProperty){f=null;f=b===$data.Array||b.isAssignableTo&&b.isAssignableTo($data.EntitySet)?this._storageModel.getStorageModel(Container.resolveType(a.elementType)):this._storageModel.getStorageModel(b);if(b=f.LogicalType.memberDefinitions.getMember(a.inverseProperty))b.inverseProperty?b.inverseProperty!=
a.name&&typeof intellisense==="undefined"&&Guard.raise(new Exception("Inverse property mismatch")):b.inverseProperty=a.name}else{var d=null;if(b===$data.Array||b.isAssignableTo&&b.isAssignableTo($data.EntitySet)){var f=this._storageModel.getStorageModel(Container.resolveType(a.elementType));f&&(d=f.LogicalType.memberDefinitions.getPublicMappedProperties().filter(function(b){return b.inverseProperty==a.name&&Container.resolveType(b.dataType)===Container.resolveType(c.LogicalType)}))}else(f=this._storageModel.getStorageModel(b))&&
(d=f.LogicalType.memberDefinitions.getPublicMappedProperties().filter(function(b){return b.elementType?b.inverseProperty==a.name&&Container.resolveType(b.elementType)===c.LogicalType:b.inverseProperty==a.name&&Container.resolveType(b.dataType)===c.LogicalType}));if(d){d.length>1&&typeof intellisense!=="undefined"&&Guard.raise(new Exception("More than one inverse property refer to this member definition: "+a.name+", type: "+Container.resolveName(c.LogicalType)));if(b=d.pop())a.inverseProperty=b.name}}},
_buildDbType_generateConvertToFunction:function(){return function(a){return a}},_buildDbType_modifyInstanceDefinition:function(){},_buildDbType_modifyClassDefinition:function(){},_buildDbType_addComplexTypePropertyDefinition:function(a,b,c,d){this._addNavigationPropertyDefinition(a,d,d.name,$data.MemberTypes.complexProperty);a=this._createComplexElement(b.LogicalType,"",d.name,c,"","");b.ComplexTypes[d.name]=a;b.ComplexTypes.push(a)},_buildDbType_Collection_OneManyDefinition:function(a,b,c,d){var f=
Container.resolveType(d.elementType);(f===void 0||f===null)&&typeof intellisense==="undefined"&&Guard.raise(new Exception("Element type definition error","Field definition",d));(c=this._storageModel.filter(function(a){return a.LogicalType===f})[0])||typeof intellisense==="undefined"&&Guard.raise(new Exception("No EntitySet definition for the following element type","Field definition",d));this._addNavigationPropertyDefinition(a,d,d.name);a=this._addAssociationElement(b.LogicalType,d.inverseProperty===
"$$unbound"?"$$unbound":"0..1",d.name,c.LogicalType,"*",d.inverseProperty);b.Associations[d.name]=a;b.Associations.push(a)},_buildDbType_ElementType_OneManyDefinition:function(a,b,c,d){var f=Container.resolveType(d.dataType);(f===void 0||f===null)&&typeof intellisense==="undefined"&&Guard.raise(new Exception("Element type definition error","Field definition",d));(c=this._storageModel.filter(function(a){return a.LogicalType===f})[0])||typeof intellisense==="undefined"&&Guard.raise(new Exception("No EntitySet definition for the following element type",
...
a.expression.nodeType===$data.Expressions.ExpressionType.Count||a.expression.nodeType===$data.Expressions.ExpressionType.Some||a.expression.nodeType===$data.Expressions.ExpressionType.Every){if(a.result.length!==1){b.error(new Exception("result count failed"));return}c=a.result[0]}else if(a.expression.nodeType===$data.Expressions.ExpressionType.First){if(a.result.length===0){b.error(new Exception("result count failed"));return}c=a.result[0]}else c=a.result;var e=function(){b.success(c)},f=0,h=a.getEntitySets(),
i=function(){var b=h[f];if(b.afterRead){f++;b=b.afterRead.call(this,c,h,a);typeof b==="function"?b.call(this,f<h.length?i:e,c,h,a):f<h.length?i():e()}else e()};h.length?i():e()}};f.error=b.error;var i=c.getEntitySets(),e=true,j=this,m=function(a){a===false&&(e=false);if(e)j.storageProvider.executeQuery(c,f);else{c.rawDataList=[];c.result=[];f.success(c)}},r=0,o=function(a){a===false&&(e=false);a=i[r];if(a.beforeRead){r++;a=a.beforeRead.call(this,i,c);if(typeof a==="function")a.call(this,r<i.length&&
e?o:m,i,c);else{a===false&&(e=false);r<i.length&&e?o():m()}}else m()};i.length?o():m()},saveChanges:function(a){for(var b=[],c=this.stateManager.trackedEntities,d=new $data.PromiseHandler,f=d.createCallback(a),a=d.getPromise(),i=[];c.length>0;){var e=[];c.forEach(function(a){var b=this._storageModel.getStorageModel(a.data.getType());if(a.data.entityState==$data.EntityState.Unchanged){a.skipSave=true;i.push(a.data)}else if(a.data.entityState==$data.EntityState.Modified&&a.data.changedProperties&&!a.data.changedProperties.some(function(a){a=
b.PhysicalType.memberDefinitions.getMember(a.name);if(a.kind==$data.MemberTypes.navProperty){a=b.Associations[a.association];a=a.FromMultiplicity+a.ToMultiplicity;return a=="*0..1"||a=="0..11"}return true})){a.skipSave=true;i.push(a.data)}b.PhysicalType.memberDefinitions.asArray().filter(function(a){return a.kind==$data.MemberTypes.navProperty}).forEach(function(c){var d=b.Associations[c.name],f=d.ToPropertyName;[].concat(a.data[c.name]).forEach(function(b){if(b){var c=b[f],h=d.FromMultiplicity+d.ToMultiplicity;
if(d.FromMultiplicity==="$$unbound")if(b instanceof $data.Array){a.dependentOn=a.dependentOn||[];b.forEach(function(){a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)},this)}else{a.dependentOn=a.dependentOn||[];a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)}else{switch(h){case "*0..1":c?c instanceof Array?c.indexOf(a.data)==-1&&c.push(a.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):b[f]=[a.data];break;default:c?
c!==a.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):b[f]=a.data}switch(h){case "*0..1":case "0..11":a.dependentOn=a.dependentOn||[];a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)}}if(!b.entityState)b.entityState=$data.EntityState.Added;e.indexOf(b)==-1&&e.push(b)}},this)},this)},this);c.forEach(function(a){a.skipSave!==true&&b.push(a)});c=[];e.forEach(function(a){i.some(function(b){return b==a})||b.some(function(b){return b.data==
a})||c.push({data:a,entitySet:this.getEntitySetFromElementType(a.getType().name)})},this)}b.forEach(function(a){if(a.dependentOn){for(var b=[],c=0;c<a.dependentOn.length;c++)i.indexOf(a.dependentOn[c])<0&&b.push(a.dependentOn[c]);a.dependentOn=b}});var i=null,j=this;if(b.length==0){f.success(0);return a}var m=[];b.forEach(function(a){a.data.entityState===$data.EntityState.Added&&a.data.getType().memberDefinitions.getPublicMappedProperties().forEach(function(b){b.required&&!b.computed&&!a.data[b.name]&&
(a.data[b.name]=Container.getDefault(b.dataType))},this);(a.data.entityState!=$data.EntityState.Added||a.data.entityState!=$data.EntityState.Modified)&&!a.data.isValid()&&m.push({item:a.data,errors:a.data.ValidationErrors})});if(m.length>0){f.error(m);return a}for(var r={},o=0;o<b.length;o++){var d=b[o],z=d.entitySet.elementType.name,C=this._entitySetReferences[z];if(C.beforeCreate||C.beforeUpdate||C.beforeDelete){r[z]||(r[z]={});switch(d.data.entityState){case $data.EntityState.Added:if(C.beforeCreate){if(!r[z].createAll)r[z].createAll=
[];r[z].createAll.push(d)}break;case $data.EntityState.Modified:if(C.beforeUpdate){if(!r[z].modifyAll)r[z].modifyAll=[];r[z].modifyAll.push(d)}break;case $data.EntityState.Deleted:if(C.beforeDelete){if(!r[z].deleteAll)r[z].deleteAll=[];r[z].deleteAll.push(d)}}}}var s=function(a){if(a){l="async";b.length=0}b.length?j.storageProvider.saveChanges({success:function(){j._postProcessSavedItems(f,b)},error:f.error},b):f.success(0)},l,h=Object.getOwnPropertyNames(r),o=0,fa=["beforeUpdate","beforeDelete",
"beforeCreate"],ga={beforeCreate:"createAll",beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},x=function(a){if(a){l="async";b.length=0}var a=j._entitySetReferences[h[o]],c=fa.pop(),d=r[h[o]][ga[c]];if(d){var e=d.map(function(a){return a.data});if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];o++}var f=a[c].call(j,e);if(typeof f==="function")f.call(j,o<h.length&&!l?x:s,e);else if(f===false){l=a.name+"."+c;d.forEach(function(a){a=b.indexOf(a);b.splice(a,1)});s()}else o<h.length&&!l?
x():s()}else{if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];o++}o<h.length&&!l?x():s()}};o<h.length?x():s();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);var c={},d=this;b.forEach(function(a){var b=a.data.entityState;a.data.entityState=$data.EntityState.Unchanged;a.data.changedProperties=[];a.physicalData=void 0;var e=
a.entitySet.elementType.name,f=d._entitySetReferences[e];if(f.afterCreate||f.afterUpdate||f.afterDelete){c[e]||(c[e]={});switch(b){case $data.EntityState.Added:if(f.afterCreate){if(!c[e].createAll)c[e].createAll=[];c[e].createAll.push(a)}break;case $data.EntityState.Modified:if(f.afterUpdate){if(!c[e].modifyAll)c[e].modifyAll=[];c[e].modifyAll.push(a)}break;case $data.EntityState.Deleted:if(f.afterDelete){if(!c[e].deleteAll)c[e].deleteAll=[];c[e].deleteAll.push(a)}}}});var f=Object.getOwnPropertyNames(c),
i=0,d=this,e=["afterUpdate","afterDelete","afterCreate"],j={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},m=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},r=function(){var a=d._entitySetReferences[f[i]],b=e.pop(),C=c[f[i]][j[b]];if(C){C=C.map(function(a){return a.data});if(!e.length){e=["afterUpdate","afterDelete","afterCreate"];i++}a=a[b].call(d,C);typeof a==="function"?a.call(d,i<f.length?r:m,C):i<f.length?r():m()}else{if(!e.length){e=["afterUpdate",
"afterDelete","afterCreate"];i++}i<f.length?r():m()}};i<f.length?r():m()},forEachEntitySet:function(a,b){for(var c in this._entitySetReferences)a.call(b,this._entitySetReferences[c])},loadItemProperty:function(a,b,c){Guard.requireType("entity",a,$data.Entity);var d=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b;if(a[d.name]!=void 0){b=new $data.PromiseHandler;callBack=b.createCallback(c);c.success(a[d.name]);return b.getPromise()}var b=true,f=this._storageModel.getStorageModel(a.getType().fullName),
i=Container.resolveType(d.dataType);if(i===$data.Array||i.isAssignableTo&&i.isAssignableTo($data.EntitySet)){i=Container.resolveType(d.elementType);b=false}else{var e=f.Associations.filter(function(a){return a.FromPropertyName==d.name})[0];e&&e.FromMultiplicity==="0..1"&&e.ToMultiplicity==="1"&&(b=false)}if(b===true){var j="function (e) { return",m={};f.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(j=j+" &&");j=j+(" e."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});
j=j+"; }";return f.EntitySetReference.map("function (e) { return e."+d.name+" }").single(j,m,c)}j="function (e) { return";m={};f.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(j=j+" &&");j=j+(" e."+d.inverseProperty+"."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});j=j+"; }";return this.getEntitySetFromElementType(i).filter(j,m).toArray(c)},getTraceString:function(a){return this.storageProvider.getTraceString(new $data.Query(a.expression,a.defaultType,this))},log:function(){},
...
for(var f=[],i=0;i<d.length;i++){var e={};e[d[i]]=Container.resolveType(Container.getTypeName(c[i]));f.push(e)}return $data.EntityContext.generateServiceOperation({serviceName:a,returnType:$data.Queryable,elementType:this[b].elementType,params:f}).apply(this,c)},attach:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());return this.getEntitySetFromElementType(a.getType()).attach(a)},attachOrGet:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());return this.getEntitySetFromElementType(a.getType()).attachOrGet(a)},
...
new $data.PromiseHandler;if(typeof b==="function"){b=c.createCallback(b);arguments[arguments.length-1]=b}else{b=c.createCallback();arguments.push(b)}try{var d=a.serviceMethod.apply(this,arguments);d!==void 0&&b.success(d)}catch(f){b.error(f)}return c.getPromise()}}else b=function(){var b=a.elementType?this.getEntitySetFromElementType(Container.resolveType(a.elementType)):null,c=null;if(a.params)for(var c=[],d=0;d<a.params.length;d++)for(var f in a.params[d])c.push(Container.createConstantExpression(arguments[d],
Container.resolveType(a.params[d][f]),f));d=Container.createEntityContextExpression(this);f=this.getType().getMemberDefinition(a.serviceName);c=Container.createServiceOperationExpression(d,Container.createMemberInfoExpression(f),c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}f=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=f;if(f===$data.Queryable){b.defaultType=
Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};var c=[];if(a.params)for(var d=0;d<a.params.length;d++){var f=a.params[d],i;for(i in f)c.push({name:i,type:f[i]})}$data.typeSystem.extend(b,a,{params:c});return b},_convertLogicalTypeNameToPhysical:function(a){return a+"_$db$"},_storageModelCache:{get:function(){if(!this.__storageModelCache)this.__storageModelCache={};return this.__storageModelCache},set:function(){}}});
...
$data.Class.define("$data.ModelBinder",null,null,{constructor:function(a){this.context=a;this.cache={}},call:function(a,b){if(!Object.getOwnPropertyNames(b).length)return a;if(b.$type)var c=Container.resolveName(b.$type),d=Container["create"+Container.resolveType(b.$type).name]();if(b.$selector){var f=b.$selector;f instanceof Array||(f=[f]);for(var i=0,e;i<f.length;){e=a;c=f[i].split(":");switch(c[0]){case "json":for(c=c[1].split(".");c.length;)if(typeof e[c[0]]==="undefined"||e[c[0]]===null){if(i===
f.length)return;if(c.length)break}else{e=e[c[0]];c=c.slice(1);if(e===null)return e}if(!c.length)i=f.length;break;case "css":case "xml":if(e.querySelector)e=e[b.$item?"querySelectorAll":"querySelector"](c[1]);else{e=$(e).find(c[1]);b.$item||(e=e[0])}}i++}a=e;if(!a)return a}if(b.$value)if(typeof b.$value==="function")d=b.$value.call(b,b,a);else if(b.$type){c=Container.resolveName(b.$type);d=(c=this.context.storageProvider.fieldConverter.fromDb[c])?c(b.$value):Container["create"+Container.resolveType(b.$type).name](b.$value)}else d=
b.$value;else if(b.$source)if(b.$type){c=Container.resolveName(b.$type);d=(c=this.context.storageProvider.fieldConverter.fromDb[c])?c(a[b.$source]):Container["create"+Container.resolveType(b.$type).name](a[b.$source])}else d=b.$source.split(":")[0]=="attr"&&a.getAttribute?a.getAttribute(b.$source.split(":")[1]):b.$source=="textContent"&&!a[b.$source]?$(a).text():a[b.$source];else if(b.$item)for(i=0;i<a.length;i++){var j=this.call(a[i],b.$item);d.push(j)}else{i="";if(b.$keys){for(j=0;j<b.$keys.length;j++)i=
i+(b.$type+"_"+b.$keys[j]+"#"+a[b.$keys[j]]);if(this.cache[i]){d=this.cache[i];for(j in b)j.indexOf("$")<0&&b[j].$item&&d[j].push(this.call(a,b[j].$item))}else{for(j in b)if(j.indexOf("$")<0)if(b[j].$item)d[j]=this.call(a,b[j]);else if(b[j].$type||b[j].$source)d[j]=this.call(a,b[j]);else if(b.$type){c=Container.resolveName(b.$type.memberDefinitions.getMember(j).type);c=this.context.storageProvider.fieldConverter.fromDb[c];d[j]=c?c(a[b[j]]):Container["create"+Container.resolveType(b.$type.memberDefinitions.getMember(j).type).name](a[b[j]])}else d[j]=
b[j].$source?a[b[j].$source]:a[b[j]];this.cache[i]=d}}else for(j in b)if(j.indexOf("$")<0)if(b[j].$item)d[j]=this.call(a,b[j]);else if(b[j].$type||b[j].$source)d[j]=this.call(a,b[j]);else if(b.$type){c=Container.resolveName(Container.resolveType(b.$type).memberDefinitions.getMember(j).type);c=this.context.storageProvider.fieldConverter.fromDb[c];d[j]=c?c(a[b[j]]):Container["create"+Container.resolveType(b.$type.memberDefinitions.getMember(j).type).name](a[b[j]])}else d[j]=b[j].$source?a[b[j].$source]:
a[b[j]]}return d}});
...
c,$data.Expressions.ExpressionType.OrderByDescending);return Container.createQueryable(this,c)},first:function(a,b,c){this._checkOperation("first");var d=this;a&&(d=this.filter(a,b));var d=d.take(1),a=new $data.PromiseHandler,c=a.createCallback(c),b=Container.createFirstExpression(d.expression),f=Container.createQueryExpressionCreator(d.entityContext);try{var i=f.Visit(b);d.entityContext.log({event:"EntityExpression",data:i});d.entityContext.executeQuery(Container.createQueryable(d,i),c)}catch(e){c.error(e)}return a.getPromise()},
include:function(a){this._checkOperation("include");a=Container.createConstantExpression(a,"string");a=Container.createIncludeExpression(this.expression,a);return Container.createQueryable(this,a)},_runQuery:function(a){var b=new $data.PromiseHandler,a=b.createCallback(a),c=Container.createQueryExpressionCreator(this.entityContext);try{var d=c.Visit(this.expression);this.entityContext.log({event:"EntityExpression",data:d});this.entityContext.executeQuery(Container.createQueryable(this,d),a)}catch(f){a.error(f)}return b.getPromise()},
...
$data.Class.defineEx("$data.EntitySet",[{type:$data.Queryable,params:[new ConstructorParameter(1)]}],null,{constructor:function(a,b,c,d,f){this.createNew=this[a.name]=a;this.stateManager=new $data.EntityStateManager(this);Object.defineProperty(this,"elementType",{value:a,enumerable:true});Object.defineProperty(this,"collectionName",{value:c,enumerable:true});Object.defineProperty(this,"roles",{value:f,enumerable:true});for(var i in d)this[i]=d[i];this._checkRootExpression()},executeQuery:function(a,
...
$data.ServiceOperation=function(){var a=arguments.callee,b=a.elementType?this.getEntitySetFromElementType(Container.resolveType(a.elementType)):null,c=null;if(a.params)for(var c=[],d=0;d<a.params.length;d++)for(var f in a.params[d])c.push(Container.createConstantExpression(arguments[d],Container.resolveType(a.params[d][f]),f));d=Container.createEntityContextExpression(this);f=this.getType().getMemberDefinition(a.serviceName);c=Container.createServiceOperationExpression(d,Container.createMemberInfoExpression(f),
c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}f=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=f;if(f===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};
Function.prototype.chain=function(a,b){var c=function(){var a=arguments.callee.chainFn,b=[];if(arguments.length)for(var c=0;c<arguments.length;c++)b.push(arguments[c]);var e=b.length,c=0,j=function(){if(b[b.length-1]&&b[b.length-1].success&&typeof b[b.length-1].success==="function")b[b.length-1].success.apply(this,arguments);else return arguments.length?arguments[0]:void 0},m=function(){var r=a[c];c++;r=r.apply(this,b);if(typeof r==="function"){var o=arguments;b[e]=c<a.length?function(){return m.apply(this,
...
Function.prototype.webInvoke=function(){return this.method("POST")};Function.prototype.authorize=function(a,b){var c={};if(a instanceof Array)for(var d=0;d<a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;this.roles=c;var f=this;return ret=function(){var a=new $data.PromiseHandler,c=a.createCallback(b),a=a.getPromise(),d=arguments;c.success=c.success.after(function(){f.apply(this,d)});$data.Access.isAuthorized($data.Access.Execute,this.user,f.roles,c);return a}};
Function.prototype.promise=function(a){var b=this;return function(){var c=new $data.PromiseHandler,d=c.createCallback(a),c=c.getPromise();arguments[arguments.length++]=d;b.apply(this,arguments);return c}};$data.ConcurrencyMode={Fixed:"fixed",None:"nonde"};
$data.Class.define("$data.StorageProviderBase",null,null,{constructor:function(a){this.providerConfiguration=a||{}},providers:{},supportedDataTypes:{value:[],writable:!1},initializeStore:function(){Guard.raise("Pure class")},executeQuery:function(){Guard.raise("Pure class")},buildIndependentBlocks:function(a){for(var b=[],c=[],d=0;d<a.length;d++){var f=a[d];if(f.dependentOn&&f.dependentOn.length!=0){for(var i=null,e=0;e<f.dependentOn.length;e++){var j=f.dependentOn[e];if(j.entityState!=$data.EntityState.Unchanged){for(var i=
i||{},m=-1,r=0;r<a.length;r++)if(a[r].data==j){m=r;break}m==-1&&Guard.raise(new Exception("Dependent object not found","ObjectNotFound",f.dependentOn[e]));i[m]=true;from=c[m]||{};from[d]=true;c[m]=from}}i!==null&&(b[d]=i)}}d=[];f=[];for(i=0;i<a.length;i++)b.hasOwnProperty(i)||f.push(i);for(;f.length>0;){i=[].concat(f);f=[];for(e=0;e<i.length;e++){j=c[i[e]];if(typeof j!=="undefined")for(var o in j){delete b[o][i[e]];a:{m=b[o];r=void 0;for(r in m)if(m.hasOwnProperty(r)){m=true;break a}m=false}if(!m){delete b[o];
f.push(o)}}delete c[i[e]]}e=[];for(j=0;j<i.length;j++){m=a[i[j]];m.data.entityState!=$data.EntityState.Unchanged&&e.push(m)}e.length>0&&d.push(e)}return d},getTraceString:function(){Guard.raise("Pure class")},setContext:function(a){this.context=a},supportedFieldOperations:{value:{length:{dataType:"number",allowedIn:"filter, map"},substr:{dataType:"string",allowedIn:"filter",parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}]},toLowerCase:{dataType:"string"}},enumerable:!0,
...
$data.Class.define("$data.dbClient.jayStorageClient.JayStorageCommand",$data.dbClient.DbCommand,null,{constructor:function(a,b,c){this.query=b;this.connection=a;this.parameters=c},executeNonQuery:function(a){a=$data.typeSystem.createCallbackSetting(a);this.exec(this.query,this.parameters,a.success,a.error)},executeQuery:function(a){a=$data.typeSystem.createCallbackSetting(a);this.exec(this.query,this.parameters,a.success,a.error)},exec:function(a,b,c,d){if(b==null||b==void 0)b={};var f=false;if(!(a instanceof
Array)){f=true;a=[a];b=[b]}var i=[],e=a.length,j=function(){--e==0&&c(f?i[0]:i)};a.forEach(function(a,c){if(a)$data.ajax({url:"http"+(this.connection.connectionParams.storage.ssl?"s":"")+"://"+this.connection.connectionParams.storage.src.replace("http://","").replace("https://","")+"?db="+this.connection.connectionParams.storage.key,type:"POST",headers:{"X-PINGOTHER":"pingpong"},data:{query:a,parameters:b[c]},dataType:"json",contentType:"application/json;charset=UTF-8",success:function(a){if(a&&a.error){console.log("JayStorage error",
...
if(b==null||b==void 0)b={};var f=false;if(!(a instanceof Array)){f=true;a=[a];b=[b]}var i=this,e=[],j=0,m=function(){if(--j==0){i.connection.database.exec("COMMIT");c(f?e[0]:e)}};i.connection.database.exec("BEGIN");a.forEach(function(a,c){j++;if(a){var f=function(a,b){if(a!=null)d(a);else{e[c]=this.lastID?{insertId:this.lastID,rows:[]}:{rows:b};m()}},C=i.connection.database.prepare(a,b[c]);a.indexOf("SELECT")==0?C.all(f):C.run(f);C.finalize()}else{e[c]=null;m()}},this)}},null);
...
this._includes.forEach(function(c){for(var d=c.name.split("."),f=null,i=b,e=0;e<d.length;e++){a.modelBinderConfig.$item&&a.selectModelBinderProperty("$item");a.selectModelBinderProperty(d[e]);f=i.Associations[d[e]];i=this._query.context._storageModel.getStorageModel(f.ToType)}a.modelBinderConfig.$selector=this._isoDataProvider?["json:"+d[d.length-1]+".results","json:"+d[d.length-1]]:"json:"+d[d.length-1];if(f.ToMultiplicity==="*"){a.modelBinderConfig.$type=$data.Array;a.selectModelBinderProperty("$item");
...
c(a)};$data.ajax(a)}},__encodeBase64:function(a){input=a;var a="",b,c,d="",f,i,e="",j=0;do{b=input.charCodeAt(j++);c=input.charCodeAt(j++);d=input.charCodeAt(j++);f=b>>2;b=(b&3)<<4|c>>4;i=(c&15)<<2|d>>6;e=d&63;isNaN(c)?i=e=64:isNaN(d)&&(e=64);a=a+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(i)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)}while(j<
