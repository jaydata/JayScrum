...
b:Math.floor(b/za.length*100)})};}function e(a,b,c,d,e,i){var f,m,b=b||g;m=b.line||0;f=b.from||0;a={id:"(error)",raw:H[a]||a,evidence:za[m-1]||"",line:m,character:f,a:c||b.value,b:d,c:e,d:i};a.reason=a.raw.supplant(a);JAYLINT.errors.push(a);k.passfail&&j(H.stopping,m,f);Ma=Ma+1;Ma>=k.maxerr&&j(H.too_many,m,f);return a}function i(a,b,c,d,g,i,f){return e(a,{line:b,from:c},d,g,i,f)}function m(a,b,c,d,g,i){a=e(a,b,c,d,g,i);j(H.stopping,a.line,a.character)}function r(a,b,c,d,g,e,i){return m(a,{line:b,
from:c},d,g,e,i)}function p(a){!k.white&&g.from!==a&&e("expected_a_at_b_c",g,g.value,a,g.from)}function z(a,b,c){if(a[b]!==c){e("expected_a_b",a,c,a[b]);return true}return false}function F(a,b,c){c=c||a.value;if(q===X){k.safe&&e("adsafe_a",a,c);if(typeof X[c]!=="string"){a.writeable=typeof Q[c]==="boolean"?Q[c]:true;a.funct=q;Aa[c]=a}b==="becoming"&&(b="var")}else if(typeof q[c]==="string")if(q[c]==="undef"){k.undef||e("used_before_a",a,c);b="var"}else e("already_defined",a,c);else{a.funct=q;a.writeable=
true;D[c]=a}q[c]=b}function s(a){for(var b,c=0,a=a||0;c<=a;){(b=Ba[c])||(b=Ba[c]=Ca.token());c=c+1}return b}function l(a){a=a||n;if(a.comments){for(var b=a.prev;b.comments===null;)b=b.prev;b.comments=b.comments?b.comments.concat(a.comments):a.comments}a.comments=null}function h(a,b){if(v){if(ea&&g.line!==n.line){if((ea!==v||!g.edge)&&g.from===v.at-(g.edge?k.indent:0)){for(var c=v;;){c.at=c.at-k.indent;if(c===ea)break;c=c.was}c.open=false}ea=null}if(v.open)if(g.edge)g.edge==="label"?p(1):g.edge===
"case"?p(v.at-k.indent):(v.mode!=="array"||g.line!==n.line)&&p(v.at);else{if(g.line!==n.line){g.from<v.at+(v.mode==="expression"?0:k.indent)&&p(v.at+k.indent);v.wrap=true}}else if(g.line!==n.line)if(g.edge)p(v.at);else{v.wrap=true;v.mode==="statement"||v.mode==="var"?p(v.at+k.indent):g.from<v.at+(v.mode==="expression"?0:k.indent)&&p(v.at+k.indent)}}switch(n.id){case "(number)":g.id==="."&&e("trailing_decimal_a");break;case "-":(g.id==="-"||g.id==="--")&&e("confusing_a");break;case "+":(g.id==="+"||
...
b.second.value&&b.second.id==="(string)";if(a.id==="["&&a.arity==="infix"&&b.id===".")return a.second.value===b.second.value&&a.second.id==="(string)"}return false}function w(a,b){var c;g.id==="(end)"&&m("unexpected_a",n,g.id);h();k.safe&&D[n.value]&&D[n.value]===Aa[n.value]&&g.id!=="("&&g.id!=="."&&e("adsafe",n);if(b){$a="anonymous";q["(verb)"]=n.value}if(b===true&&n.fud)c=n.fud();else{if(n.nud)c=n.nud();else{if(g.id==="(number)"&&n.id==="."){e("leading_decimal_a",n,g.value);h();return n}m("expected_identifier_a",
...
function bb(a){return(a=a.identifier&&D[a.value]||a)&&a.type}function L(a,b,c){var d="",g,i,f;if(typeof a!=="string"){i=a.identifier&&D[a.value]||a;a=i.type}f=b.identifier&&D[b.value]||b;g=f.type;if(a)g?a===g?d=a:k.type||e("type_inconsistency_a_b",c||b,a,g):f.type=d=a;else if(g){if(i)i.type=g;d=g}return d}function E(a,b){var c=M(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function va(b,c,d){b=E(b);b.type=c;b.value=d;b.nud=a;return b}function cb(a,b){return E(a,function(){typeof b===
...
(!a.identifier||a.reserved)&&a.id!=="."&&a.id!=="["&&e("bad_operand",this):e("unexpected_a",this);this.first=a;this.arity="suffix";return this};return a}function pa(){if(g.identifier){h();k.safe&&Qa[n.value]?e("adsafe_a",n):n.reserved&&!k.es5&&e("expected_identifier_a_reserved",n);return n.value}}function db(){var a,b=D;if(g.id===";"){e("unexpected_a");V()}else{if(g.identifier&&!g.reserved&&s().id===":"){x("label");a=g;h();l();h(":");l();D=Object.create(b);F(a,"label");g.labeled!==true?e("label_a_b",
g,a.value,g.value):eb.test(a.value+":")?e("url",a):q===X&&m("unexpected_a",n);g.label=a}x();K("statement");if(a=w(0,true))if(a.arity==="statement")a.id==="switch"||a.block&&a.id!=="do"?J():V();else{a.id==="("?a.first.id==="new"&&e("bad_new"):!a.assign&&a.id!=="delete"&&a.id!=="++"&&a.id!=="--"&&e("assignment_function_expression",n);V()}A();D=b;return a}}function qa(){for(var a=[],b,c;g.postscript!==true;)if(g.id===";"){e("unexpected_a",g);V()}else{if(g.value==="use strict"){(!La||q!==X||a.length>
0)&&e("function_strict");Na()}if(b){e("unreachable_a_b",g,g.value,b.value);b=null}if(c=db()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ca(a){var b,c=g,d=Fa,i=D,f=na;Fa=a;D=Object.create(D);J();if(g.id==="{"){h("{");K();!a&&!Na()&&!f&&!k.sloppy&&q["(context)"]===X&&e("missing_use_strict");b=qa();na=f;A("}",c);l()}else if(a){e("expected_a_b",g,"{",g.value);b=[db()];b.disrupt=b[0].disrupt}else m("expected_a_b",g,"{",g.value);q["(verb)"]=null;D=i;Fa=d;a&&b.length===0&&e("empty_block");
...
b+I(a.first);break;case "case":case "infix":b=b+(I(a.first)+I(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(I(a.first)+I(a.second)+I(a.third))}return b}function Sa(a,b){var d=q,e=k,i=ha,f=D;q={"(name)":b||"'"+($a||"").replace(ub,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":D,"(token)":a};ha=i&&Object.create(i);k=Object.create(e);D=Object.create(f);Ta.push(q);(a.name=b)&&F(a,"function",b);a.writeable=false;var m=q,j;a:{var r=g,p=[];h("(");K();
l();u();if(g.id===")"){u();A(")",r);l();j=void 0}else for(;;){x();pa();p.push(n);F(n,k.unparam?"parameter":"unparam");if(g.id===",")G();else{u();A(")",r);l();j=p;break a}}}a.first=m["(params)"]=j;a.type="function";y();a.block=ca(false);q["(complexity)"]=I(a.block)+1;q=d;k=e;ha=i;D=f}function gb(){function a(){var b=g,c={};h("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){e("unexpected_a",g);G()}g.id!=="(string)"&&e("expected_string_a");c[g.value]===true?e("duplicate_a"):g.value==="__proto__"?
...
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&e("expected_fraction_a",g);h();if(g.id==="%"){e("unexpected_a");h("%")}}h(")",c);return true}if(Mb[g.value]===true){h();return true}}else if(g.id==="(color)"){h();return true}return false}function C(){if(g.id==="-"){h("-");B()}if(g.id==="(number)"){h();if(g.id!=="(string)"&&vb[g.value]===true){B();h()}else+n.value!==0&&e("expected_linear_a");return true}return false}function xa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":h();return true}else return C()}
function Ga(){if(g.identifier){if(g.value==="auto"){h();return true}}else return C()}function sa(){var a,b;if(g.identifier&&g.value==="url"){g=Ca.range("(",")");b=g.value;a=b.charAt(0);if(a==='"'||a==="'")if(b.slice(-1)!==a)e("bad_url");else{b=b.slice(1,-1);b.indexOf(a)>=0&&e("bad_url")}b||e("missing_url");k.safe&&wb.test(b)&&m("adsafe_a",g,b);Ha.push(b);h();return true}return false}function jb(a){var b=0,c,d,e,i=0;switch(typeof a){case "function":return a();case "string":if(g.identifier&&g.value===
a){h();return true}return false}for(;;){if(b>=a.length)return false;e=a[b];b=b+1;if(typeof e==="boolean")break;else if(typeof e==="number"){c=e;e=a[b];b=b+1}else c=1;for(d=false;c>0;)if(jb(e)){d=true;c=c-1}else break;if(d)return true}i=b;for(c=[];;){e=false;for(b=i;b<a.length;b=b+1)if(!c[b]&&jb(Va[a[b]])){e=d=true;c[b]=true;break}if(!e)return d}}function xb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){e("unexpected_a");V()}for(a=void 0;g.id==="*"||g.id==="#"||
...
i("unexpected_comment",d,e):t==="script"&&/<\//i.test(l)?i("unexpected_a",d,e,"</"):k.safe&&Sb.test(b)&&i("dangerous_comment",d,g);ta.comments?ta.comments.push(c):ta.comments=[c];JAYLINT.comments.push(c)}function b(){var a;if(h>=za.length)return false;e=1;l=za[h];h=h+1;a=l.search(/ \t/);a>=0&&i("mixed",h,a+1);l=l.replace(/\t/g,Za);a=l.search(Vb);a>=0&&i("unsafe",h,a);k.maxlen&&k.maxlen<l.length&&i("too_long",h,l.length);return true}function c(a,b,d){var g;(a==="(string)"||a==="(range)")&&eb.test(b)&&
i("url",h,j);g=Object.create(Y[a==="(punctuator)"||a==="(identifier)"&&Object.prototype.hasOwnProperty.call(Y,b)?b:a]||Y["(error)"]);if(a==="(identifier)"){g.identifier=true;b==="__iterator__"||b==="__proto__"?r("reserved_a",h,j,b):!k.nomen&&(b.charAt(0)==="_"||b.charAt(b.length-1)==="_")&&i("dangling_a",h,j,b)}if(b!==void 0)g.value=b;if(d)g.quote=d;g.line=h;g.from=j;g.thru=e;g.prev=ta;pb=(a=g.id)&&("(,=:[!&|?{};".indexOf(a.charAt(a.length-1))>=0||a==="return");return ta=ta.next=g}function d(a){function g(a){var b=
parseInt(l.substr(o+1,a),16);o=o+a;b>=32&&b<=126&&b!==34&&b!==92&&b!==39&&i("unexpected_a",h,e,"\\");e=e+a;f=String.fromCharCode(b)}var f,o,m="";ma&&a!=='"'&&i("expected_a",h,e,'"');if(T===a||t==="scriptstring"&&!T)return c("(punctuator)",a);for(o=0;;){for(;o>=l.length;){o=0;(t!=="html"||!b())&&r("unclosed",h,j)}f=l.charAt(o);if(f===a){e=e+1;l=l.slice(o+1);return c("(string)",m,a)}if(f<" "){if(f==="\n"||f==="\r")break;i("control_a",h,e+p,l.slice(0,p))}else if(f===T)i("bad_html",h,e+o);else if(f===
"<")k.safe&&t==="html"?i("adsafe_a",h,e+p,f):l.charAt(p+1)==="/"&&(t||k.safe)?i("expected_a_b",h,e,"<\\/","</"):l.charAt(p+1)==="!"&&(t||k.safe)&&i("unexpected_a",h,e,"<!");else if(f==="\\")if(t==="html")k.safe&&i("adsafe_a",h,e+p,f);else if(t==="styleproperty"){o=o+1;e=e+1;f=l.charAt(o);f!==a&&i("unexpected_a",h,e,"\\")}else{o=o+1;e=e+1;f=l.charAt(o);switch(f){case "":k.es5||i("es5",h,e);b();o=-1;break;case T:i("bad_html",h,e+o);break;case "'":ma&&i("unexpected_a",h,e,"\\'");break;case "u":g(4);
break;case "v":ma&&i("unexpected_a",h,e,"\\v");f="\v";break;case "x":ma&&i("unexpected_a",h,e,"\\x");g(2);break;default:f=Ob[f];typeof f!=="string"&&i("unexpected_a",h,e,"\\")}}m=m+f;e=e+1;o=o+1}}function g(){for(var a,b,d=0,o=0;;){a=true;f=l.charAt(o);o=o+1;switch(f){case "":r("unclosed_regexp",h,j);return;case "/":d>0&&i("unescaped_a",h,j+o,"/");f=l.slice(0,o-1);for(d=Object.create(Pb);d[l.charAt(o)]===true;){d[l.charAt(o)]=false;o=o+1}l.charAt(o).isAlpha()&&r("unexpected_a",h,j,l.charAt(o));e=
e+o;l=l.slice(o);o=l.charAt(0);(o==="/"||o==="*")&&r("confusing_regexp",h,j);return c("(regexp)",f);case "\\":f=l.charAt(o);f<" "?i("control_a",h,j+o,""+f):f==="<"&&i(H.unexpected_a,h,j+o,"\\");o=o+1;break;case "(":d=d+1;a=false;if(l.charAt(o)==="?"){o=o+1;switch(l.charAt(o)){case ":":case "=":case "!":o=o+1;break;default:i(H.expected_a_b,h,j+o,":",l.charAt(o))}}break;case "|":a=false;break;case ")":d===0?i("unescaped_a",h,j+o,")"):d=d-1;break;case " ":for(p=1;l.charAt(o)===" ";){o=o+1;p=p+1}p>1&&
i("use_braces",h,j+o,p);break;case "[":f=l.charAt(o);if(f==="^"){o=o+1;k.regexp?l.charAt(o)==="]"&&r("unescaped_a",h,j+o,"^"):i("insecure_a",h,j+o,f)}b=false;if(f==="]"){i("empty_class",h,j+o-1);b=true}a:do{f=l.charAt(o);o=o+1;switch(f){case "[":case "^":i("unescaped_a",h,j+o,f);b=true;break;case "-":if(b)b=false;else{i("unescaped_a",h,j+o,"-");b=true}break;case "]":b||i("unescaped_a",h,j+o-1,"-");break a;case "\\":f=l.charAt(o);f<" "?i(H.control_a,h,j+o,""+f):f==="<"&&i(H.unexpected_a,h,j+o,"\\");
o=o+1;b=true;break;case "/":i("unescaped_a",h,j+o-1,"/");b=true;break;case "<":if(t==="script"){f=l.charAt(o);(f==="!"||f==="/")&&i(H.html_confusion_a,h,j+o,f)}b=true;break;default:b=true}}while(f);break;case ".":k.regexp||i("insecure_a",h,j+o,f);break;case "]":case "?":case "{":case "}":case "+":case "*":i("unescaped_a",h,j+o,f);break;case "<":if(t==="script"){f=l.charAt(o);(f==="!"||f==="/")&&i(H.html_confusion_a,h,j+o,f)}}if(a)switch(l.charAt(o)){case "?":case "+":case "*":o=o+1;l.charAt(o)===
"?"&&(o=o+1);break;case "{":o=o+1;f=l.charAt(o);(f<"0"||f>"9")&&i(H.expected_number_a,h,j+o,f);o=o+1;for(b=+f;;){f=l.charAt(o);if(f<"0"||f>"9")break;o=o+1;b=+f+b*10}a=b;if(f===","){o=o+1;a=Infinity;f=l.charAt(o);if(f>="0"&&f<="9"){o=o+1;for(a=+f;;){f=l.charAt(o);if(f<"0"||f>"9")break;o=o+1;a=+f+a*10}}}l.charAt(o)!=="}"?i(H.expected_a_b,h,j+o,"}",f):o=o+1;l.charAt(o)==="?"&&(o=o+1);b>a&&i(H.not_greater,h,j+o,b,a)}}f=l.slice(0,o-1);e=e+o;l=l.slice(o);return c("(regexp)",f)}var e,f,j,m,h,p,l;return{init:function(a){za=
typeof a==="string"?a.replace(Ub,"\n").replace(Tb,"\n").split("\n"):a;h=0;b();j=1},range:function(a,b){var d,g="";j=e;for(l.charAt(0)!==a&&r("expected_a_b",h,e,a,l.charAt(0));;){l=l.slice(1);e=e+1;d=l.charAt(0);switch(d){case "":r("missing_a",h,e,d);break;case b:l=l.slice(1);e=e+1;return c("(range)",g);case T:case "\\":i("unexpected_a",h,e,d)}g=g+d}},token:function(){for(var k,p,s;;){for(;!l;)if(!b())return c("(end)");for(;t==="outer";){p=l.search(Yb);if(p===0)break;else if(p>0){e=e+1;l=l.slice(p);
break}else if(!b())return c("(end)","")}k=(ac[t]||$b).exec(l);s=void 0;if(k){m=k[0].length;s=k[1];f=s.charAt(0);l=l.slice(m);j=e+m-s.length;e=e+m}else s=void 0;if(s){k=s.charAt(0);if(k.isAlpha()||k==="_"||k==="$")return c("(identifier)",s);if(k.isDigit()){p=s;k=void 0;t!=="style"&&t!=="styleproperty"&&l.charAt(0).isAlpha()&&i("expected_space_a_b",h,e,f,l.charAt(0));if(f==="0"){k=p.charAt(1);k.isDigit()?n.id!=="."&&t!=="styleproperty"&&i("unexpected_a",h,e,p):ma&&(k==="x"||k==="X")&&i("unexpected_a",
h,e,"0x")}p.slice(p.length-1)==="."&&i("trailing_decimal_a",h,e,p);if(t!=="style"){k=+p;isFinite(k)||i("bad_number",h,e,p);p=k}return c("(number)",p)}switch(s){case '"':case "'":return d(s);case "//":a(l,"//",h,e);l="";break;case "/*":for(k="/*";;){p=l.search(Xb);if(p>=0)break;a(l,k,h,e);k="";b()||r("unclosed_comment",h,e)}a(l.slice(0,p),k,e,h);e=e+(p+2);l.charAt(p)==="/"&&r("nested_comment",h,e);l=l.slice(p+2);break;case "":break;case "/":n.id==="/="&&r(H.slash_equal,h,j);return pb?g():c("(punctuator)",
...
funct:X};X[a]="var"}else{k.undef||e("used_before_a",n);D[a]=b={value:a,writeable:true,funct:q};q[a]="undef"}}b=b.funct;if(q===b)switch(q[a]){case "becoming":e("unexpected_a",n);q[a]="var";break;case "unused":q[a]="var";break;case "unparam":q[a]="parameter";break;case "unction":q[a]="function";break;case "label":e("a_label",n,a)}else switch(q[a]){case "closure":case "function":case "var":case "unused":e("a_scope",n,a);break;case "label":e("a_label",n,a);break;case "outer":case "global":break;default:switch(b[a]){case "function":case "unction":case "var":case "unused":case "becoming":case "closure":case "parameter":b[a]=
...
this);y();this.arity="statement";this.block=ca(false);if(g.id==="catch"){y();h("catch");l();y();c=g;h("(");K("control");l();u();x();b=D;D=Object.create(b);this.first=a=g.value;g.identifier?F(g,"exception"):e("expected_identifier_a",g);h();u();A(")",c);l();y();this.second=ca(false);D=b}if(g.id==="finally"){l();y();h("finally");l();y();this.third=ca(false)}else this.second||m("expected_a_b",g,"catch",g.value);return this});Oa("while",function(){y();var a=g;q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=
q["(loopage)"]+1;h("(");K("control");l();u();x();this.arity="statement";this.first=aa(w(0));this.first.id!=="true"&&ba(this.first,H.unexpected_a);u();A(")",a);l();y();this.block=ca(true);this.block.disrupt&&e("strange_loop",U);q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});E("with");Oa("switch",function(){var a,b=g,c=true;q["(breakage)"]=q["(breakage)"]+1;y();h("(");l();u();K();this.arity="statement";this.first=ba(aa(w(0)));u();A(")",b);l();y();h("{");K();for(this.second=
...
"white-space":["normal","nowrap","pre","pre-line","pre-wrap","inherit"],width:[C,"auto"],"word-spacing":["normal",C],"word-wrap":["break-word","normal"],"z-index":["auto",Ua]};da=function(a,b){var c,i,j;JAYLINT.comments=[];JAYLINT.errors=[];JAYLINT.tree="";nb=ta=U=n=g=Object.create(Y["(begin)"]);Q={};d(Qb);if(b){k=Object.create(b);if(i=k.predef)if(Array.isArray(i))for(c=0;c<i.length;c=c+1)Q[i[c]]=true;else typeof i==="object"&&d(i);fa()}else k={};k.indent=+k.indent||0;k.maxerr=k.maxerr||50;W="";Ia=
Ja=la=false;Wa={};if(k.approved)for(c=0;c<k.approved.length;c=c+1)Wa[k.approved[c]]=k.approved[c];else Wa.test="test";Za="";for(c=0;c<k.indent;c=c+1)Za=Za+" ";Aa=D={};X=q={"(scope)":D,"(breakage)":0,"(loopage)":0};Ta=[q];Da=false;Ya={};Fa=false;v=null;ma=false;Ba=[];ra={};La=false;ha=null;pb=true;qb=false;O=null;na=false;Ha=[];ea=null;Ma=0;t="";Ca.init(a);f();try{h();if(g.id==="(number)")m("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var l,p,r,s,F=k.white,y,B,A,w;t="html";T="";for(O=null;;){switch(g.value){case "<":t=
"html";h("<");p={};B=g;B.identifier||e("bad_name_a",B);s=B.value;k.cap&&(s=s.toLowerCase());B.name=s;h();if(!O){O=[];c=s;c!=="html"&&!k.fragment&&(c==="div"&&k.adsafe?m("adsafe_fragment"):m("expected_a_b",n,"html",c));if(k.adsafe){c==="html"&&m("adsafe_html",n);k.fragment?c!=="div"&&m("adsafe_div",n):m("adsafe_fragment",n)}k.browser=true}A=mb[s];typeof A!=="object"&&m("unrecognized_tag_a",B,s);r=A.empty;for(B.type=s;;){if(g.id==="/"){h("/");g.id!==">"&&e("expected_a_b",g,">",g.value);break}if(g.id&&
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&e("expected_a_b",g,">",g.value);e("bad_name_a")}k.white=false;J();l=g.value;k.white=F;h();!k.cap&&l!==l.toLowerCase()&&e("attribute_case_a",n);l=l.toLowerCase();T="";Object.prototype.hasOwnProperty.call(p,l)&&e("duplicate_a",n,l);if(l.slice(0,2)==="on"){k.on||e("html_handlers");t="scriptstring";h("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);T=y;w=k.white;k.white=true;h(y);Na();qa();k.white=w;g.id!==y&&
m("expected_a_b",g,y,g.value);t="html";T="";h(y);A=false}else if(l==="style"){t="scriptstring";h("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);t="styleproperty";T=y;h(y);xb();t="html";T="";h(y);A=false}else if(g.id==="="){h("=");A=g.value;!g.identifier&&g.id!=='"'&&g.id!=="'"&&g.id!=="(string)"&&g.id!=="(string)"&&g.id!=="(color)"&&e("expected_attribute_value_a",n,l);h()}else A=true;p[l]=A;c=l;i=A;var u=j=void 0;if(c==="id"){j=typeof i==="string"?i.toUpperCase():"";Ya[j]===true&&e("duplicate_a",
g,i);if(/^[A-Za-z][A-Za-z0-9._:\-]*$/.test(i)){if(k.adsafe)if(W)i.slice(0,W.length)!==W?e("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(i)||e("adsafe_bad_id");else{W=i;/^[A-Z]+_$/.test(i)||e("adsafe_bad_id")}}else e("bad_id_a",g,i);u=i.search(Wb);u>=0&&e("unexpected_char_a_b",n,i.charAt(u),c);Ya[j]=true}else if(c==="class"||c==="type"||c==="name"){u=i.search(Zb);u>=0&&e("unexpected_char_a_b",n,i.charAt(u),c);Ya[j]=true}else if(c==="href"||c==="background"||c==="content"||c==="data"||c.indexOf("src")>=
0||c.indexOf("url")>=0){k.safe&&wb.test(i)&&m("bad_url",g,i);Ha.push(i)}else c==="for"?k.adsafe&&(W?i.slice(0,W.length)!==W?e("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(i)||e("adsafe_bad_id"):e("adsafe_bad_id")):c==="name"&&k.adsafe&&i.indexOf("_")>=0&&e("adsafe_name_a",g,i)}c=s;i=p;j=void 0;var C=mb[c],E=u=void 0;qb=false;C||m(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(O.length>0){c==="html"&&m("unexpected_a",n,c);if(E=C.parent)E.indexOf(" "+O[O.length-1].name+
" ")<0&&m("tag_a_in_b",n,c,E);else if(!k.adsafe&&!k.fragment){j=O.length;do{j<=0&&m("tag_a_in_b",n,c,"body");j=j-1}while(O[j].name!=="body")}}switch(c){case "div":k.adsafe&&O.length===1&&!W&&e("adsafe_missing_id");break;case "script":t="script";h(">");i.lang&&e("lang",n);k.adsafe&&O.length!==1&&e("adsafe_placement",n);if(i.src){k.adsafe&&(!Ia||!Wa[i.src])&&e("adsafe_source",n);i.type&&e("type",n)}else{K(g.from);x();Na();Ja=true;u=qa();if(k.adsafe){la&&m("adsafe_script",n);(u.length!==1||z(u[0],"id",
...
null}t="html";h("</");!g.identifier&&g.value!=="script"&&e("expected_a_b",g,"script",g.value);h();t="outer";break;case "style":t="style";h(">");zb();t="html";h("</");!g.identifier&&g.value!=="style"&&e("expected_a_b",g,"style",g.value);h();t="outer";break;case "input":switch(i.type){case "radio":case "checkbox":case "button":case "reset":case "submit":break;case "text":case "file":case "password":case "file":case "hidden":case "image":k.adsafe&&i.autocomplete!=="off"&&e("adsafe_autocomplete");break;
...
!la&&e("adsafe_go",this)}else switch(g.id){case "{":case "[":ma=true;gb();break;case "@":case "*":case "#":case ".":case ":":t="style";h();(n.id!=="@"||!g.identifier||g.value!=="charset"||n.line!==1||n.from!==1)&&m("css");h();g.id!=="(string)"&&g.value!=="UTF-8"&&m("css");h();V();zb();break;default:k.adsafe&&k.fragment&&m("expected_a_b",g,"<div>",g.value);K(1);g.id===";"&&!La&&V();Ja=true;j=qa();nb.first=j;JAYLINT.tree=nb;k.adsafe&&(j.length!==1||z(j[0],"id","(")||z(j[0].first,"id",".")||z(j[0].first.first,
"value","ADSAFE")||z(j[0].first.second,"value","lib")||j[0].second.length!==2||j[0].second[0].id!=="(string)"||z(j[0].second[1],"id","function"))&&m("adsafe_lib");j.disrupt&&e("weird_program",U)}v=null;h("(end)")}catch(G){G&&JAYLINT.errors.push({reason:G.message,line:G.line||g.line,character:G.character||g.from},null)}return JAYLINT.errors.length===0};da.data=function(){var a={functions:[]},b,c,d,e,g,f=[],i=[];if(da.errors.length)a.errors=da.errors;if(ma)a.json=true;if(Ha.length>0)a.urls=Ha;b=Object.keys(Aa).filter(function(a){return a.charAt(0)!==
"("?a:void 0});if(b.length>0)a.globals=b;for(c=1;c<Ta.length;c=c+1){g=Ta[c];b={};for(d=0;d<Ka.length;d=d+1)b[Ka[d]]=[];for(e in g)if(Object.prototype.hasOwnProperty.call(g,e)&&e.charAt(0)!=="("){d=g[e];if(d==="unction"||d==="unparam")d="unused";if(Array.isArray(b[d])){b[d].push(e);d==="unused"?i.push({name:e,line:g["(line)"],"function":g["(name)"]}):d==="undef"&&f.push({name:e,line:g["(line)"],"function":g["(name)"]})}}for(d=0;d<Ka.length;d=d+1)b[Ka[d]].length===0&&delete b[Ka[d]];b.name=g["(name)"];
b.param=g["(params)"];b.line=g["(line)"];b["(complexity)"]=g["(complexity)"];a.functions.push(b)}if(i.length>0)a.unused=i;if(f.length>0)a.undef=f;for(e in ra)if(typeof ra[e]==="number"){a.member=ra;break}return a};da.report=function(a){function b(a,c){var d,e;if(Array.isArray(c)){h.push("<div><i>"+a+"</i> ");c=c.sort().forEach(function(a){if(a!==e){e=a;h.push((d?", ":"")+e);d=true}});h.push("</div>")}else c&&h.push("<div><i>"+a+"</i> "+c+"</div>")}var d=da.data(),e,g,f,i;g="";var j,h=[];if(d.errors||
d.unused||d.undef){e=true;h.push("<div id=errors><i>Error:</i>");if(d.errors)for(f=0;f<d.errors.length;f=f+1)if(i=d.errors[f]){g=i.evidence||"";h.push("<p>Problem"+(isFinite(i.line)?" at line "+i.line+" character "+i.character:"")+": "+i.reason.entityify()+"</p><p class=evidence>"+(g&&(g.length>80?g.slice(0,77)+"...":g).entityify())+"</p>")}if(d.undef){g=[];for(f=0;f<d.undef.length;f=f+1)g[f]="<code><u>"+d.undef[f].name+"</u></code>&nbsp;<i>"+d.undef[f].line+" </i> <small>"+d.undef[f]["function"]+
...
e.exception);b("Outer",e.outer);b("Global",e.global);b("Label",e.label);b("Complexity",e["(complexity)"])}if(d.member){e=Object.keys(d.member);if(e.length){e=e.sort();g="<br><pre id=properties>/*properties ";i=13;for(f=0;f<e.length;f=f+1){a=e[f];j=Cb.test(a)?a:"'"+a.entityify().replace(ub,c)+"'";if(i+j.length>72){h.push(g+"<br>");g="    ";i=1}i=i+(j.length+2);d.member[a]===1&&(j="<i>"+j+"</i>");f<e.length-1&&(j=j+", ");g=g+j}h.push(g+"<br>*/</pre>")}h.push("</div>")}}return h.join("")};da.jslint=
...
f.prototype={getClass:function(){},getProperties:function(a){return a.propertyDefinitions},define:function(a,b,c,d,e){return this.defineEx(a,[{type:b}],c,d,e)},defineEx:function(b,c,d,e,f){if(c.length==0)c.push({type:a.Base});else if(c.length>0&&!c[0].type)c[0].type=a.Base;for(var d=0,j=c.length;d<j;d++)typeof c[d]==="function"&&(c[d]={type:c[d]});for(var j=b.split("."),s=j.splice(j.length-1,1)[0],l=window,d=0;d<j.length;d++){var h=j[d];l[h]||(l[h]={__namespace:true});l=l[h]}d=null;d=this.classFunctionBuilder(s,
c,f,e);d.fullName=b;d.namespace=j.join(".");this.buildType(d,c,e,f);d.name=s;Container.registerType(b,d);typeof intellisense!=="undefined"&&e&&e.constructor&&intellisense.annotate(d,e.constructor);return l[s]=this.classNames[b]=d},classFunctionBuilder:function(a,b,c,d){return(new Function("base","classDefinition","instanceDefinition","return function "+a+" (){ "+this.bodyBuilder(b,c,d)+" \n}; "))(b,c,d)},bodyBuilder:function(a,b,c){for(var d=b="",e="",f=0,j=a.length;f<j;f++){var l=a[f],h=f;if(h==
0){if(l&&l.type){d=d+("    var baseArguments = $data.typeSystem.createCtorParams(arguments, base["+h+"].params, this); \n");d=d+("    "+l.type.fullName+".apply(this, baseArguments); \n")}}else if(l&&l.type&&l.propagateTo){e=e+("    "+(!e?"var ":"")+"propagationArguments = $data.typeSystem.createCtorParams(arguments, base["+h+"].params, this); \n");e=e+('    this["'+l.propagateTo+'"] =  Object.create('+l.type.fullName+".prototype); \n    "+l.type.fullName+'.apply(this["'+l.propagateTo+'"], propagationArguments); \n')}else l&&
l.type&&l.type.memberDefinitions&&l.type.memberDefinitions.$constructor&&!l.propagateTo&&(b=b+("    "+l.type.fullName+".memberDefinitions.$constructor.method.apply(this); \n"))}c&&c.constructor!=Object&&(d=d+"    instanceDefinition.constructor.apply(this, arguments); \n");return"\n    //mixins \n"+b+"\n    //construction \n"+d+"\n    //propagations \n"+e},buildType:function(b,c,e,f){var j=c[0].type;if(b.inheritsFrom=j){b.prototype=Object.create(j.prototype);b.memberDefinitions=Object.create(j.memberDefinitions||
new d);b.memberDefinitions.clearCache();var F=j.staticDefinitions;if(F)if(F=F.asArray())for(var s=0;s<F.length;s++)this.buildMember(b,F[s],void 0,"staticDefinitions");b.baseTypes=j.baseTypes||[];for(s=0;s<c.length;s++)b.baseTypes.push(c[s].type);b.isAssignableTo||Object.defineProperty(b,"isAssignableTo",{value:function(a){return this===a||this.baseTypes.indexOf(a)>=0},writable:false,enumerable:false,configurable:false})}if(f){this.buildStaticMembers(b,f);if(f.constructor)b.classConstructor=f.constructor}e&&
...
c[d].name;f!=="constructor"&&!a.memberDefinitions.getMember(f)&&this.buildMember(a,c[d])}},buildInstancePropagation:function(a,b){for(var c=b.type.memberDefinitions.asArray(),d=0,e=c.length;d<e;d++){var f=c[d].name;f!=="constructor"&&!a.memberDefinitions.getMember(f)&&this.buildMember(a,c[d],b.propagateTo)}}};a.Class=Class=new f;(function(b){a.Number=typeof Number!=="undefined"?Number:function(){};a.Integer=typeof Integer!=="undefined"?Integer:function(){};a.Date=typeof Date!=="undefined"?Date:function(){};
...
a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return"";case a.Boolean:return false;default:return null}};this.registerType=function(a,e,j){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var i=[];i.push(a);a=i}for(i=0;i<a.length;i++){var z=a[i].split("."),x={};x.shortName=z[z.length-1];x.fullName=a[i];a[i]=x}z=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);b.apply(c,
a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(z,e);for(var i=0,K=a.length;i<K;i++){x=a[i];"create"+x.shortName in f?console&&console.warn("warning: short names overlap:"+x.shortName+", Container.create"+x.shortName+" has not been updated"):f["create"+x.shortName]=typeof j==="function"?j:z;var A=d.indexOf(e);if(A==-1){A=d.push(e)-1;c[A]=x.fullName}x.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+x.fullName);b[x.fullName]=A}if(!e.name)e.name=
...
{success:a}):this.extend(c,a)},createCtorParams:function(a,b,c){if(b){for(var d=[],f=0,j=b.length;f<j;f++){var e=f;b[e]instanceof ConstructorParameter?d.push(a[b[e].paramIndex]):typeof b[e]==="function"?d.push(b[e].apply(c)):d.push(b[e])}return d}return a},writePropertyValues:function(a){a&&a.getType&&a.getType().memberDefinitions&&this.writeProperties(a,a.getType().memberDefinitions.asArray().filter(function(a){return(a.kind=="property"||a.kind=="navProperty"||a.kind=="complexProperty")&&!a.prototypeProperty}))},
writeProperties:function(a,b){for(var c={},d=0,f=b.length;d<f;d++){var j=b[d];c[j.name]=j.createPropertyDescriptor(null,j.value)}Object.defineProperties(a,c)},writeProperty:function(a,b,c){if(b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b){c=b.createPropertyDescriptor(null,c);Object.defineProperty(a,b.name,c)}}};$data.ASTNode=function(){};$data.FunctionASTNode=function(){};$data.FunctionASTNode.prototype=new $data.ASTNode;$data.ParameterASTNode=function(){};
...
Container.createPropertyExpression(c,d)},VisitCall:function(a,b){var c=$data.Expressions.ExpressionVisitor.prototype.VisitCall.apply(this,arguments),d=c.expression,f=c.member,j=c.args;if(function(a,b,c){return b instanceof $data.Expressions.ConstantExpression&&(!c||c instanceof $data.Expressions.ConstantExpression)&&a.every(function(a){return a instanceof $data.Expressions.ConstantExpression})}(j,f,d)){c=f.value;typeof c==="string"&&d.value&&(c=d.value[c]);typeof c!=="function"&&Guard.raise("Constant expression is not a method...");
d=a.implementation(d.value,c,j);return new $data.Expressions.ConstantExpression(d)}return c}},{});$C("$data.Expressions.AggregatedVisitor",$data.Expressions.ExpressionVisitor,null,{constructor:function(a){this.Visit=function(b,c){for(var d=0;d<a.length;d++){var f=a[d].Visit(b,c);if(f!==b)return f}return b}}});
...
for(var f=[],j=0;j<d.length;j++){var e=d[j];f.push(typeof e.value=="string"?"'"+e.value+"'":e.value)}c=c?"value = object.value[eNode.method]("+f.join(",")+");":"value = "+a.method+"("+f.join(",")+");";eval(c);return $data.Expressions.ExpressionNodeTypes.LiteralExpressionNode.create(true,"undefined",void 0)},VisitArrayAccess:function(a,b){var c=this.Visit(a.array,b),d=this.Visit(a.index,b),c=c.value[d.value];return $data.Expressions.ExpressionNodeTypes.LiteralExpressionNode.create(true,typeof c,c)}},
null);
...
$data.Class.define("$data.Access",null,null,{},{isAuthorized:function(a,b,c,d){console.log("isAuthorized",arguments);var f;a||(f="Access undefined");typeof a!=="number"&&(f="Invalid access type");b||(b={});if(!b.roles)b.roles={};c||(c={});c instanceof Array||typeof c==="object"||(f="Invald roles type");var j=new $data.PromiseHandler,e=j.createCallback(d),j=j.getPromise();if(f){e.error(f,"Access authorization");return j}if(b.roles instanceof Array){f={};for(var i=0;i<b.roles.length;i++)typeof b.roles[i]===
"string"&&(f[b.roles[i]]=true);b.roles=f}if(c instanceof Array){f={};for(i=0;i<c.length;i++)typeof c[i]==="string"&&(f[c[i]]=true);c=f}var m=arguments,r=function(a){a?e.success(a):e.error("Authorization failed",m)},p=Object.getOwnPropertyNames(c),i=0,z=function(d){d&&r(d);if(typeof c[p[i]]==="boolean"&&c[p[i]])if(b.roles[p[i]])r(true);else{i++;i<p.length?z():r(false)}else if(typeof c[p[i]]==="function"){d=c[p[i]].call(b);if(typeof d==="function")d.call(b,i<p.length?z:r);else if(d)r(true);else{i++;
...
$data.Class.define("$data.EntityContext",null,null,{constructor:function(a,b){this.trackChanges=this.lazyLoad=false;this._entitySetReferences={};this._storageModel=[];var c=this;this._storageModel.getStorageModel=function(a){var b=Container.resolveType(a);return c._storageModel.filter(function(a){return a.LogicalType===b})[0]};if(typeof a.name==="string")a.name=[a.name];var d=[].concat(a.name),f=$data.typeSystem.createCallbackSetting({success:this._successInitProvider});$data.StorageProviderLoader.load(d,
{success:function(d){c.storageProvider=new d(a,c);c.storageProvider.setContext(c);c.stateManager=new $data.EntityStateManager(c);if(a.name in c.getType()._storageModelCache)c._storageModel=c.getType()._storageModelCache[a.name];else{c._initializeStorageModel();c.getType()._storageModelCache[a.name]=c._storageModel}c._initializeEntitySets(c.constructor);c._user=a&&a.user||b;c._isOK=false;c.storageProvider&&c.storageProvider.initializeStore(f)},error:function(){f.error("Provider fallback failed!")}})},
...
"$$unbound"?"$$unbound":"*",d.name,c.LogicalType,"0..1",d.inverseProperty);b.Associations[d.name]=a;b.Associations.push(a)},_buildDbType_ElementType_OneOneDefinition:function(a,b,c,d){var f=Container.resolveType(d.dataType);(f===void 0||f===null)&&typeof intellisense==="undefined"&&Guard.raise(new Exception("Element type definition error","Field definition",d));(c=this._storageModel.filter(function(a){return a.LogicalType===f})[0])||typeof intellisense==="undefined"&&Guard.raise(new Exception("No EntitySet definition following element type",
...
return}c=a.result[0]}else if(a.expression.nodeType===$data.Expressions.ExpressionType.First){if(a.result.length===0){b.error(new Exception("result count failed"));return}c=a.result[0]}else c=a.result;var e=function(){b.success(c)},f=0,h=a.getEntitySets(),i=function(){var b=h[f];if(b.afterRead){f++;b=b.afterRead.call(this,c,h,a);typeof b==="function"?b.call(this,f<h.length?i:e,c,h,a):f<h.length?i():e()}else e()};h.length?i():e()}};f.error=b.error;var j=c.getEntitySets(),e=true,i=this,m=function(a){a===
false&&(e=false);if(e)i.storageProvider.executeQuery(c,f);else{c.rawDataList=[];c.result=[];f.success(c)}},r=0,p=function(a){a===false&&(e=false);a=j[r];if(a.beforeRead){r++;a=a.beforeRead.call(this,j,c);if(typeof a==="function")a.call(this,r<j.length&&e?p:m,j,c);else{a===false&&(e=false);r<j.length&&e?p():m()}}else m()};j.length?p():m()},saveChanges:function(a){for(var b=[],c=this.stateManager.trackedEntities,d=new $data.PromiseHandler,f=d.createCallback(a),a=d.getPromise(),j=[];c.length>0;){var e=
...
true;j.push(a.data)}b.PhysicalType.memberDefinitions.asArray().filter(function(a){return a.kind==$data.MemberTypes.navProperty}).forEach(function(c){var d=b.Associations[c.name],f=d.ToPropertyName;[].concat(a.data[c.name]).forEach(function(b){if(b){var c=b[f],h=d.FromMultiplicity+d.ToMultiplicity;if(d.FromMultiplicity==="$$unbound")if(b instanceof $data.Array){a.dependentOn=a.dependentOn||[];b.forEach(function(){a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)},this)}else{a.dependentOn=
a.dependentOn||[];a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)}else{switch(h){case "*0..1":c?c instanceof Array?c.indexOf(a.data)==-1&&c.push(a.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):b[f]=[a.data];break;default:c?c!==a.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):b[f]=a.data}switch(h){case "*0..1":case "0..11":a.dependentOn=a.dependentOn||[];a.dependentOn.indexOf(b)<
0&&b.skipSave!==true&&a.dependentOn.push(b)}}if(!b.entityState)b.entityState=$data.EntityState.Added;e.indexOf(b)==-1&&e.push(b)}},this)},this)},this);c.forEach(function(a){a.skipSave!==true&&b.push(a)});c=[];e.forEach(function(a){j.some(function(b){return b==a})||b.some(function(b){return b.data==a})||c.push({data:a,entitySet:this.getEntitySetFromElementType(a.getType().name)})},this)}b.forEach(function(a){if(a.dependentOn){for(var b=[],c=0;c<a.dependentOn.length;c++)j.indexOf(a.dependentOn[c])<
0&&b.push(a.dependentOn[c]);a.dependentOn=b}});var j=null,i=this;if(b.length==0){f.success(0);return a}var m=[];b.forEach(function(a){a.data.entityState===$data.EntityState.Added&&a.data.getType().memberDefinitions.getPublicMappedProperties().forEach(function(b){b.required&&!b.computed&&!a.data[b.name]&&(a.data[b.name]=Container.getDefault(b.dataType))},this);(a.data.entityState!=$data.EntityState.Added||a.data.entityState!=$data.EntityState.Modified)&&!a.data.isValid()&&m.push({item:a.data,errors:a.data.ValidationErrors})});
if(m.length>0){f.error(m);return a}for(var r={},p=0;p<b.length;p++){var d=b[p],z=d.entitySet.elementType.name,F=this._entitySetReferences[z];if(F.beforeCreate||F.beforeUpdate||F.beforeDelete){r[z]||(r[z]={});switch(d.data.entityState){case $data.EntityState.Added:if(F.beforeCreate){if(!r[z].createAll)r[z].createAll=[];r[z].createAll.push(d)}break;case $data.EntityState.Modified:if(F.beforeUpdate){if(!r[z].modifyAll)r[z].modifyAll=[];r[z].modifyAll.push(d)}break;case $data.EntityState.Deleted:if(F.beforeDelete){if(!r[z].deleteAll)r[z].deleteAll=
[];r[z].deleteAll.push(d)}}}}var s=function(a){if(a){l="async";b.length=0}b.length?i.storageProvider.saveChanges({success:function(){i._postProcessSavedItems(f,b)},error:f.error},b):f.success(0)},l,h=Object.getOwnPropertyNames(r),p=0,fa=["beforeUpdate","beforeDelete","beforeCreate"],ga={beforeCreate:"createAll",beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},x=function(a){if(a){l="async";b.length=0}var a=i._entitySetReferences[h[p]],c=fa.pop(),d=r[h[p]][ga[c]];if(d){var e=d.map(function(a){return a.data});
if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];p++}var f=a[c].call(i,e);if(typeof f==="function")f.call(i,p<h.length&&!l?x:s,e);else if(f===false){l=a.name+"."+c;d.forEach(function(a){a=b.indexOf(a);b.splice(a,1)});s()}else p<h.length&&!l?x():s()}else{if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];p++}p<h.length&&!l?x():s()}};p<h.length?x():s();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof
...
[];c[e].modifyAll.push(a)}break;case $data.EntityState.Deleted:if(f.afterDelete){if(!c[e].deleteAll)c[e].deleteAll=[];c[e].deleteAll.push(a)}}}});var f=Object.getOwnPropertyNames(c),j=0,d=this,e=["afterUpdate","afterDelete","afterCreate"],i={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},m=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},r=function(){var a=d._entitySetReferences[f[j]],b=e.pop(),F=c[f[j]][i[b]];if(F){F=F.map(function(a){return a.data});
if(!e.length){e=["afterUpdate","afterDelete","afterCreate"];j++}a=a[b].call(d,F);typeof a==="function"?a.call(d,j<f.length?r:m,F):j<f.length?r():m()}else{if(!e.length){e=["afterUpdate","afterDelete","afterCreate"];j++}j<f.length?r():m()}};j<f.length?r():m()},forEachEntitySet:function(a,b){for(var c in this._entitySetReferences)a.call(b,this._entitySetReferences[c])},loadItemProperty:function(a,b,c){Guard.requireType("entity",a,$data.Entity);var d=typeof b==="string"?a.getType().memberDefinitions.getMember(b):
b;if(a[d.name]!=void 0){b=new $data.PromiseHandler;callBack=b.createCallback(c);c.success(a[d.name]);return b.getPromise()}var b=true,f=this._storageModel.getStorageModel(a.getType().fullName),j=Container.resolveType(d.dataType);if(j===$data.Array||j.isAssignableTo&&j.isAssignableTo($data.EntitySet)){j=Container.resolveType(d.elementType);b=false}else{var e=f.Associations.filter(function(a){return a.FromPropertyName==d.name})[0];e&&e.FromMultiplicity==="0..1"&&e.ToMultiplicity==="1"&&(b=false)}if(b===
true){var i="function (e) { return",m={};f.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(i=i+" &&");i=i+(" e."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});i=i+"; }";return f.EntitySetReference.map("function (e) { return e."+d.name+" }").single(i,m,c)}i="function (e) { return";m={};f.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(i=i+" &&");i=i+(" e."+d.inverseProperty+"."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});i=i+"; }";return this.getEntitySetFromElementType(j).filter(i,
...
b,c)},_generateServiceOperationQueryable:function(a,b,c,d){typeof console!=="undefined"&&console.log&&console.log("Obsolate: _generateServiceOperationQueryable, $data.EntityContext");for(var f=[],j=0;j<d.length;j++){var e={};e[d[j]]=Container.resolveType(Container.getTypeName(c[j]));f.push(e)}return $data.EntityContext.generateServiceOperation({serviceName:a,returnType:$data.Queryable,elementType:this[b].elementType,params:f}).apply(this,c)},attach:function(a){a instanceof $data.EntityWrapper&&(a=
...
true;return b._runQuery(d)}return b}f=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=f;if(f===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};var c=[];if(a.params)for(var d=0;d<a.params.length;d++){var f=a.params[d],j;for(j in f)c.push({name:j,type:f[j]})}$data.typeSystem.extend(b,a,{params:c});return b},_convertLogicalTypeNameToPhysical:function(a){return a+
...
$data.Class.define("$data.ModelBinder",null,null,{constructor:function(a){this.context=a;this.cache={}},call:function(a,b){if(!Object.getOwnPropertyNames(b).length)return a;if(b.$type)var c=Container.resolveName(b.$type),d=this.context.storageProvider.fieldConverter.fromDb[c],f=d?d():new (Container.resolveType(b.$type));if(b.$selector){var j=b.$selector;j instanceof Array||(j=[j]);for(var d=0,e;d<j.length;){e=a;c=j[d].split(":");switch(c[0]){case "json":for(c=c[1].split(".");c.length;)if(typeof e[c[0]]===
"undefined"){if(d===j.length)return;if(c.length)break}else{e=e[c[0]];c=c.slice(1);if(e===null)return e}if(!c.length)d=j.length;break;case "css":case "xml":if(e.querySelector)e=e[b.$item?"querySelectorAll":"querySelector"](c[1]);else{e=$(e).find(c[1]);b.$item||(e=e[0])}}d++}a=e;if(!a)return a}if(b.$value)if(typeof b.$value==="function")f=b.$value.call(b,b,a);else if(b.$type){c=Container.resolveName(b.$type);f=(d=this.context.storageProvider.fieldConverter.fromDb[c])?d(b.$value):new (Container.resolveType(b.$type))(b.$value)}else f=
b.$value;else if(b.$source)if(b.$type){c=Container.resolveName(b.$type);f=(d=this.context.storageProvider.fieldConverter.fromDb[c])?d(a[b.$source]):new (Container.resolveType(b.$type))(a[b.$source])}else f=b.$source.split(":")[0]=="attr"&&a.getAttribute?a.getAttribute(b.$source.split(":")[1]):b.$source=="textContent"&&!a[b.$source]?$(a).text():a[b.$source];else if(b.$item)for(d=0;d<a.length;d++){var i=this.call(a[d],b.$item);f.push(i)}else{e="";if(b.$keys){for(i=0;i<b.$keys.length;i++)e=e+(b.$type+
"_"+b.$keys[i]+"#"+a[b.$keys[i]]);if(this.cache[e]){f=this.cache[e];for(i in b)i.indexOf("$")<0&&b[i].$item&&f[i].push(this.call(a,b[i].$item))}else{for(i in b)if(i.indexOf("$")<0)if(b[i].$item)f[i]=this.call(a,b[i]);else if(b[i].$type||b[i].$source)f[i]=this.call(a,b[i]);else if(b.$type){c=Container.resolveName(b.$type.memberDefinitions.getMember(i).type);d=this.context.storageProvider.fieldConverter.fromDb[c];f[i]=d?d(a[b[i]]):new (Container.resolveType(b.$type.memberDefinitions.getMember(i).type))(a[b[i]])}else f[i]=
b[i].$source?a[b[i].$source]:a[b[i]];this.cache[e]=f}}else for(i in b)if(i.indexOf("$")<0)if(b[i].$item)f[i]=this.call(a,b[i]);else if(b[i].$type||b[i].$source)f[i]=this.call(a,b[i]);else if(b.$type){c=Container.resolveName(Container.resolveType(b.$type).memberDefinitions.getMember(i).type);d=this.context.storageProvider.fieldConverter.fromDb[c];f[i]=d?d(a[b[i]]):new (Container.resolveType(b.$type.memberDefinitions.getMember(i).type))(a[b[i]])}else f[i]=b[i].$source?a[b[i].$source]:a[b[i]]}return f}});
...
c,$data.Expressions.ExpressionType.OrderByDescending);return Container.createQueryable(this,c)},first:function(a,b,c){this._checkOperation("first");var d=this;a&&(d=this.filter(a,b));var d=d.take(1),a=new $data.PromiseHandler,c=a.createCallback(c),b=Container.createFirstExpression(d.expression),f=Container.createQueryExpressionCreator(d.entityContext);try{var j=f.Visit(b);d.entityContext.log({event:"EntityExpression",data:j});d.entityContext.executeQuery(Container.createQueryable(d,j),c)}catch(e){c.error(e)}return a.getPromise()},
...
$data.Class.defineEx("$data.EntitySet",[{type:$data.Queryable,params:[new ConstructorParameter(1)]}],null,{constructor:function(a,b,c,d,f){this.createNew=this[a.name]=a;this.stateManager=new $data.EntityStateManager(this);this.elementType=a;this.collectionName=c;this.roles=f;for(var j in d)this[j]=d[j];this._checkRootExpression()},executeQuery:function(a,b){var c=$data.typeSystem.createCallbackSetting(b);this.entityContext.executeQuery(a,c)},getTraceString:function(a){return this.entityContext.getTraceString(a)},
...
$data.FunctionImport.prototype={extend:function(a){for(var b in a)this[b]=a[b];return this},chain:function(a,b){var c=function(){var a=arguments.callee.chainFn,b=[];if(arguments.length)for(var c=0;c<arguments.length;c++)b.push(arguments[c]);var e=b.length,c=0,i=function(){if(b[b.length-1]&&b[b.length-1].success&&typeof b[b.length-1].success==="function")b[b.length-1].success.apply(this,arguments);else return arguments.length?arguments[0]:void 0},m=function(){var r=a[c];c++;r=r.apply(this,b);if(typeof r===
"function"){var p=arguments;b[e]=c<a.length?function(){return m.apply(this,p)}:function(){return i.apply(this,p)};r.apply(this,b)}else c<a.length?m.apply(this,arguments):i(this,arguments)};m()};if(!c.chainFn)c.chainFn=(a||[]).concat([this].concat(b||[]));return c},before:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.unshift(a);return b},after:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.push(a);return b},asResult:function(a,b){return this.extend({resultType:a,resultCfg:b})},
...
a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;this.roles=c;var f=this;return ret=function(){var a=new $data.PromiseHandler,c=a.createCallback(b),a=a.getPromise(),d=arguments;c.success=c.success.after(function(){f.apply(this,d)});$data.Access.isAuthorized($data.Access.Execute,this.user,f.roles,c);return a}},toPromise:function(){return this}};
...
c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}f=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=f;if(f===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)}.toServiceOperation();
...
this._includes.forEach(function(c){for(var d=c.name.split("."),f=null,j=b,e=0;e<d.length;e++){a.modelBinderConfig.$item&&a.selectModelBinderProperty("$item");a.selectModelBinderProperty(d[e]);f=j.Associations[d[e]];j=this._query.context._storageModel.getStorageModel(f.ToType)}a.modelBinderConfig.$selector=this._isoDataProvider?["json:"+d[d.length-1]+".results","json:"+d[d.length-1]]:"json:"+d[d.length-1];if(f.ToMultiplicity==="*"){a.modelBinderConfig.$type=$data.Array;a.selectModelBinderProperty("$item");
...
c(a)};$data.ajax(a)}},__encodeBase64:function(a){input=a;var a="",b,c,d="",f,j,e="",i=0;do{b=input.charCodeAt(i++);c=input.charCodeAt(i++);d=input.charCodeAt(i++);f=b>>2;b=(b&3)<<4|c>>4;j=(c&15)<<2|d>>6;e=d&63;isNaN(c)?j=e=64:isNaN(d)&&(e=64);a=a+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(j)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)}while(i<
