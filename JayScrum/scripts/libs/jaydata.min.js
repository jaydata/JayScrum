...
b:Math.floor(b/za.length*100)})};}function f(a,b,c,d,e,f){var j,m,b=b||g;m=b.line||0;j=b.from||0;a={id:"(error)",raw:H[a]||a,evidence:za[m-1]||"",line:m,character:j,a:c||b.value,b:d,c:e,d:f};a.reason=a.raw.supplant(a);JAYLINT.errors.push(a);k.passfail&&h(H.stopping,m,j);Ma=Ma+1;Ma>=k.maxerr&&h(H.too_many,m,j);return a}function j(a,b,c,d,e,g,j){return f(a,{line:b,from:c},d,e,g,j)}function m(a,b,c,d,e,g){a=f(a,b,c,d,e,g);h(H.stopping,a.line,a.character)}function r(a,b,c,d,e,f,g){return m(a,{line:b,
from:c},d,e,f,g)}function p(a){!k.white&&g.from!==a&&f("expected_a_at_b_c",g,g.value,a,g.from)}function z(a,b,c){if(a[b]!==c){f("expected_a_b",a,c,a[b]);return true}return false}function F(a,b,c){c=c||a.value;if(q===X){k.safe&&f("adsafe_a",a,c);if(typeof X[c]!=="string"){a.writeable=typeof Q[c]==="boolean"?Q[c]:true;a.funct=q;Aa[c]=a}b==="becoming"&&(b="var")}else if(typeof q[c]==="string")if(q[c]==="undef"){k.undef||f("used_before_a",a,c);b="var"}else f("already_defined",a,c);else{a.funct=q;a.writeable=
true;D[c]=a}q[c]=b}function s(a){for(var b,c=0,a=a||0;c<=a;){(b=Ba[c])||(b=Ba[c]=Ca.token());c=c+1}return b}function l(a){a=a||n;if(a.comments){for(var b=a.prev;b.comments===null;)b=b.prev;b.comments=b.comments?b.comments.concat(a.comments):a.comments}a.comments=null}function i(a,b){if(v){if(ea&&g.line!==n.line){if((ea!==v||!g.edge)&&g.from===v.at-(g.edge?k.indent:0)){for(var c=v;;){c.at=c.at-k.indent;if(c===ea)break;c=c.was}c.open=false}ea=null}if(v.open)if(g.edge)g.edge==="label"?p(1):g.edge===
"case"?p(v.at-k.indent):(v.mode!=="array"||g.line!==n.line)&&p(v.at);else{if(g.line!==n.line){g.from<v.at+(v.mode==="expression"?0:k.indent)&&p(v.at+k.indent);v.wrap=true}}else if(g.line!==n.line)if(g.edge)p(v.at);else{v.wrap=true;v.mode==="statement"||v.mode==="var"?p(v.at+k.indent):g.from<v.at+(v.mode==="expression"?0:k.indent)&&p(v.at+k.indent)}}switch(n.id){case "(number)":g.id==="."&&f("trailing_decimal_a");break;case "-":(g.id==="-"||g.id==="--")&&f("confusing_a");break;case "+":(g.id==="+"||
g.id==="++")&&f("confusing_a")}if(n.id==="(string)"||n.identifier)$a=n.value;a&&g.id!==a&&(b?f("expected_a_b_from_c_d",g,a,b.id,b.line,g.value):(!g.identifier||g.value!==a)&&f("expected_a_b",g,a,g.value));U=n;n=g;g=Ba.shift()||Ca.token();n.id==="(end)"&&l()}function fa(){if(k.adsafe)k.safe=true;if(k.safe){k.browser=k["continue"]=k.css=k.debug=k.devel=k.evil=k.forin=k.newcap=k.nomen=k.on=k.rhino=k.sloppy=k.sub=k.undef=k.widget=k.windows=false;delete Q.Array;delete Q.Date;delete Q.Function;delete Q.Object;
delete Q.eval;d({ADSAFE:false,lib:false})}}function ga(){var a=this.id,b=Da;g.line===n.line&&g.from===n.thru&&f("missing_space_a_b",g,n.value,g.value);Da=true;k.white=true;(Ba.length>0||g.comments)&&f("unexpected_a",this);switch(a){case "/*properties":case "/*property":case "/*members":case "/*member":a:for(ha||(ha={});;){if(g.id!=="(string)"&&!g.identifier)break a;ha[g.value]=true;i();if(g.id!==",")break a;i(",")}break;case "/*jslint":for(k.safe&&f("adsafe_a",this);g.id==="(string)"||g.identifier;){a=
g.value;i();g.id!==":"&&m("expected_a_b",g,":",g.value);i(":");switch(a){case "indent":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&m("expected_small_a");k.indent=a;break;case "maxerr":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<=0||Math.floor(a)!==a)&&m("expected_small_a",g);k.maxerr=a;break;case "maxlen":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&m("expected_small_a");k.maxlen=a;break;default:g.id==="true"?k[a]=true:g.id==="false"?k[a]=
false:m("unexpected_a");if(a==="adsafe"){k.adsafe=k.safe=true;fa()}else a==="safe"&&fa()}i();g.id===","&&i(",")}e();break;case "/*globals":case "/*global":k.safe&&f("adsafe_a",this);a:for(var c;;){if(g.id!=="(string)"&&!g.identifier)break a;a=g.value;i();c=false;if(g.id===":"){i(":");switch(g.id){case "true":c=Q[a]!==false;i("true");break;case "false":i("false");break;default:m("unexpected_a")}}Q[a]=c;if(g.id!==",")break a;i(",")}break;default:m("unpexpected_a",this)}Da=b;i("*/")}function x(a){g.edge=
!v||v.open&&(a||true)}function K(a){var b,c;if(typeof a==="number")v={at:a,open:true,was:c};else if(v){c=v;b=a==="var"||g.line!==n.line&&a!=="statement";v={at:(b||a==="control"?c.at+k.indent:c.at)+(c.wrap?k.indent:0),mode:a,open:b,was:c};a==="var"&&b&&(ea=v)}else v={at:1,mode:"statement",open:true}}function A(a,b){if(a){if(v&&v.open){v.at=v.at-k.indent;x()}i(a,b)}if(v)v=v.was}function y(a,b){b=b||g;b.id!=="(end)"&&!k.white&&(n.line!==b.line||n.thru+1!==b.from)&&f("expected_space_a_b",b,n.value,b.value)}
function ua(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!k.white&&a.thru+1!==b.from)&&f("expected_space_a_b",b,a.value,b.value)}function u(a,b){a=a||n;b=b||g;(!k.white||t==="styleproperty"||t==="style")&&a.thru!==b.from&&a.line===b.line&&f("unexpected_space_a_b",b,a.value,b.value)}function B(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!k.white&&a.thru!==b.from)&&f("unexpected_space_a_b",b,a.value,b.value)}function J(a,b){if(!k.white){a=a||n;b=b||g;a.thru===b.from&&a.line===b.line&&
f("missing_space_a_b",b,a.value,b.value)}}function G(){if(g.id!==",")j("expected_a_b",n.line,n.thru,",",g.value);else{k.white||B();i(",");l();J()}}function V(){if(g.id!==";")j("expected_a_b",n.line,n.thru,";",g.value);else{k.white||B();i(";");l();Kb[g.id]!==true&&J()}}function Na(){if(g.value==="use strict"){na&&f("unnecessary_use");x();i();V();na=true;k.newcap=false;k.undef=false;return true}return false}function S(a,b){if(a===b)return true;if(Array.isArray(a)){if(Array.isArray(b)&&a.length===b.length){var c;
...
b.second.value&&b.second.id==="(string)";if(a.id==="["&&a.arity==="infix"&&b.id===".")return a.second.value===b.second.value&&a.second.id==="(string)"}return false}function w(a,b){var c;g.id==="(end)"&&m("unexpected_a",n,g.id);i();k.safe&&D[n.value]&&D[n.value]===Aa[n.value]&&g.id!=="("&&g.id!=="."&&f("adsafe",n);if(b){$a="anonymous";q["(verb)"]=n.value}if(b===true&&n.fud)c=n.fud();else{if(n.nud)c=n.nud();else{if(g.id==="(number)"&&n.id==="."){f("leading_decimal_a",n,g.value);i();return n}m("expected_identifier_a",
n,n.id)}for(;a<g.lbp;){i();n.led?c=n.led(c):m("expected_operator_a",n,n.id)}}return c}function Ea(a,b){var c=Y[a];if(!c||typeof c!=="object")Y[a]=c={id:a,lbp:b,value:a};return c}function M(a){return Ea(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Ea(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;a.value=a;return oa(b)}function R(a,b){var c=M(a);c.identifier=c.reserved=true;c.fud=b;return c}function Oa(a,b){R(a,b).labeled=true}function Pa(a,b){R(a,b).disrupt=true}function rb(a){var b=
...
function bb(a){return(a=a.identifier&&D[a.value]||a)&&a.type}function L(a,b,c){var d="",e,g,j;if(typeof a!=="string"){g=a.identifier&&D[a.value]||a;a=g.type}j=b.identifier&&D[b.value]||b;e=j.type;if(a)e?a===e?d=a:k.type||f("type_inconsistency_a_b",c||b,a,e):j.type=d=a;else if(e){if(g)g.type=e;d=e}return d}function E(a,b){var c=M(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function va(b,c,d){b=E(b);b.type=c;b.value=d;b.nud=a;return b}function cb(a,b){return E(a,function(){typeof b===
...
(!a.identifier||a.reserved)&&a.id!=="."&&a.id!=="["&&f("bad_operand",this):f("unexpected_a",this);this.first=a;this.arity="suffix";return this};return a}function pa(){if(g.identifier){i();k.safe&&Qa[n.value]?f("adsafe_a",n):n.reserved&&!k.es5&&f("expected_identifier_a_reserved",n);return n.value}}function db(){var a,b=D;if(g.id===";"){f("unexpected_a");V()}else{if(g.identifier&&!g.reserved&&s().id===":"){x("label");a=g;i();l();i(":");l();D=Object.create(b);F(a,"label");g.labeled!==true?f("label_a_b",
g,a.value,g.value):eb.test(a.value+":")?f("url",a):q===X&&m("unexpected_a",n);g.label=a}x();K("statement");if(a=w(0,true))if(a.arity==="statement")a.id==="switch"||a.block&&a.id!=="do"?J():V();else{a.id==="("?a.first.id==="new"&&f("bad_new"):!a.assign&&a.id!=="delete"&&a.id!=="++"&&a.id!=="--"&&f("assignment_function_expression",n);V()}A();D=b;return a}}function qa(){for(var a=[],b,c;g.postscript!==true;)if(g.id===";"){f("unexpected_a",g);V()}else{if(g.value==="use strict"){(!La||q!==X||a.length>
0)&&f("function_strict");Na()}if(b){f("unreachable_a_b",g,g.value,b.value);b=null}if(c=db()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ca(a){var b,c=g,d=Fa,e=D,j=na;Fa=a;D=Object.create(D);J();if(g.id==="{"){i("{");K();!a&&!Na()&&!j&&!k.sloppy&&q["(context)"]===X&&f("missing_use_strict");b=qa();na=j;A("}",c);l()}else if(a){f("expected_a_b",g,"{",g.value);b=[db()];b.disrupt=b[0].disrupt}else m("expected_a_b",g,"{",g.value);q["(verb)"]=null;D=e;Fa=d;a&&b.length===0&&f("empty_block");
return b}function Ra(a){ha&&typeof ha[a]!=="boolean"&&f("unexpected_property_a",n,a);ra[a]=typeof ra[a]==="number"?ra[a]+1:1}function fb(){var a=pa(true);if(!a)if(g.id==="(string)"){a=g.value;k.safe&&(Qa[a]?f("adsafe_a"):(a.charAt(0)==="_"||a.charAt(a.length-1)==="_")&&f("dangling_a"));i()}else if(g.id==="(number)"){a=g.value.toString();i()}return a}function I(a){var b=0;if(a)if(Array.isArray(a))a.forEach(function(a){b=b+I(a)});else switch(a.arity){case "statement":switch(a.id){case "if":b=b+(I(a.first)+
...
b+I(a.first);break;case "case":case "infix":b=b+(I(a.first)+I(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(I(a.first)+I(a.second)+I(a.third))}return b}function Sa(a,b){var d=q,e=k,f=ha,j=D;q={"(name)":b||"'"+($a||"").replace(ub,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":D,"(token)":a};ha=f&&Object.create(f);k=Object.create(e);D=Object.create(j);Ta.push(q);(a.name=b)&&F(a,"function",b);a.writeable=false;var h=q,m;a:{var r=g,p=[];i("(");K();
l();u();if(g.id===")"){u();A(")",r);l();m=void 0}else for(;;){x();pa();p.push(n);F(n,k.unparam?"parameter":"unparam");if(g.id===",")G();else{u();A(")",r);l();m=p;break a}}}a.first=h["(params)"]=m;a.type="function";y();a.block=ca(false);q["(complexity)"]=I(a.block)+1;q=d;k=e;ha=f;D=j}function gb(){function a(){var b=g,c={};i("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);G()}g.id!=="(string)"&&f("expected_string_a");c[g.value]===true?f("duplicate_a"):g.value==="__proto__"?
f("dangling_a"):c[g.value]=true;i();i(":");gb();if(g.id!==",")break;G();if(g.id==="}"){f("unexpected_a",n);break}}i("}",b)}function b(){var a=g;i("[");if(g.id!=="]")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);G()}gb();if(g.id!==",")break;G();if(g.id==="]"){f("unexpected_a",n);break}}i("]",a)}switch(g.id){case "{":a();break;case "[":b();break;case "true":case "false":case "null":case "(number)":case "(string)":i();break;case "-":i("-");B();i("(number)");break;default:m("unexpected_a")}}
function hb(){if(g.identifier){i();return true}}function Ua(){if(g.id==="-"){i("-");B()}if(g.id==="(number)"){i("(number)");return true}}function ib(){if(g.id==="(string)"){i();return true}}function ja(){var a,b,c,d;if(g.identifier){d=g.value;if(d==="rgb"||d==="rgba"){i();c=g;i("(");for(a=0;a<3;a=a+1){a&&G();b=g.value;if(g.id!=="(string)"||b<0){f("expected_positive_a",g);i()}else{i();if(g.id==="%"){i("%");b>100&&f("expected_percent_a",n,b)}else b>255&&f("expected_small_a",n,b)}}if(d==="rgba"){G();
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&f("expected_fraction_a",g);i();if(g.id==="%"){f("unexpected_a");i("%")}}i(")",c);return true}if(Mb[g.value]===true){i();return true}}else if(g.id==="(color)"){i();return true}return false}function C(){if(g.id==="-"){i("-");B()}if(g.id==="(number)"){i();if(g.id!=="(string)"&&vb[g.value]===true){B();i()}else+n.value!==0&&f("expected_linear_a");return true}return false}function xa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":i();return true}else return C()}
function Ga(){if(g.identifier){if(g.value==="auto"){i();return true}}else return C()}function sa(){var a,b;if(g.identifier&&g.value==="url"){g=Ca.range("(",")");b=g.value;a=b.charAt(0);if(a==='"'||a==="'")if(b.slice(-1)!==a)f("bad_url");else{b=b.slice(1,-1);b.indexOf(a)>=0&&f("bad_url")}b||f("missing_url");k.safe&&wb.test(b)&&m("adsafe_a",g,b);Ha.push(b);i();return true}return false}function jb(a){var b=0,c,d,e,f=0;switch(typeof a){case "function":return a();case "string":if(g.identifier&&g.value===
a){i();return true}return false}for(;;){if(b>=a.length)return false;e=a[b];b=b+1;if(typeof e==="boolean")break;else if(typeof e==="number"){c=e;e=a[b];b=b+1}else c=1;for(d=false;c>0;)if(jb(e)){d=true;c=c-1}else break;if(d)return true}f=b;for(c=[];;){e=false;for(b=f;b<a.length;b=b+1)if(!c[b]&&jb(Va[a[b]])){e=d=true;c[b]=true;break}if(!e)return d}}function xb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){f("unexpected_a");V()}for(a=void 0;g.id==="*"||g.id==="#"||
g.value==="_";){k.css||f("unexpected_a");i()}if(g.id==="-"){k.css||f("unexpected_a");i("-");g.identifier||f("expected_nonstandard_style_attribute");i();a=kb}else{if(g.identifier)if(Object.prototype.hasOwnProperty.call(Va,g.value))a=Va[g.value];else{a=kb;k.css||f("unrecognized_style_attribute_a")}else f("expected_style_attribute");i()}i(":");if(g.identifier&&g.value==="inherit")i();else if(!jb(a)){f("unexpected_a");i()}if(g.id==="!"){i("!");B();g.identifier&&g.value==="important"?i():f("expected_a_b",
g,"important",g.value)}g.id==="}"||g.id===T?f("expected_a_b",g,";",g.value):V()}}function lb(){if(g.identifier){Object.prototype.hasOwnProperty.call(mb,k.cap?g.value.toLowerCase():g.value)||f("expected_tagname_a");i()}else switch(g.id){case ">":case "+":i();lb();break;case ":":i(":");switch(g.value){case "active":case "after":case "before":case "checked":case "disabled":case "empty":case "enabled":case "first-child":case "first-letter":case "first-line":case "first-of-type":case "focus":case "hover":case "last-child":case "last-of-type":case "link":case "only-of-type":case "root":case "target":case "visited":i();
break;case "lang":i();i("(");g.identifier||f("expected_lang_a");i(")");break;case "nth-child":case "nth-last-child":case "nth-last-of-type":case "nth-of-type":i();i("(");if(g.id==="(number)"){i();if(g.value==="n"&&g.identifier){B();i();if(g.id==="+"){B();i("+");B();i("(number)")}}}else g.identifier&&(g.value==="odd"||g.value==="even")?i():f("unexpected_a");i(")");break;case "not":i();i("(");g.id===":"&&s(0).value==="not"&&f("not");lb();i(")");break;default:f("expected_pseudo_a")}break;case "#":i("#");
g.identifier||f("expected_id_a");i();break;case "*":i("*");break;case ".":i(".");g.identifier||f("expected_class_a");i();break;case "[":i("[");g.identifier||f("expected_attribute_a");i();if(g.id==="="||g.value==="~="||g.value==="$="||g.value==="|="||g.id==="*="||g.id==="^="){i();g.id!=="(string)"&&f("expected_string_a");i()}i("]");break;default:m("expected_selector_a")}}function yb(){for(;g.id!=="</"&&g.id!=="(end)";){a:for(g.id==="{"&&f("expected_style_pattern");;){lb();if(g.id==="</"||g.id==="{"||
g.id==="(end)")break a;g.id===","&&G()}t="styleproperty";if(g.id===";")V();else{i("{");xb();t="style";i("}")}}}function zb(){for(;g.id==="@";){s();i("@");if(g.identifier)switch(g.value){case "import":i();if(!sa()){f("expected_a_b",g,"url",g.value);i()}V();break;case "media":for(i();;){(!g.identifier||Ab[g.value]===true)&&m("expected_media_a");i();if(g.id!==",")break;G()}i("{");yb();i("}");break;default:f("expected_at_a")}else f("expected_at_a")}yb()}var W,Ia,Ja,la,$a,Wa,Nb={"<":true,"<=":true,"==":true,
...
j("unexpected_comment",d,f):t==="script"&&/<\//i.test(l)?j("unexpected_a",d,f,"</"):k.safe&&Sb.test(b)&&j("dangerous_comment",d,e);ta.comments?ta.comments.push(c):ta.comments=[c];JAYLINT.comments.push(c)}function b(){var a;if(i>=za.length)return false;f=1;l=za[i];i=i+1;a=l.search(/ \t/);a>=0&&j("mixed",i,a+1);l=l.replace(/\t/g,Za);a=l.search(Vb);a>=0&&j("unsafe",i,a);k.maxlen&&k.maxlen<l.length&&j("too_long",i,l.length);return true}function c(a,b,d){var e;(a==="(string)"||a==="(range)")&&eb.test(b)&&
j("url",i,h);e=Object.create(Y[a==="(punctuator)"||a==="(identifier)"&&Object.prototype.hasOwnProperty.call(Y,b)?b:a]||Y["(error)"]);if(a==="(identifier)"){e.identifier=true;b==="__iterator__"||b==="__proto__"?r("reserved_a",i,h,b):!k.nomen&&(b.charAt(0)==="_"||b.charAt(b.length-1)==="_")&&j("dangling_a",i,h,b)}if(b!==void 0)e.value=b;if(d)e.quote=d;e.line=i;e.from=h;e.thru=f;e.prev=ta;pb=(a=e.id)&&("(,=:[!&|?{};".indexOf(a.charAt(a.length-1))>=0||a==="return");return ta=ta.next=e}function d(a){function e(a){var b=
parseInt(l.substr(o+1,a),16);o=o+a;b>=32&&b<=126&&b!==34&&b!==92&&b!==39&&j("unexpected_a",i,f,"\\");f=f+a;g=String.fromCharCode(b)}var g,o,m="";ma&&a!=='"'&&j("expected_a",i,f,'"');if(T===a||t==="scriptstring"&&!T)return c("(punctuator)",a);for(o=0;;){for(;o>=l.length;){o=0;(t!=="html"||!b())&&r("unclosed",i,h)}g=l.charAt(o);if(g===a){f=f+1;l=l.slice(o+1);return c("(string)",m,a)}if(g<" "){if(g==="\n"||g==="\r")break;j("control_a",i,f+p,l.slice(0,p))}else if(g===T)j("bad_html",i,f+o);else if(g===
"<")k.safe&&t==="html"?j("adsafe_a",i,f+p,g):l.charAt(p+1)==="/"&&(t||k.safe)?j("expected_a_b",i,f,"<\\/","</"):l.charAt(p+1)==="!"&&(t||k.safe)&&j("unexpected_a",i,f,"<!");else if(g==="\\")if(t==="html")k.safe&&j("adsafe_a",i,f+p,g);else if(t==="styleproperty"){o=o+1;f=f+1;g=l.charAt(o);g!==a&&j("unexpected_a",i,f,"\\")}else{o=o+1;f=f+1;g=l.charAt(o);switch(g){case "":k.es5||j("es5",i,f);b();o=-1;break;case T:j("bad_html",i,f+o);break;case "'":ma&&j("unexpected_a",i,f,"\\'");break;case "u":e(4);
break;case "v":ma&&j("unexpected_a",i,f,"\\v");g="\v";break;case "x":ma&&j("unexpected_a",i,f,"\\x");e(2);break;default:g=Ob[g];typeof g!=="string"&&j("unexpected_a",i,f,"\\")}}m=m+g;f=f+1;o=o+1}}function e(){for(var a,b,d=0,o=0;;){a=true;g=l.charAt(o);o=o+1;switch(g){case "":r("unclosed_regexp",i,h);return;case "/":d>0&&j("unescaped_a",i,h+o,"/");g=l.slice(0,o-1);for(d=Object.create(Pb);d[l.charAt(o)]===true;){d[l.charAt(o)]=false;o=o+1}l.charAt(o).isAlpha()&&r("unexpected_a",i,h,l.charAt(o));f=
f+o;l=l.slice(o);o=l.charAt(0);(o==="/"||o==="*")&&r("confusing_regexp",i,h);return c("(regexp)",g);case "\\":g=l.charAt(o);g<" "?j("control_a",i,h+o,""+g):g==="<"&&j(H.unexpected_a,i,h+o,"\\");o=o+1;break;case "(":d=d+1;a=false;if(l.charAt(o)==="?"){o=o+1;switch(l.charAt(o)){case ":":case "=":case "!":o=o+1;break;default:j(H.expected_a_b,i,h+o,":",l.charAt(o))}}break;case "|":a=false;break;case ")":d===0?j("unescaped_a",i,h+o,")"):d=d-1;break;case " ":for(p=1;l.charAt(o)===" ";){o=o+1;p=p+1}p>1&&
j("use_braces",i,h+o,p);break;case "[":g=l.charAt(o);if(g==="^"){o=o+1;k.regexp?l.charAt(o)==="]"&&r("unescaped_a",i,h+o,"^"):j("insecure_a",i,h+o,g)}b=false;if(g==="]"){j("empty_class",i,h+o-1);b=true}a:do{g=l.charAt(o);o=o+1;switch(g){case "[":case "^":j("unescaped_a",i,h+o,g);b=true;break;case "-":if(b)b=false;else{j("unescaped_a",i,h+o,"-");b=true}break;case "]":b||j("unescaped_a",i,h+o-1,"-");break a;case "\\":g=l.charAt(o);g<" "?j(H.control_a,i,h+o,""+g):g==="<"&&j(H.unexpected_a,i,h+o,"\\");
o=o+1;b=true;break;case "/":j("unescaped_a",i,h+o-1,"/");b=true;break;case "<":if(t==="script"){g=l.charAt(o);(g==="!"||g==="/")&&j(H.html_confusion_a,i,h+o,g)}b=true;break;default:b=true}}while(g);break;case ".":k.regexp||j("insecure_a",i,h+o,g);break;case "]":case "?":case "{":case "}":case "+":case "*":j("unescaped_a",i,h+o,g);break;case "<":if(t==="script"){g=l.charAt(o);(g==="!"||g==="/")&&j(H.html_confusion_a,i,h+o,g)}}if(a)switch(l.charAt(o)){case "?":case "+":case "*":o=o+1;l.charAt(o)===
"?"&&(o=o+1);break;case "{":o=o+1;g=l.charAt(o);(g<"0"||g>"9")&&j(H.expected_number_a,i,h+o,g);o=o+1;for(b=+g;;){g=l.charAt(o);if(g<"0"||g>"9")break;o=o+1;b=+g+b*10}a=b;if(g===","){o=o+1;a=Infinity;g=l.charAt(o);if(g>="0"&&g<="9"){o=o+1;for(a=+g;;){g=l.charAt(o);if(g<"0"||g>"9")break;o=o+1;a=+g+a*10}}}l.charAt(o)!=="}"?j(H.expected_a_b,i,h+o,"}",g):o=o+1;l.charAt(o)==="?"&&(o=o+1);b>a&&j(H.not_greater,i,h+o,b,a)}}g=l.slice(0,o-1);f=f+o;l=l.slice(o);return c("(regexp)",g)}var f,g,h,m,i,p,l;return{init:function(a){za=
typeof a==="string"?a.replace(Ub,"\n").replace(Tb,"\n").split("\n"):a;i=0;b();h=1},range:function(a,b){var d,e="";h=f;for(l.charAt(0)!==a&&r("expected_a_b",i,f,a,l.charAt(0));;){l=l.slice(1);f=f+1;d=l.charAt(0);switch(d){case "":r("missing_a",i,f,d);break;case b:l=l.slice(1);f=f+1;return c("(range)",e);case T:case "\\":j("unexpected_a",i,f,d)}e=e+d}},token:function(){for(var k,p,s;;){for(;!l;)if(!b())return c("(end)");for(;t==="outer";){p=l.search(Yb);if(p===0)break;else if(p>0){f=f+1;l=l.slice(p);
break}else if(!b())return c("(end)","")}k=(ac[t]||$b).exec(l);s=void 0;if(k){m=k[0].length;s=k[1];g=s.charAt(0);l=l.slice(m);h=f+m-s.length;f=f+m}else s=void 0;if(s){k=s.charAt(0);if(k.isAlpha()||k==="_"||k==="$")return c("(identifier)",s);if(k.isDigit()){p=s;k=void 0;t!=="style"&&t!=="styleproperty"&&l.charAt(0).isAlpha()&&j("expected_space_a_b",i,f,g,l.charAt(0));if(g==="0"){k=p.charAt(1);k.isDigit()?n.id!=="."&&t!=="styleproperty"&&j("unexpected_a",i,f,p):ma&&(k==="x"||k==="X")&&j("unexpected_a",
i,f,"0x")}p.slice(p.length-1)==="."&&j("trailing_decimal_a",i,f,p);if(t!=="style"){k=+p;isFinite(k)||j("bad_number",i,f,p);p=k}return c("(number)",p)}switch(s){case '"':case "'":return d(s);case "//":a(l,"//",i,f);l="";break;case "/*":for(k="/*";;){p=l.search(Xb);if(p>=0)break;a(l,k,i,f);k="";b()||r("unclosed_comment",i,f)}a(l.slice(0,p),k,f,i);f=f+(p+2);l.charAt(p)==="/"&&r("nested_comment",i,f);l=l.slice(p+2);break;case "":break;case "/":n.id==="/="&&r(H.slash_equal,i,h);return pb?e():c("(punctuator)",
s);case "<\!--":for(m=i;;){p=l.indexOf("--");if(p>=0)break;p=l.indexOf("<!");p>=0&&r("nested_comment",i,f+p);b()||r("unclosed_comment",m,k)}m=l.indexOf("<!");m>=0&&m<p&&r("nested_comment",i,f+m);f=f+p;l.charAt(p+2)!==">"&&r("expected_a",i,f,"--\>");f=f+3;l=l.slice(p+3);break;case "#":if(t==="html"||t==="styleproperty"){for(;;){k=l.charAt(0);if((k<"0"||k>"9")&&(k<"a"||k>"f")&&(k<"A"||k>"F"))break;f=f+1;l=l.slice(1);s=s+k}s.length!==4&&s.length!==7&&j("bad_color_a",i,h+m,s);return c("(color)",s)}return c("(punctuator)",
s);default:if(t==="outer"&&k==="&"){f=f+1;for(l=l.slice(1);;){k=l.charAt(0);f=f+1;l=l.slice(1);if(k===";")break;k>="0"&&k<="9"||k>="a"&&k<="z"||k==="#"||r("bad_entity",i,h+m,f)}break}return c("(punctuator)",s)}}else{for(;l&&l<"!";)l=l.slice(1);if(l){if(t==="html")return c("(error)",l.charAt(0));r("unexpected_a",i,f,l.charAt(0))}}}}}}();Y["(identifier)"]={lbp:0,identifier:true,nud:function(){var a=this.value,b=D[a];if(typeof b!=="object"){b=Q[a];if(typeof b==="boolean"){Aa[a]=b={value:a,writeable:b,
...
a)});va("true","boolean",true);va("undefined","",void 0);N("?",30,function(a,b){b.first=ba(aa(a));b.second=w(0);J();var c=g;i(":");l();J();b.third=w(10);b.arity="ternary";b.type=L(b.second,b.third);S(b.second,b.third)?f("weird_ternary",c):S(b.first,b.second)&&f("use_or",b);return b});N("||",40,function(a,b){function c(a){a.id==="&&"&&!a.paren&&f("and",a);return a}b.first=c(ba(aa(a)));b.second=c(aa(w(40)));S(b.first,b.second)&&f("weird_condition",b);return b});N("&&",50,function(a,b){b.first=ba(aa(a));
...
null,"string");P("new",function(){y();var a=w(160),b;this.first=a;if(a.id!=="function")if(a.identifier)switch(a.value){case "Object":f("use_object",n);break;case "Array":if(g.id==="("){b=g;b.first=this;i("(");if(g.id!==")"){b.second=w(0);if(b.second.id!=="(string)"||!b.second.value){ba(b.second,H.use_array);a=false}else a=true;for(;g.id!==")"&&g.id!=="(end)";){if(a){f("use_array",b);a=false}i()}}else f("use_array",n);i(")",b);l();return b}f("use_array",n);break;case "Number":case "String":case "Boolean":case "Math":case "JSON":f("not_a_constructor",
a);break;case "Function":k.evil||f("function_eval");break;case "Date":case "RegExp":break;default:if(a.id!=="function"){a=a.value.charAt(0);!k.newcap&&(a<"A"||a>"Z")&&f("constructor_name_a",n)}}else a.id!=="."&&a.id!=="["&&a.id!=="("&&f("bad_constructor",n);else f("weird_new",this);g.id!=="("&&f("missing_a",g,"()");return this});N("(",160,function(a,b){v&&v.mode==="expression"?u(U,n):B(U,n);!a.immed&&a.id==="function"&&f("wrap_immediate");var c=[];if(a){L("function",a);a.identifier?a.value.match(/^[A-Z]([A-Z0-9_$]*[a-z][A-Za-z0-9_$]*)?$/)&&
a.value!=="Number"&&a.value!=="String"&&a.value!=="Boolean"&&a.value!=="Date"&&(a.value==="Math"||a.value==="JSON"?f("not_a_function",a):a.value==="Object"?f("use_object",n):(a.value==="Array"||!k.newcap)&&f("missing_a",a,"new")):a.id==="."&&(k.safe&&a.first.value==="Math"&&a.second==="random"?f("adsafe",a):a.second.value==="split"&&a.first.id==="(string)"&&f("use_array",a.second))}K();if(g.id!==")")for(u();;){x();c.push(w(10));if(g.id!==",")break;G()}u();A(")",b);if(typeof a==="object"){a.value===
...
a)})}else(a.second.value==="toString"||a.second.value==="stringify")&&L("string",b);else a.identifier&&a.value==="String"&&L("string",b);return b},"",true);P("(",function(){K("expression");l();u();x();if(g.id==="function")g.immed=true;var a=w(0);a.paren=true;u();A(")",this);l();a.id==="function"&&(g.id==="("?f("move_invocation"):f("bad_wrap",this));return a});N(".",170,function(a,b){u(U,n);u();var c=pa();typeof c==="string"&&Ra(c);b.first=a;b.second=n;if(a&&a.value==="arguments"&&(c==="callee"||c===
"caller"))f("avoid_a",a,"arguments."+c);else if(!k.evil&&a&&a.value==="document"&&(c==="write"||c==="writeln"))f("write_is_wrong",a);else if(k.adsafe){if(!Ja&&a.value==="ADSAFE")if(c==="id"||c==="lib")f("adsafe",b);else if(c==="go"){t!=="script"?f("adsafe",b):(la||g.id!=="("||s(0).id!=="(string)"||s(0).value!==W||s(1).id!==",")&&m("adsafe_a",b,"go");la=true;Ia=false}Ja=false}if(!k.evil&&(c==="eval"||c==="execScript"))f("evil");else if(k.safe)for(;;){Qa[c]===true&&f("adsafe_a",n,c);if(typeof Q[a.value]!==
"boolean"||g.id==="(")break;if(Rb[c]===true){g.id==="."&&f("adsafe",b);break}if(g.id!=="."){f("adsafe",b);break}i(".");n.first=b;n.second=c;b=n;c=pa();typeof c==="string"&&Ra(c)}c==="length"&&L("number",b);return b},"",true);N("[",170,function(a,b){var c=bb(a),d;B(U,n);u();K();x();d=w(0);switch(bb(d)){case "number":d.id==="(number)"&&a.id==="arguments"&&f("use_param",a);c||L("array",a);break;case "string":if(d.id==="(string)"){if(k.safe&&(Qa[d.value]||d.value.charAt(0)==="_"||d.value.slice(-1)===
...
d):f("bad_type")}A("]",b);l();u(U,n);b.first=a;b.second=d;return b},"",true);P("[",function(){this.arity="prefix";this.first=[];this.type="array";for(K("array");g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);i(",");l()}if(g.id==="]")break;v.wrap=false;x();this.first.push(w(10));if(g.id===","){G();if(g.id==="]"&&!k.es5){f("unexpected_a",n);break}}else break}A("]",this);l();return this},170);Z("=");Z("+=","+");Z("-=","-");Z("*=","*");Z("/=","/").nud=function(){m("slash_equal")};Z("%=","%");
Z("&=","&");Z("|=","|");Z("^=","^");Z("<<=","<<");Z(">>=",">>");Z(">>>=",">>>");P("{",function(){var a,b,c,d,e,j={};this.arity="prefix";this.first=[];this.type="object";for(K();g.id!=="}";){v.wrap=false;x();if(g.value==="get"&&s().id!==":"){k.es5||f("es5");a=g;i("get");ua();d=g;(b=fb())||m("missing_property");a.value="";Sa(a);q["(loopage)"]&&f("function_loop",a);(c=a.first)&&f("parameter_a_get_b",c[0],c[0].value,b);G();e=g;e.value="";J();x();i("set");ua();c=fb();b!==c&&m("expected_a_b",n,b,c||g.value);
Sa(e);c=e.first;!c||c.length!==1?m("parameter_set_a",e,"value"):c[0].value!=="value"&&m("expected_a_b",c[0],"value",c[0].value);d.first=[a,e]}else{d=g;b=fb();typeof b!=="string"&&m("missing_property");i(":");l();J();d.first=w(10)}this.first.push(d);j[b]===true&&f("duplicate_a",g,b);j[b]=true;Ra(b);if(g.id!==",")break;for(;;){G();if(g.id!==",")break;f("unexpected_a",g)}g.id==="}"&&!k.es5&&f("unexpected_a",n)}A("}",this);l();return this});R("{",function(){l();f("statement_block");this.arity="statement";
this.block=qa();this.disrupt=this.block.disrupt;i("}",this);l();return this});R("/*global",ga);R("/*globals",ga);R("/*jslint",ga);R("/*member",ga);R("/*members",ga);R("/*property",ga);R("/*properties",ga);R("var",function(){var a,b,c;q["(vars)"]&&!k.vars?f("combine_var"):q!==X&&(q["(vars)"]=true);this.arity="statement";this.first=[];for(K("var");;){c=g;b=pa();F(c,"becoming");if(g.id==="="){a=g;a.first=c;J();i("=");J();g.id==="undefined"&&f("unnecessary_initialize",n,b);s(0).id==="="&&g.identifier&&
m("var_a_not");a.second=w(0);a.arity="infix";this.first.push(a);if(a.second.type)c.type=a.second.type}else this.first.push(c);q[b]==="becoming"&&(q[b]="unused");if(g.id!==",")break;G();v.wrap=false;if(ea&&g.line===n.line&&this.first.length===1){ea=null;v.open=false;v.at=v.at-k.indent}J();x()}ea=null;A();return this});R("function",function(){y();Fa&&f("function_block",n);var a=g,b=pa();F(a,"unction");u();Sa(this,b);g.id==="("&&g.line===n.line&&m("function_statement");this.arity="statement";return this});
P("function",function(){y();var a=pa();a?u():a="";Sa(this,a);q["(loopage)"]&&f("function_loop");this.arity="function";return this});R("if",function(){var a=g;y();i("(");K("control");l();u();x();this.arity="statement";this.first=ba(aa(w(0)));u();A(")",a);l();y();this.block=ca(true);if(g.id==="else"){y();i("else");l();y();this["else"]=g.id==="if"||g.id==="switch"?db(true):ca(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});R("try",function(){var a,b,c;k.adsafe&&f("adsafe_a",
this);y();this.arity="statement";this.block=ca(false);if(g.id==="catch"){y();i("catch");l();y();c=g;i("(");K("control");l();u();x();b=D;D=Object.create(b);this.first=a=g.value;g.identifier?F(g,"exception"):f("expected_identifier_a",g);i();u();A(")",c);l();y();this.second=ca(false);D=b}if(g.id==="finally"){l();y();i("finally");l();y();this.third=ca(false)}else this.second||m("expected_a_b",g,"catch",g.value);return this});Oa("while",function(){y();var a=g;q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=
q["(loopage)"]+1;i("(");K("control");l();u();x();this.arity="statement";this.first=aa(w(0));this.first.id!=="true"&&ba(this.first,H.unexpected_a);u();A(")",a);l();y();this.block=ca(true);this.block.disrupt&&f("strange_loop",U);q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});E("with");Oa("switch",function(){var a,b=g,c=true;q["(breakage)"]=q["(breakage)"]+1;y();i("(");l();u();K();this.arity="statement";this.first=ba(aa(w(0)));u();A(")",b);l();y();i("{");K();for(this.second=
[];g.id==="case";){b=g;b.first=[];b.arity="case";J();x("case");for(i("case");;){y();a=w(0);b.first.push(a);a.id==="NaN"&&f("unexpected_a",a);B();i(":");l();if(g.id!=="case")break;J();x("case");i("case");l()}J();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];a.disrupt?a.id==="break"&&(c=false):f("missing_a_after_b",g,"break","case")}else f("empty_case");this.second.push(b)}this.second.length===0&&f("missing_a",g,"case");if(g.id==="default"){J();b=g;b.arity="case";x("case");
i("default");l();B();i(":");l();J();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];if(c&&a.disrupt&&a.id!=="break")this.disrupt=true}this.second.push(b)}q["(breakage)"]=q["(breakage)"]-1;J();A("}",this);return this});R("debugger",function(){k.debug||f("unexpected_a",this);this.arity="statement";return this});Oa("do",function(){q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=q["(loopage)"]+1;y();this.arity="statement";this.block=ca(true);this.block.disrupt&&f("strange_loop",
U);y();i("while");l();var a=g;y();i("(");K();l();u();x();this.first=ba(aa(w(0)),H.unexpected_a);u();A(")",a);l();q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});Oa("for",function(){var a,b,c=false;a=g;var d;this.arity="statement";q["(breakage)"]=q["(breakage)"]+1;q["(loopage)"]=q["(loopage)"]+1;i("(");K("control");l();J(this,a);u();g.id==="var"&&m("move_var");x();if(s(0).id==="in"){b=g;switch(q[b.value]){case "unused":q[b.value]="var";break;case "closure":case "var":break;
default:f("bad_in_a",b)}L("string",b);i();d=g;i("in");d.first=b;d.second=w(20);L("object",d.second);A(")",a);l();this.first=d;a=ca(true);if(!k.forin){if(a.length===1&&typeof a[0]==="object"&&a[0].value==="if"&&!a[0]["else"]){for(b=a[0].first;b.id==="&&";)b=b.first;switch(b.id){case "===":case "!==":c=b.first.id==="["?b.first.first.value===d.second.value&&b.first.second.value===d.first.value:b.first.id==="typeof"&&b.first.first.id==="["&&b.first.first.first.value===d.second.value&&b.first.first.second.value===
...
"call"&&b.second[0].value===d.second.value&&b.second[1].value===d.first.value)}}c||f("for_if",this)}}else{if(g.id!==";"){x();for(this.first=[];;){this.first.push(w(0,"for"));if(g.id!==",")break;G()}}V();if(g.id!==";"){x();this.second=aa(w(0));this.second.id!=="true"&&ba(this.second,H.unexpected_a)}V(n);g.id===";"&&m("expected_a_b",g,")",";");if(g.id!==")"){this.third=[];for(x();;){this.third.push(w(0,"for"));if(g.id!==",")break;G()}}u();A(")",a);l();y();a=ca(true)}a.disrupt&&f("strange_loop",U);this.block=
a;q["(breakage)"]=q["(breakage)"]-1;q["(loopage)"]=q["(loopage)"]-1;return this});Pa("break",function(){var a=g.value;this.arity="statement";q["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){ua();q[a]!=="label"?f("not_a_label",g):D[a].funct!==q&&f("not_a_scope",g);this.first=g;i()}return this});Pa("continue",function(){k["continue"]||f("unexpected_a",this);var a=g.value;this.arity="statement";q["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){ua();
q[a]!=="label"?f("not_a_label",g):D[a].funct!==q&&f("not_a_scope",g);this.first=g;i()}return this});Pa("return",function(){this.arity="statement";if(g.id!==";"&&g.line===n.line){ua();(g.id==="/"||g.id==="(regexp)")&&f("wrap_regexp");this.first=w(20)}return this});Pa("throw",function(){this.arity="statement";ua();this.first=w(20);return this});E("class");E("const");E("enum");E("export");E("extends");E("import");E("super");E("let");E("yield");E("implements");E("interface");E("package");E("private");
E("protected");E("public");E("static");kb=[sa,function(){for(;;)if(g.identifier)switch(g.value.toLowerCase()){case "url":sa();break;case "expression":f("unexpected_a");i();break;default:i()}else{if(g.id===";"||g.id==="!"||g.id==="(end)"||g.id==="}")return true;i()}}];ya=["none","dashed","dotted","double","groove","hidden","inset","outset","ridge","solid"];ob=["auto","always","avoid","left","right"];Ab={all:true,braille:true,embossed:true,handheld:true,print:true,projection:true,screen:true,speech:true,
...
"border-right-width":xa,"border-spacing":[2,C],"border-style":[4,ya],"border-top":[true,"border-top-color","border-top-style","border-top-width"],"border-top-color":ja,"border-top-style":ya,"border-top-width":xa,"border-width":[4,xa],bottom:[C,"auto"],"caption-side":["bottom","left","right","top"],clear:["both","left","none","right"],clip:[function(){var a;if(g.identifier&&g.value==="rect"){i();i("(");for(a=0;a<4;a=a+1)if(!C()){f("expected_number_a");break}i(")");return true}return false},"auto"],
color:ja,content:["open-quote","close-quote","no-open-quote","no-close-quote",ib,sa,function(){if(g.identifier&&g.value==="counter"){i();i("(");i();if(g.id===","){G();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}if(g.identifier&&g.value==="counters"){i();i("(");g.identifier||f("expected_name_a");i();if(g.id===","){G();g.id!=="(string)"&&f("expected_string_a");i()}if(g.id===","){G();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}return false},function(){if(g.identifier&&
...
"white-space":["normal","nowrap","pre","pre-line","pre-wrap","inherit"],width:[C,"auto"],"word-spacing":["normal",C],"word-wrap":["break-word","normal"],"z-index":["auto",Ua]};da=function(a,b){var c,j,h;JAYLINT.comments=[];JAYLINT.errors=[];JAYLINT.tree="";nb=ta=U=n=g=Object.create(Y["(begin)"]);Q={};d(Qb);if(b){k=Object.create(b);if(j=k.predef)if(Array.isArray(j))for(c=0;c<j.length;c=c+1)Q[j[c]]=true;else typeof j==="object"&&d(j);fa()}else k={};k.indent=+k.indent||0;k.maxerr=k.maxerr||50;W="";Ia=
Ja=la=false;Wa={};if(k.approved)for(c=0;c<k.approved.length;c=c+1)Wa[k.approved[c]]=k.approved[c];else Wa.test="test";Za="";for(c=0;c<k.indent;c=c+1)Za=Za+" ";Aa=D={};X=q={"(scope)":D,"(breakage)":0,"(loopage)":0};Ta=[q];Da=false;Ya={};Fa=false;v=null;ma=false;Ba=[];ra={};La=false;ha=null;pb=true;qb=false;O=null;na=false;Ha=[];ea=null;Ma=0;t="";Ca.init(a);e();try{i();if(g.id==="(number)")m("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var l,p,r,s,F=k.white,y,B,A,w;t="html";T="";for(O=null;;){switch(g.value){case "<":t=
"html";i("<");p={};B=g;B.identifier||f("bad_name_a",B);s=B.value;k.cap&&(s=s.toLowerCase());B.name=s;i();if(!O){O=[];c=s;c!=="html"&&!k.fragment&&(c==="div"&&k.adsafe?m("adsafe_fragment"):m("expected_a_b",n,"html",c));if(k.adsafe){c==="html"&&m("adsafe_html",n);k.fragment?c!=="div"&&m("adsafe_div",n):m("adsafe_fragment",n)}k.browser=true}A=mb[s];typeof A!=="object"&&m("unrecognized_tag_a",B,s);r=A.empty;for(B.type=s;;){if(g.id==="/"){i("/");g.id!==">"&&f("expected_a_b",g,">",g.value);break}if(g.id&&
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&f("expected_a_b",g,">",g.value);f("bad_name_a")}k.white=false;J();l=g.value;k.white=F;i();!k.cap&&l!==l.toLowerCase()&&f("attribute_case_a",n);l=l.toLowerCase();T="";Object.prototype.hasOwnProperty.call(p,l)&&f("duplicate_a",n,l);if(l.slice(0,2)==="on"){k.on||f("html_handlers");t="scriptstring";i("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);T=y;w=k.white;k.white=true;i(y);Na();qa();k.white=w;g.id!==y&&
m("expected_a_b",g,y,g.value);t="html";T="";i(y);A=false}else if(l==="style"){t="scriptstring";i("=");y=g.id;y!=='"'&&y!=="'"&&m("expected_a_b",g,'"',g.value);t="styleproperty";T=y;i(y);xb();t="html";T="";i(y);A=false}else if(g.id==="="){i("=");A=g.value;!g.identifier&&g.id!=='"'&&g.id!=="'"&&g.id!=="(string)"&&g.id!=="(string)"&&g.id!=="(color)"&&f("expected_attribute_value_a",n,l);i()}else A=true;p[l]=A;c=l;j=A;var u=h=void 0;if(c==="id"){h=typeof j==="string"?j.toUpperCase():"";Ya[h]===true&&f("duplicate_a",
g,j);if(/^[A-Za-z][A-Za-z0-9._:\-]*$/.test(j)){if(k.adsafe)if(W)j.slice(0,W.length)!==W?f("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(j)||f("adsafe_bad_id");else{W=j;/^[A-Z]+_$/.test(j)||f("adsafe_bad_id")}}else f("bad_id_a",g,j);u=j.search(Wb);u>=0&&f("unexpected_char_a_b",n,j.charAt(u),c);Ya[h]=true}else if(c==="class"||c==="type"||c==="name"){u=j.search(Zb);u>=0&&f("unexpected_char_a_b",n,j.charAt(u),c);Ya[h]=true}else if(c==="href"||c==="background"||c==="content"||c==="data"||c.indexOf("src")>=
0||c.indexOf("url")>=0){k.safe&&wb.test(j)&&m("bad_url",g,j);Ha.push(j)}else c==="for"?k.adsafe&&(W?j.slice(0,W.length)!==W?f("adsafe_prefix_a",g,W):/^[A-Z]+_[A-Z]+$/.test(j)||f("adsafe_bad_id"):f("adsafe_bad_id")):c==="name"&&k.adsafe&&j.indexOf("_")>=0&&f("adsafe_name_a",g,j)}c=s;j=p;h=void 0;var C=mb[c],E=u=void 0;qb=false;C||m(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(O.length>0){c==="html"&&m("unexpected_a",n,c);if(E=C.parent)E.indexOf(" "+O[O.length-1].name+
" ")<0&&m("tag_a_in_b",n,c,E);else if(!k.adsafe&&!k.fragment){h=O.length;do{h<=0&&m("tag_a_in_b",n,c,"body");h=h-1}while(O[h].name!=="body")}}switch(c){case "div":k.adsafe&&O.length===1&&!W&&f("adsafe_missing_id");break;case "script":t="script";i(">");j.lang&&f("lang",n);k.adsafe&&O.length!==1&&f("adsafe_placement",n);if(j.src){k.adsafe&&(!Ia||!Wa[j.src])&&f("adsafe_source",n);j.type&&f("type",n)}else{K(g.from);x();Na();Ja=true;u=qa();if(k.adsafe){la&&m("adsafe_script",n);(u.length!==1||z(u[0],"id",
...
null}t="html";i("</");!g.identifier&&g.value!=="script"&&f("expected_a_b",g,"script",g.value);i();t="outer";break;case "style":t="style";i(">");zb();t="html";i("</");!g.identifier&&g.value!=="style"&&f("expected_a_b",g,"style",g.value);i();t="outer";break;case "input":switch(j.type){case "radio":case "checkbox":case "button":case "reset":case "submit":break;case "text":case "file":case "password":case "file":case "hidden":case "image":k.adsafe&&j.autocomplete!=="off"&&f("adsafe_autocomplete");break;
default:f("bad_type")}break;case "applet":case "body":case "embed":case "frame":case "frameset":case "head":case "iframe":case "noembed":case "noframes":case "object":case "param":k.adsafe&&f("adsafe_tag",g,c)}r||O.push(B);t="outer";i(">");break;case "</":t="html";i("</");g.identifier||f("bad_name_a");s=g.value;k.cap&&(s=s.toLowerCase());i();O||m("unexpected_a",g,"</"+s+">");(B=O.pop())||m("unexpected_a",g,"</"+s+">");B.name!==s&&m("expected_a_b",g,"</"+B.name+">","</"+s+">");g.id!==">"&&m("expected_a_b",
g,">",g.value);t="outer";i(">");break;case "<!":k.safe&&f("adsafe_a");for(t="html";;){i();if(g.id===">"||g.id==="(end)")break;g.value.indexOf("--")>=0&&m("unexpected_a",g,"--");g.value.indexOf("<")>=0&&m("unexpected_a",g,"<");g.value.indexOf(">")>=0&&m("unexpected_a",g,">")}t="outer";i(">");break;case "(end)":break a;default:g.id==="(end)"?m("missing_a",g,"</"+O[O.length-1].value+">"):i()}if(O&&O.length===0&&(k.adsafe||!k.fragment||g.id==="(end)"))break}g.id!=="(end)"&&m("unexpected_a")}k.adsafe&&
!la&&f("adsafe_go",this)}else switch(g.id){case "{":case "[":ma=true;gb();break;case "@":case "*":case "#":case ".":case ":":t="style";i();(n.id!=="@"||!g.identifier||g.value!=="charset"||n.line!==1||n.from!==1)&&m("css");i();g.id!=="(string)"&&g.value!=="UTF-8"&&m("css");i();V();zb();break;default:k.adsafe&&k.fragment&&m("expected_a_b",g,"<div>",g.value);K(1);g.id===";"&&!La&&V();Ja=true;h=qa();nb.first=h;JAYLINT.tree=nb;k.adsafe&&(h.length!==1||z(h[0],"id","(")||z(h[0].first,"id",".")||z(h[0].first.first,
"value","ADSAFE")||z(h[0].first.second,"value","lib")||h[0].second.length!==2||h[0].second[0].id!=="(string)"||z(h[0].second[1],"id","function"))&&m("adsafe_lib");h.disrupt&&f("weird_program",U)}v=null;i("(end)")}catch(G){G&&JAYLINT.errors.push({reason:G.message,line:G.line||g.line,character:G.character||g.from},null)}return JAYLINT.errors.length===0};da.data=function(){var a={functions:[]},b,c,d,e,f,g=[],j=[];if(da.errors.length)a.errors=da.errors;if(ma)a.json=true;if(Ha.length>0)a.urls=Ha;b=Object.keys(Aa).filter(function(a){return a.charAt(0)!==
"("?a:void 0});if(b.length>0)a.globals=b;for(c=1;c<Ta.length;c=c+1){f=Ta[c];b={};for(d=0;d<Ka.length;d=d+1)b[Ka[d]]=[];for(e in f)if(Object.prototype.hasOwnProperty.call(f,e)&&e.charAt(0)!=="("){d=f[e];if(d==="unction"||d==="unparam")d="unused";if(Array.isArray(b[d])){b[d].push(e);d==="unused"?j.push({name:e,line:f["(line)"],"function":f["(name)"]}):d==="undef"&&g.push({name:e,line:f["(line)"],"function":f["(name)"]})}}for(d=0;d<Ka.length;d=d+1)b[Ka[d]].length===0&&delete b[Ka[d]];b.name=f["(name)"];
b.param=f["(params)"];b.line=f["(line)"];b["(complexity)"]=f["(complexity)"];a.functions.push(b)}if(j.length>0)a.unused=j;if(g.length>0)a.undef=g;for(e in ra)if(typeof ra[e]==="number"){a.member=ra;break}return a};da.report=function(a){function b(a,c){var d,e;if(Array.isArray(c)){i.push("<div><i>"+a+"</i> ");c=c.sort().forEach(function(a){if(a!==e){e=a;i.push((d?", ":"")+e);d=true}});i.push("</div>")}else c&&i.push("<div><i>"+a+"</i> "+c+"</div>")}var d=da.data(),e,f,g,j;f="";var h,i=[];if(d.errors||
d.unused||d.undef){e=true;i.push("<div id=errors><i>Error:</i>");if(d.errors)for(g=0;g<d.errors.length;g=g+1)if(j=d.errors[g]){f=j.evidence||"";i.push("<p>Problem"+(isFinite(j.line)?" at line "+j.line+" character "+j.character:"")+": "+j.reason.entityify()+"</p><p class=evidence>"+(f&&(f.length>80?f.slice(0,77)+"...":f).entityify())+"</p>")}if(d.undef){f=[];for(g=0;g<d.undef.length;g=g+1)f[g]="<code><u>"+d.undef[g].name+"</u></code>&nbsp;<i>"+d.undef[g].line+" </i> <small>"+d.undef[g]["function"]+
"</small>";i.push("<p><i>Undefined variable:</i> "+f.join(", ")+"</p>")}if(d.unused){f=[];for(g=0;g<d.unused.length;g=g+1)f[g]="<code><u>"+d.unused[g].name+"</u></code>&nbsp;<i>"+d.unused[g].line+" </i> <small>"+d.unused[g]["function"]+"</small>";i.push("<p><i>Unused variable:</i> "+f.join(", ")+"</p>")}d.json&&i.push("<p>JSON: bad.</p>");i.push("</div>")}if(!a){i.push("<br><div id=functions>");d.urls&&b("URLs<br>",d.urls,"<br>");t==="style"?i.push("<p>CSS.</p>"):d.json&&!e?i.push("<p>JSON: good.</p>"):
...
e.exception);b("Outer",e.outer);b("Global",e.global);b("Label",e.label);b("Complexity",e["(complexity)"])}if(d.member){e=Object.keys(d.member);if(e.length){e=e.sort();f="<br><pre id=properties>/*properties ";j=13;for(g=0;g<e.length;g=g+1){a=e[g];h=Cb.test(a)?a:"'"+a.entityify().replace(ub,c)+"'";if(j+h.length>72){i.push(f+"<br>");f="    ";j=1}j=j+(h.length+2);d.member[a]===1&&(h="<i>"+h+"</i>");g<e.length-1&&(h=h+", ");f=f+h}i.push(f+"<br>*/</pre>")}i.push("</div>")}}return i.join("")};da.jslint=
...
function(a){return this["_"+a.name]};a.Base.prototype.setProperty=function(a,b,c){this[a.name]=b;c()};a.Base.prototype.getProperty=function(a,b){b.apply(this,[this[a.name]])};a.Base.extend=function(b,c,d){return a.Class.define(b,null,null,c,d)};h.__enum=true;h.method="method";h.property="property";h.navProperty="navProperty";h.complexProperty="complexProperty";h.field="field";a.MemberTypes=h;f.constructor="constructor";f.classConstructor="classConstructor";f.mixin="mixin";f.propagation="propagation";
e.prototype={getClass:function(){},getProperties:function(a){return a.propertyDefinitions},define:function(a,b,c,d,e){return this.defineEx(a,[{type:b}],c,d,e)},defineEx:function(b,c,d,e,f){if(c.length==0)c.push({type:a.Base});else if(c.length>0&&!c[0].type)c[0].type=a.Base;for(var d=0,h=c.length;d<h;d++)typeof c[d]==="function"&&(c[d]={type:c[d]});for(var h=b.split("."),s=h.splice(h.length-1,1)[0],l=window,d=0;d<h.length;d++){var i=h[d];l[i]||(l[i]={__namespace:true});l=l[i]}d=null;d=this.classFunctionBuilder(s,
c,f,e);d.fullName=b;d.namespace=h.join(".");this.buildType(d,c,e,f);d.name=s;Container.registerType(b,d);typeof intellisense!=="undefined"&&e&&e.constructor&&intellisense.annotate(d,e.constructor);return l[s]=this.classNames[b]=d},classFunctionBuilder:function(a,b,c,d){return(new Function("base","classDefinition","instanceDefinition","return function "+a+" (){ "+this.bodyBuilder(b,c,d)+" \n}; "))(b,c,d)},bodyBuilder:function(a,b,c){for(var d=b="",e="",f=0,h=a.length;f<h;f++){var l=a[f],i=f;if(i==
0){if(l&&l.type){d=d+("    var baseArguments = $data.typeSystem.createCtorParams(arguments, base["+i+"].params, this); \n");d=d+("    "+l.type.fullName+".apply(this, baseArguments); \n")}}else if(l&&l.type&&l.propagateTo){e=e+("    "+(!e?"var ":"")+"propagationArguments = $data.typeSystem.createCtorParams(arguments, base["+i+"].params, this); \n");e=e+('    this["'+l.propagateTo+'"] =  Object.create('+l.type.fullName+".prototype); \n    "+l.type.fullName+'.apply(this["'+l.propagateTo+'"], propagationArguments); \n')}else l&&
l.type&&l.type.memberDefinitions&&l.type.memberDefinitions.$constructor&&!l.propagateTo&&(b=b+("    "+l.type.fullName+".memberDefinitions.$constructor.method.apply(this); \n"))}c&&c.constructor!=Object&&(d=d+"    instanceDefinition.constructor.apply(this, arguments); \n");return"\n    //mixins \n"+b+"\n    //construction \n"+d+"\n    //propagations \n"+e},buildType:function(b,c,e,f){var h=c[0].type;if(b.inheritsFrom=h){b.prototype=Object.create(h.prototype);b.memberDefinitions=Object.create(h.memberDefinitions||
new d);b.memberDefinitions.clearCache();var F=h.staticDefinitions;if(F)if(F=F.asArray())for(var s=0;s<F.length;s++)this.buildMember(b,F[s],void 0,"staticDefinitions");b.baseTypes=h.baseTypes||[];for(s=0;s<c.length;s++)b.baseTypes.push(c[s].type);b.isAssignableTo||Object.defineProperty(b,"isAssignableTo",{value:function(a){return this===a||this.baseTypes.indexOf(a)>=0},writable:false,enumerable:false,configurable:false})}if(f){this.buildStaticMembers(b,f);if(f.constructor)b.classConstructor=f.constructor}e&&
this.buildInstanceMembers(b,e);c=[].concat(c);c.shift();Object.keys(c).length>0&&this.buildInstanceMixins(b,c);b.__class=true;b.prototype.constructor=b;Object.defineProperty(b.prototype,"getType",{value:function(){return b},writable:false,enumerable:false,configurable:false});b.extend=function(c,d,e){return a.Class.define(c,b,null,d,e)};Object.defineProperty(b,"getMemberDefinition",{value:function(a){return b.memberDefinitions.getMember(a)}})},addMethod:function(a,b,c,d){a[b]=!d||typeof intellisense!==
"undefined"?c:function(){return c.apply(this[d],arguments)}},addProperty:function(a,b,c,d){if(d){c.configurable=true;if(c.get){var e=c.get;c.get=function(){this[d]||Guard.raise(new Exception("not inicialized"));return e.apply(this[d],arguments)}}if(c.set){var f=c.set;c.set=function(){this[d]||Guard.raise(new Exception("not inicialized"));f.apply(this[d],arguments)}}}Object.defineProperty(a,b,c)},addField:function(){Guard.raise("not implemented")},buildMethod:function(a,b,c){this.addMethod(b.classMember?
a:a.prototype,b.name,b.method,c)},buildProperty:function(a,b,c){var d=b.classMember?a:a.prototype,e=b.createPropertyDescriptor(a);this.addProperty(d,b.name,e,c);if(!b.classMember&&a.__setPropertyfunctions==true){a=b.createGetMethod();this.addProperty(d,"get_"+b.name,a,c);a=b.createSetMethod();this.addProperty(d,"set_"+b.name,a,c)}},buildMember:function(a,b,c,e){e=e||"memberDefinitions";a[e]=a[e]||new d;a[e].setMember(b);switch(b.kind){case h.method:this.buildMethod(a,b,c);break;case h.navProperty:case h.complexProperty:case h.property:this.buildProperty(a,
b,c);break;default:Guard.raise("Unknown member type: "+b.kind+","+b.name)}},buildStaticMembers:function(a,b){for(var d in b)if(b.hasOwnProperty(d)){var e=new c(b[d],a);e.name=d;e.classMember=true;this.buildMember(a,e,void 0,"staticDefinitions")}},buildInstanceMembers:function(a,b){for(var d in b)if(b.hasOwnProperty(d)){var e=new c(b[d],a);e.name=d;this.buildMember(a,e)}},copyMembers:function(a,b){Object.keys(a.prototype).forEach(function(c){if(c!=="constructor"&&c!=="toString"){typeof intellisense!==
"undefined"&&intellisense.logMessage("copying item:"+c);b.prototype[c]=a[c]}})},buildInstanceMixins:function(a,b){a.mixins=a.mixins||[];a.propagations=a.propagations||[];for(var c=0;c<b.length;c++){var d=b[c];if(d.propagateTo){this.buildInstancePropagation(a,d);a.propagations.push(d);a.propagations[d.type.name]=true}else{this.buildInstanceMixin(a,d);a.mixins.push(d);a.mixins[d.type.name]=true}}},buildInstanceMixin:function(a,b){for(var c=b.type.memberDefinitions.asArray(),d=0,e=c.length;d<e;d++){var f=
c[d].name;f!=="constructor"&&!a.memberDefinitions.getMember(f)&&this.buildMember(a,c[d])}},buildInstancePropagation:function(a,b){for(var c=b.type.memberDefinitions.asArray(),d=0,e=c.length;d<e;d++){var f=c[d].name;f!=="constructor"&&!a.memberDefinitions.getMember(f)&&this.buildMember(a,c[d],b.propagateTo)}}};a.Class=Class=new e;(function(b){a.Number=typeof Number!=="undefined"?Number:function(){};a.Integer=typeof Integer!=="undefined"?Integer:function(){};a.Date=typeof Date!=="undefined"?Date:function(){};
a.String=typeof String!=="undefined"?String:function(){};a.Boolean=typeof Boolean!=="undefined"?Boolean:function(){};a.Blob=function(){};a.Array=typeof Array!=="undefined"?Array:function(){};a.Object=typeof Object!=="undefined"?Object:function(){};a.ObjectID=typeof ObjectID!=="undefined"?ObjectID:function(){};a.Function=Function;b.Container=a.Container=b=b.C$=new function(){var b={},c=[],d=[];this.classNames=b;this.consolidatedClassNames=c;this.classTypes=d;var e=[];this.mappedTo=e;var f=this;this.holder=
null;this.mapType=function(a,b){Guard.requireValue("aliasType",a);Guard.requireValue("realType",b);var c=this.getType(a),f=this.getType(b),c=d.indexOf(c),f=d.indexOf(f);e[c]=f};this.resolve=function(a,b){return new (this.resolveType(a,b))(b)};this.resolveName=function(a){a=this.resolveType(a);a=d.indexOf(a);return c[a]};this.isPrimitiveType=function(b){b=this.resolveType(b);return b===Number||b===String||b===Date||b===String||b===Boolean||b===Array||b===Object||b===a.Number||b===a.String||b===a.Date||
b===a.String||b===a.Boolean||b===a.Array||b===a.Object};this.resolveType=function(a){var a=this.getType(a),b=d.indexOf(a);return typeof e[b]==="undefined"?a:d[e[b]]};this.getTypes=function(){for(var a=Object.keys(b),c=[],e=0;e<a.length;e++){var f=a[e];c.push({name:f,type:d[b[f]],toString:function(){return this.name}})}return c};this.getTypeName=function(a){switch(typeof a){case "object":if(a==null)return"$data.Object";if(a instanceof Array)return"$data.Array";if(a.getType)return a.getType().fullName;
if(a instanceof Date)return"$data.Date";default:return typeof a}};this.isTypeRegistered=function(a){return typeof a==="function"?d.indexOf(a)>-1:a in b};this.unregisterType=function(){Guard.raise("Unimplemented")};this.getType=function(a){Guard.requireValue("typeOrName",a);if(typeof a==="function")return a;a in b||Guard.raise(new Exception("Unable to resolve type:"+a));return d[b[a]]};this.getName=function(a){var b=this.getType(a),b=d.indexOf(b);b==-1&&Guard.raise("unknown type to request name for: "+
a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return"";case a.Boolean:return false;default:return null}};this.registerType=function(a,e,h){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var j=[];j.push(a);a=j}for(j=0;j<a.length;j++){var z=a[j].split("."),x={};x.shortName=z[z.length-1];x.fullName=a[j];a[j]=x}z=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);b.apply(c,
a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(z,e);for(var j=0,K=a.length;j<K;j++){x=a[j];"create"+x.shortName in f?console&&console.warn("warning: short names overlap:"+x.shortName+", Container.create"+x.shortName+" has not been updated"):f["create"+x.shortName]=typeof h==="function"?h:z;var A=d.indexOf(e);if(A==-1){A=d.push(e)-1;c[A]=x.fullName}x.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+x.fullName);b[x.fullName]=A}if(!e.name)e.name=
a[0].shortName}}};b.registerType(["$data.Number","number","float","real","decimal","JayNumber"],a.Number);b.registerType(["$data.Integer","int","integer","int16","int32","int64","JayInteger"],a.Integer);b.registerType(["$data.String","string","text","character","JayString"],a.String);b.registerType(["$data.Array","array","Array","[]","JayArray"],a.Array,function(){return a.Array.apply(void 0,arguments)});b.registerType(["$data.Date","datetime","date","JayDate"],a.Date);b.registerType(["$data.Boolean",
"bool","boolean","JayBoolean"],a.Boolean);b.registerType(["$data.Blob","blob","JayBlob"],a.Blob);b.registerType(["$data.Object","Object","object","{}","JayObject"],a.Object);b.registerType(["$data.Function","Function","function"],a.Function);b.registerType(["$data.ObjectID","ObjectID","objectId","objectid","ID","Id","id","JayObjectID"],a.ObjectID)})(window);b.$C=function(){Class.define.apply(Class,arguments)};a.Class.ConstructorParameter=ConstructorParameter=a.Class.define("ConstructorParameter",
...
writeProperties:function(a,b){for(var c={},d=0,e=b.length;d<e;d++){var h=b[d];c[h.name]=h.createPropertyDescriptor(null,h.value)}Object.defineProperties(a,c)},writeProperty:function(a,b,c){if(b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b){c=b.createPropertyDescriptor(null,c);Object.defineProperty(a,b.name,c)}}};$data.ASTNode=function(){};$data.FunctionASTNode=function(){};$data.FunctionASTNode.prototype=new $data.ASTNode;$data.ParameterASTNode=function(){};
...
$data.Class.define("$data.Access",null,null,{},{isAuthorized:function(a,b,c,d){console.log("isAuthorized",arguments);var e;a||(e="Access undefined");typeof a!=="number"&&(e="Invalid access type");b||(b={});if(!b.roles)b.roles={};c||(c={});c instanceof Array||typeof c==="object"||(e="Invald roles type");var h=new $data.PromiseHandler,f=h.createCallback(d),h=h.getPromise();if(e){f.error(e,"Access authorization");return h}if(b.roles instanceof Array){e={};for(var j=0;j<b.roles.length;j++)typeof b.roles[j]===
"string"&&(e[b.roles[j]]=true);b.roles=e}if(c instanceof Array){e={};for(j=0;j<c.length;j++)typeof c[j]==="string"&&(e[c[j]]=true);c=e}var m=arguments,r=function(a){a?f.success(a):f.error("Authorization failed",m)},p=Object.getOwnPropertyNames(c),j=0,z=function(d){d&&r(d);if(typeof c[p[j]]==="boolean"&&c[p[j]])if(b.roles[p[j]])r(true);else{j++;j<p.length?z():r(false)}else if(typeof c[p[j]]==="function"){d=c[p[j]].call(b);if(typeof d==="function")d.call(b,j<p.length?z:r);else if(d)r(true);else{j++;
j<p.length?z():r(false)}}else if(typeof c[p[j]]==="number")if((typeof b.roles[p[j]]==="number"&&b.roles[p[j]]&a||typeof b.roles[p[j]]!=="number"&&b.roles[p[j]])&&c[p[j]]&a)b.roles[p[j]]&&r(true);else{j++;j<p.length?z():r(false)}};z();return h},None:0,Create:1,Read:2,Update:4,Delete:8,Execute:16});
...
getDataType:function(a){if(typeof a=="string"){var b=this[a];if(b===void 0||b===null)b=eval(a);return b}return a},_initializeEntitySets:function(a){a.inheritsFrom!==null&&a.inheritsFrom!==void 0&&this._initializeEntitySets(a.inheritsFrom);for(var a=0,b=this._storageModel.length;a<b;a++){var c=this._storageModel[a];this[c.ItemName]=new $data.EntitySet(c.LogicalType,this,c.ItemName,c.EventHandlers,c.Roles);var d=this[c.ItemName];d.name=c.ItemName;d.tableName=c.TableName;d.eventHandlers=c.EventHandlers;
this._entitySetReferences[c.LogicalType.name]=d;c.EntitySetReference=d}},_initializeStorageModel:function(){this.getType().memberDefinitions.asArray().forEach(function(a){if("dataType"in a){var b=Container.resolveType(a.dataType);if(b&&b.isAssignableTo&&b.isAssignableTo($data.EntitySet)){b=new $data.StorageModel;b.TableName=a.tableName||a.name;b.ItemName=a.name;b.LogicalType=Container.resolveType(a.elementType);b.LogicalTypeName=b.LogicalType.name;b.PhysicalTypeName=$data.EntityContext._convertLogicalTypeNameToPhysical(b.LogicalTypeName);
if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.beforeCreate=a.beforeCreate}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.beforeRead=a.beforeRead}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.beforeUpdate=a.beforeUpdate}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.beforeDelete=a.beforeDelete}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.afterCreate=a.afterCreate}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers=
{};b.EventHandlers.afterRead=a.afterRead}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.afterUpdate=a.afterUpdate}if(a.beforeCreate){if(!b.EventHandlers)b.EventHandlers={};b.EventHandlers.afterDelete=a.afterDelete}var a=a.roles,c={};if(a instanceof Array)for(var d=0;d<a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;b.Roles=c;this._storageModel.push(b)}}},this);typeof intellisense==="undefined"&&this._storageModel.forEach(function(a){var b={};a.Associations=
a.Associations||[];a.ComplexTypes=a.ComplexTypes||[];a.LogicalType.memberDefinitions.getPublicMappedProperties().forEach(function(c){var e=Container.resolveType(c.dataType);if(this.storageProvider.supportedDataTypes.indexOf(e)>-1&&Object.isNullOrUndefined(c.inverseProperty)){var h=JSON.parse(JSON.stringify(c));h.dataType=e;b[c.name]=h}else{this._buildDbType_navigationPropertyComplite(c,e,a);if((e===$data.Array||e.isAssignableTo&&e.isAssignableTo($data.EntitySet))&&c.inverseProperty&&c.inverseProperty!==
"$$unbound")this._buildDbType_Collection_OneManyDefinition(b,a,e,c);else if(c.inverseProperty)if(c.inverseProperty==="$$unbound")e===$data.Array?this._buildDbType_Collection_OneManyDefinition(b,a,e,c):this._buildDbType_ElementType_OneManyDefinition(b,a,e,c);else(h=e.memberDefinitions.getMember(c.inverseProperty))?h.elementType?Container.resolveType(h.elementType)===a.LogicalType?this._buildDbType_ElementType_OneManyDefinition(b,a,e,c):typeof intellisense==="undefined"&&Guard.raise(new Exception("Inverse property not valid, refereed item element type not match: "+
...
return}c=a.result[0]}else if(a.expression.nodeType===$data.Expressions.ExpressionType.First){if(a.result.length===0){b.error(new Exception("result count failed"));return}c=a.result[0]}else c=a.result;var e=function(){b.success(c)},f=0,h=a.getEntitySets(),j=function(){var b=h[f];if(b.afterRead){f++;b=b.afterRead.call(this,c,h,a);typeof b==="function"?b.call(this,f<h.length?j:e,c,h,a):f<h.length?j():e()}else e()};h.length?j():e()}};e.error=b.error;var h=c.getEntitySets(),f=true,j=this,m=function(a){a===
false&&(f=false);if(f)j.storageProvider.executeQuery(c,e);else{c.rawDataList=[];c.result=[];e.success(c)}},r=0,p=function(a){a===false&&(f=false);a=h[r];if(a.beforeRead){r++;a=a.beforeRead.call(this,h,c);if(typeof a==="function")a.call(this,r<h.length&&f?p:m,h,c);else{a===false&&(f=false);r<h.length&&f?p():m()}}else m()};h.length?p():m()},saveChanges:function(a){for(var b=[],c=this.stateManager.trackedEntities,d=new $data.PromiseHandler,e=d.createCallback(a),a=d.getPromise(),h=[];c.length>0;){var f=
...
true;h.push(a.data)}b.PhysicalType.memberDefinitions.asArray().filter(function(a){return a.kind==$data.MemberTypes.navProperty}).forEach(function(c){var d=b.Associations[c.name],e=d.ToPropertyName;[].concat(a.data[c.name]).forEach(function(b){if(b){var c=b[e],h=d.FromMultiplicity+d.ToMultiplicity;if(d.FromMultiplicity==="$$unbound")if(b instanceof $data.Array){a.dependentOn=a.dependentOn||[];b.forEach(function(){a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)},this)}else{a.dependentOn=
a.dependentOn||[];a.dependentOn.indexOf(b)<0&&b.skipSave!==true&&a.dependentOn.push(b)}else{switch(h){case "*0..1":c?c instanceof Array?c.indexOf(a.data)==-1&&c.push(a.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):b[e]=[a.data];break;default:c?c!==a.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):b[e]=a.data}switch(h){case "*0..1":case "0..11":a.dependentOn=a.dependentOn||[];a.dependentOn.indexOf(b)<
0&&b.skipSave!==true&&a.dependentOn.push(b)}}if(!b.entityState)b.entityState=$data.EntityState.Added;f.indexOf(b)==-1&&f.push(b)}},this)},this)},this);c.forEach(function(a){a.skipSave!==true&&b.push(a)});c=[];f.forEach(function(a){h.some(function(b){return b==a})||b.some(function(b){return b.data==a})||c.push({data:a,entitySet:this.getEntitySetFromElementType(a.getType().name)})},this)}b.forEach(function(a){if(a.dependentOn){for(var b=[],c=0;c<a.dependentOn.length;c++)h.indexOf(a.dependentOn[c])<
0&&b.push(a.dependentOn[c]);a.dependentOn=b}});var h=null,j=this;if(b.length==0){e.success(0);return a}var m=[];b.forEach(function(a){a.data.entityState===$data.EntityState.Added&&a.data.getType().memberDefinitions.getPublicMappedProperties().forEach(function(b){b.required&&!b.computed&&!a.data[b.name]&&(a.data[b.name]=Container.getDefault(b.dataType))},this);(a.data.entityState!=$data.EntityState.Added||a.data.entityState!=$data.EntityState.Modified)&&!a.data.isValid()&&m.push({item:a.data,errors:a.data.ValidationErrors})});
if(m.length>0){e.error(m);return a}for(var r={},p=0;p<b.length;p++){var d=b[p],z=d.entitySet.elementType.name,F=this._entitySetReferences[z];if(F.beforeCreate||F.beforeUpdate||F.beforeDelete){r[z]||(r[z]={});switch(d.data.entityState){case $data.EntityState.Added:if(F.beforeCreate){if(!r[z].createAll)r[z].createAll=[];r[z].createAll.push(d)}break;case $data.EntityState.Modified:if(F.beforeUpdate){if(!r[z].modifyAll)r[z].modifyAll=[];r[z].modifyAll.push(d)}break;case $data.EntityState.Deleted:if(F.beforeDelete){if(!r[z].deleteAll)r[z].deleteAll=
[];r[z].deleteAll.push(d)}}}}var s=function(a){if(a){l="async";b.length=0}b.length?j.storageProvider.saveChanges({success:function(){j._postProcessSavedItems(e,b)},error:e.error},b):e.success(0)},l,i=Object.getOwnPropertyNames(r),p=0,fa=["beforeUpdate","beforeDelete","beforeCreate"],ga={beforeCreate:"createAll",beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},x=function(a){if(a){l="async";b.length=0}var a=j._entitySetReferences[i[p]],c=fa.pop(),d=r[i[p]][ga[c]];if(d){var e=d.map(function(a){return a.data});
if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];p++}var f=a[c].call(j,e);if(typeof f==="function")f.call(j,p<i.length&&!l?x:s,e);else if(f===false){l=a.name+"."+c;d.forEach(function(a){a=b.indexOf(a);b.splice(a,1)});s()}else p<i.length&&!l?x():s()}else{if(!fa.length){fa=["beforeUpdate","beforeDelete","beforeCreate"];p++}p<i.length&&!l?x():s()}};p<i.length?x():s();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof
$data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);var c={},d=this;b.forEach(function(a){var b=a.data.entityState;a.data.entityState=$data.EntityState.Unchanged;a.data.changedProperties=[];a.physicalData=void 0;var e=a.entitySet.elementType.name,f=d._entitySetReferences[e];if(f.afterCreate||f.afterUpdate||f.afterDelete){c[e]||(c[e]={});switch(b){case $data.EntityState.Added:if(f.afterCreate){if(!c[e].createAll)c[e].createAll=[];c[e].createAll.push(a)}break;case $data.EntityState.Modified:if(f.afterUpdate){if(!c[e].modifyAll)c[e].modifyAll=
[];c[e].modifyAll.push(a)}break;case $data.EntityState.Deleted:if(f.afterDelete){if(!c[e].deleteAll)c[e].deleteAll=[];c[e].deleteAll.push(a)}}}});var e=Object.getOwnPropertyNames(c),h=0,d=this,f=["afterUpdate","afterDelete","afterCreate"],j={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},m=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},r=function(){var a=d._entitySetReferences[e[h]],b=f.pop(),F=c[e[h]][j[b]];if(F){F=F.map(function(a){return a.data});
if(!f.length){f=["afterUpdate","afterDelete","afterCreate"];h++}a=a[b].call(d,F);typeof a==="function"?a.call(d,h<e.length?r:m,F):h<e.length?r():m()}else{if(!f.length){f=["afterUpdate","afterDelete","afterCreate"];h++}h<e.length?r():m()}};h<e.length?r():m()},forEachEntitySet:function(a,b){for(var c in this._entitySetReferences)a.call(b,this._entitySetReferences[c])},loadItemProperty:function(a,b,c){Guard.requireType("entity",a,$data.Entity);var d=typeof b==="string"?a.getType().memberDefinitions.getMember(b):
b;if(a[d.name]!=void 0){b=new $data.PromiseHandler;callBack=b.createCallback(c);c.success(a[d.name]);return b.getPromise()}var b=true,e=this._storageModel.getStorageModel(a.getType().fullName),h=Container.resolveType(d.dataType);if(h===$data.Array||h.isAssignableTo&&h.isAssignableTo($data.EntitySet)){h=Container.resolveType(d.elementType);b=false}else{var f=e.Associations.filter(function(a){return a.FromPropertyName==d.name})[0];f&&f.FromMultiplicity==="0..1"&&f.ToMultiplicity==="1"&&(b=false)}if(b===
true){var j="function (e) { return",m={};e.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(j=j+" &&");j=j+(" e."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});j=j+"; }";return e.EntitySetReference.map("function (e) { return e."+d.name+" }").single(j,m,c)}j="function (e) { return";m={};e.LogicalType.memberDefinitions.getKeyProperties().forEach(function(b,c){c>0&&(j=j+" &&");j=j+(" e."+d.inverseProperty+"."+b.name+" == this.key"+c);m["key"+c]=a[b.name]});j=j+"; }";return this.getEntitySetFromElementType(h).filter(j,
...
true;return b._runQuery(d)}return b}e=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=e;if(e===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};var c=[];if(a.params)for(var d=0;d<a.params.length;d++){var e=a.params[d],h;for(h in e)c.push({name:h,type:e[h]})}$data.typeSystem.extend(b,a,{params:c});return b},_convertLogicalTypeNameToPhysical:function(a){return a+
...
c,$data.Expressions.ExpressionType.OrderByDescending);return Container.createQueryable(this,c)},first:function(a,b,c){this._checkOperation("first");var d=this;a&&(d=this.filter(a,b));var d=d.take(1),a=new $data.PromiseHandler,c=a.createCallback(c),b=Container.createFirstExpression(d.expression),e=Container.createQueryExpressionCreator(d.entityContext);try{var h=e.Visit(b);d.entityContext.log({event:"EntityExpression",data:h});d.entityContext.executeQuery(Container.createQueryable(d,h),c)}catch(f){c.error(f)}return a.getPromise()},
...
$data.Class.defineEx("$data.EntitySet",[{type:$data.Queryable,params:[new ConstructorParameter(1)]}],null,{constructor:function(a,b,c,d,e){this.createNew=this[a.name]=a;this.stateManager=new $data.EntityStateManager(this);this.elementType=a;this.collectionName=c;this.roles=e;for(var h in d)this[h]=d[h];this._checkRootExpression()},executeQuery:function(a,b){var c=$data.typeSystem.createCallbackSetting(b);this.entityContext.executeQuery(a,c)},getTraceString:function(a){return this.entityContext.getTraceString(a)},
...
$data.FunctionImport.prototype={extend:function(a){for(var b in a)this[b]=a[b];return this},chain:function(a,b){var c=function(){var a=arguments.callee.chainFn,b=[];if(arguments.length)for(var c=0;c<arguments.length;c++)b.push(arguments[c]);var f=b.length,c=0,j=function(){if(b[b.length-1]&&b[b.length-1].success&&typeof b[b.length-1].success==="function")b[b.length-1].success.apply(this,arguments);else return arguments.length?arguments[0]:void 0},m=function(){var r=a[c];c++;r=r.apply(this,b);if(typeof r===
"function"){var p=arguments;b[f]=c<a.length?function(){return m.apply(this,p)}:function(){return j.apply(this,p)};r.apply(this,b)}else c<a.length?m.apply(this,arguments):j(this,arguments)};m()};if(!c.chainFn)c.chainFn=(a||[]).concat([this].concat(b||[]));return c},before:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.unshift(a);return b},after:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.push(a);return b},asResult:function(a,b){return this.extend({resultType:a,resultCfg:b})},
returns:function(a,b){typeof a==="string"&&(a=Container.resolveType(a));typeof b==="string"&&(b=Container.resolveType(b));return this.extend({returnType:a,elementType:b})},params:function(a){return this.extend({params:a})},serviceName:function(a){return this.extend({serviceName:a})},httpMethod:function(a){return this.extend({method:a})},webGet:function(){return this.method("GET")},webInvoke:function(){return this.method("POST")},authorize:function(a,b){var c={};if(a instanceof Array)for(var d=0;d<
a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;this.roles=c;var e=this;return ret=function(){var a=new $data.PromiseHandler,c=a.createCallback(b),a=a.getPromise(),d=arguments;c.success=c.success.after(function(){e.apply(this,d)});$data.Access.isAuthorized($data.Access.Execute,this.user,e.roles,c);return a}},toPromise:function(){return this}};
...
c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}e=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=e;if(e===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)}.toServiceOperation();
...
h||{},m=-1,r=0;r<a.length;r++)if(a[r].data==j){m=r;break}m==-1&&Guard.raise(new Exception("Dependent object not found","ObjectNotFound",e.dependentOn[f]));h[m]=true;from=c[m]||{};from[d]=true;c[m]=from}}h!==null&&(b[d]=h)}}d=[];e=[];for(h=0;h<a.length;h++)b.hasOwnProperty(h)||e.push(h);for(;e.length>0;){h=[].concat(e);e=[];for(f=0;f<h.length;f++){j=c[h[f]];if(typeof j!=="undefined")for(var p in j){delete b[p][h[f]];a:{m=b[p];r=void 0;for(r in m)if(m.hasOwnProperty(r)){m=true;break a}m=false}if(!m){delete b[p];
e.push(p)}}delete c[h[f]]}f=[];for(j=0;j<h.length;j++){m=a[h[j]];m.data.entityState!=$data.EntityState.Unchanged&&f.push(m)}f.length>0&&d.push(f)}return d},getTraceString:function(){Guard.raise("Pure class")},setContext:function(a){this.context=a},supportedFieldOperations:{value:{length:{dataType:"number",allowedIn:"filter, map"},substr:{dataType:"string",allowedIn:"filter",parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}]},toLowerCase:{dataType:"string"}},enumerable:!0,
...
this._includes.forEach(function(c){for(var d=c.name.split("."),e=null,h=b,f=0;f<d.length;f++){a.modelBinderConfig.$item&&a.selectModelBinderProperty("$item");a.selectModelBinderProperty(d[f]);e=h.Associations[d[f]];h=this._query.context._storageModel.getStorageModel(e.ToType)}a.modelBinderConfig.$selector=this._isoDataProvider?["json:"+d[d.length-1]+".results","json:"+d[d.length-1]]:"json:"+d[d.length-1];if(e.ToMultiplicity==="*"){a.modelBinderConfig.$type=$data.Array;a.selectModelBinderProperty("$item");
...
c(a)};$data.ajax(a)}},__encodeBase64:function(a){input=a;var a="",b,c,d="",e,h,f="",j=0;do{b=input.charCodeAt(j++);c=input.charCodeAt(j++);d=input.charCodeAt(j++);e=b>>2;b=(b&3)<<4|c>>4;h=(c&15)<<2|d>>6;f=d&63;isNaN(c)?h=f=64:isNaN(d)&&(f=64);a=a+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)}while(j<
input.length);return a}},null);
$data.Class.define("$data.oDataParser.RequestExpressionBuilder",null,null,{buildConstant:function(a,b){return new $data.Expressions.ConstantExpression(a,b)},buildProperty:function(a,b){return new $data.Expressions.PropertyExpression(a,b)},buildParameter:function(a,b,c){expr=new $data.Expressions.ParameterExpression(a,b,c);expr.paramIndex=0;return expr},buildSimpleBinary:function(a,b,c,d){var e,h;switch(c){case "or":d="boolean";e="or";h="||";break;case "and":d="boolean";e="and";h="&&";break;case "eq":d=
"boolean";e="equal";h="==";break;case "ne":d="boolean";e="notEqual";h="!=";break;case "lt":d="boolean";e="lessThan";h="<";break;case "gt":d="boolean";e="greaterThan";h=">";break;case "le":d="boolean";e="lessThenOrEqual";h="<=";break;case "ge":d="boolean";e="greaterThanOrEqual";h=">=";break;case "add":d="number";e="add";h="+";break;case "sub":d="number";e="subtract";h="-";break;case "mul":d="number";e="multiply";h="*";break;case "div":d="number";e="divide";h="/";break;case "mod":d="number";e="modulo";
h="%";break;default:Guard.raise(new Exception("Not implemented operator in $data.oDataParser.RequestExpressionBuilder.buildConstant: "+c))}return new $data.Expressions.SimpleBinaryExpression(a,b,e,h,d)},buildGlobalCall:function(a,b,c){var d;switch(b){case "substringof":d="contains";break;case "startswith":d="startsWith";break;case "endswith":d="endsWith";break;case "length":d="length";break;case "indexof":d="indexOf";break;case "replace":d="replace";break;case "substring":d="substr";break;case "tolower":d=
"toLowerCase";break;case "toupper":d="toUpperCase";break;case "trim":d="trim";break;case "concat":d="concat";break;case "day":d="day";break;case "hour":d="hour";break;case "minute":d="minute";break;case "month":d="month";break;case "second":d="second";break;case "year":d="year";break;case "round":d="round";break;case "floor":d="floor";break;case "ceiling":d="ceiling";break;default:Guard.raise(new Exception("Not implemented globalCall name in $data.oDataParser.RequestExpressionBuilder.buildGlobalCall: "+
b))}for(a=0;a<c.length;a++)if(c[a]instanceof $data.Expressions.PropertyExpression)break;a=c.splice(a,1)[0];d=this.buildConstant(d,"string");return new $data.Expressions.CallExpression(a,d,c)},buildMemberPath:function(a){for(var b=this.buildParameter("it","unknown",$data.Expressions.ExpressionType.LambdaParameterReference),c=0;c<a.length;c++)b=this.buildProperty(b,this.buildConstant(a[c],"string"));return b},buildOrderBy:function(a){for(var b=Array(a.length),c=0;c<a.length;c++)b[c]={expression:a[c].expr,
nodeType:a[c].dir==="asc"?$data.Expressions.ExpressionType.OrderBy:$data.Expressions.ExpressionType.OrderByDescending};return b},buildUnary:function(a,b,c){var d,e;switch(b){case "not":c="boolean";e="not";d="!";break;case "minus":c="number";e="minus";d="-";break;case "plus":c="number";e="plus";d="+";break;default:Guard.raise(new Exception("Not implemented operator in $data.oDataParser.RequestExpressionBuilder.buildConstant: "+b))}return new $data.Expressions.UnaryExpression(a,e,d,c)}});
(function(){$data.Class.define("$data.oDataParser.ASCII",null,null,{},{NULL:{value:"\x00"},HTAB:{value:9},LF:{value:10},VTAB:{value:11},CR:{value:13},SPC:{value:32},DOLLAR:{value:36},AMP:{value:38},APOS:{value:39},LPAREN:{value:40},RPAREN:{value:41},PLUS:{value:43},COMMA:{value:44},MINUS:{value:45},DOT:{value:46},SLASH:{value:47},ZERO:{value:48},NINE:{value:57},COLON:{value:58},A:{value:65},Z:{value:90},UNDERSCORE:{value:95},a:{value:97},z:{value:122}});$data.Class.define("$data.oDataParser.CharType",
null,null,{},{EOF:{value:0},WSP:{value:1},CTRLCHAR:{value:2},CHAR:{value:3},DIGIT:{value:4},ALPHA:{value:5}});$data.Class.define("$data.oDataParser.TokenType",null,null,{},{EOF:{value:0},WSP:{value:1},CTRLCHAR:{value:2},CHAR:{value:3},DIGITS:{value:4},WORD:{value:5},STRING:{value:6}});var a=$data.oDataParser.ASCII,b=$data.oDataParser.CharType,c=$data.oDataParser.TokenType;$data.Class.define("$data.oDataParser.RequestToken",null,null,{constructor:function(){this.tokenType=c.EOF;this.value="";this.column=
this.line=-1},toString:function(){return this.tokenType==c.DIGITS||this.tokenType==c.WORD||this.tokenType==c.STRING?this.value:this.tokenType==c.CTRLCHAR||this.tokenType==c.CHAR||this.tokenType==c.WSP?String.fromCharCode(this.value):"[EOF]"}});$data.Class.define("$data.oDataParser.RequestLexer",null,null,{constructor:function(c){this.src=c;this.srcLength=c.length;this.srcIndex=0;this.token=null;this.currentChar=a.NULL;this.currentCharType=b.EOF;this.line=0;this.column=-1;this.nextChar();this.nextToken()},
nextChar:function(){if(this.srcIndex>=this.srcLength){this.currentChar="\x00";this.currentCharType=b.EOF;this.column++;return false}if(this.currentChar==a.CR){this.line++;this.column=-1}this.currentChar=this.src.charCodeAt(this.srcIndex++);this.column++;this.currentCharType=this.getCharType(this.currentChar);return true},getCharType:function(c){return c==a.NULL?b.EOF:c==a.HTAB?b.WSP:c<a.SPC?b.CTRLCHAR:c==a.SPC?b.WSP:c<a.ZERO?b.CHAR:c<=a.NINE?b.DIGIT:c<a.A?b.CHAR:c<=a.Z?b.ALPHA:c<a.a?b.CHAR:c<=a.z?
b.ALPHA:c},nextToken:function(){this.skipWhiteSpaces();var d=new $data.oDataParser.RequestToken;this.token=d;d.line=this.line;d.column=this.column;switch(this.currentCharType){case b.EOF:d.tokenType=c.EOF;d.value=this.currentChar;break;case b.WSP:d.tokenType=c.WSP;d.value=this.currentChar;this.nextChar();break;case b.CTRLCHAR:d.tokenType=c.CTRLCHAR;d.value=this.currentChar;this.nextChar();break;case b.CHAR:var e=this.srcIndex;if(this.currentChar==a.APOS&&this.readTo("'")){d.tokenType=c.STRING;var h=
this.srcIndex-e-1;d.value=this.src.substr(e,this.srcIndex-e-1);this.column=this.column+(h+1)}else{d.tokenType=c.CHAR;d.value=this.currentChar}this.nextChar();break;case b.DIGIT:this.scanDigits(d);break;case b.ALPHA:this.scanWord(d);break;default:throw"Unknown CharType: "+this.currentCharType;}},readTo:function(a){if(this.srcIndex==this.srcLength-1)return false;a=this.src.indexOf(a,this.srcIndex+1);if(a<0)return false;this.srcIndex=a+1;return true},skipWhiteSpaces:function(){for(;this.currentCharType==
b.WSP&&this.nextChar(););},scanDigits:function(a){var e=this.srcIndex-1,h=0;for(a.tokenType=c.DIGITS;this.currentCharType==b.DIGIT;){this.nextChar();h++}a.value=this.src.substr(e,h)},scanWord:function(a){for(var e=this.srcIndex-1,h=0;this.currentCharType==b.ALPHA;){this.nextChar();h++}a.tokenType=c.WORD;a.value=this.src.substr(e,h)}})})();
(function(){var a=$data.oDataParser.ASCII,b=$data.oDataParser.CharType,c=$data.oDataParser.TokenType;$data.Class.define("$data.oDataParser.QueryRequest",$data.Base,null,{constructor:function(){this.expand=this.select=this.top=this.skip=this.orderby=this.filter=""},filter:{type:"string"},orderby:{type:"string"},skip:{type:"string"},top:{type:"string"},select:{type:"string"},expand:{type:"string"},format:{type:"string"},inlinecount:{type:"string"}});$data.Class.define("$data.oDataParser.RequestParser",
null,null,{constructor:function(){this.lexer=this.req=null;this.builder=new $data.oDataParser.RequestExpressionBuilder},parse:function(a){this.req=a;a.filter.length>0&&this.parseFilterExpr();a.orderby.length>0&&this.parseOrderByExpr();a.skip.length>0&&this.parseSkipExpr();a.top.length>0&&this.parseTopExpr();a.select.length>0&&this.parseSelectExpr();a.expand.length>0&&this.parseExpandExpr()},parseFilterExpr:function(){this.lexer=new $data.oDataParser.RequestLexer(this.req.filter);var a=this.parseExpr(),
b=this.lexer.token;b&&b.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(b.tokenType)+" in $filter: '"+b.value+"'.","parseFilterExpr");this.req.filter=a},parseOrderByExpr:function(){this.lexer=new $data.oDataParser.RequestLexer(this.req.orderby);var a=this.parseOrderBy(),b=this.lexer.token;b&&b.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(b.tokenType)+" in $orderby: '"+b.value+"'.","parseOrderByExpr");
this.req.orderby=a},parseSkipExpr:function(){this.lexer=new $data.oDataParser.RequestLexer(this.req.skip);var a=this.lexer.token;this.lexer.token.tokenType!=c.DIGITS&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Invalid expression in $skip: '"+a.value+"'.","parseSkipExpr");var b=this.parseNumberLiteral();(a=this.lexer.token)&&a.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(a.tokenType)+" in $skip: '"+a.value+"'.","parseSkipExpr");this.req.skip=
b},parseTopExpr:function(){this.lexer=new $data.oDataParser.RequestLexer(this.req.top);var a=this.lexer.token;this.lexer.token.tokenType!=c.DIGITS&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Invalid expression in $top: '"+a.value+"'.","parseTopExpr");var b=this.parseNumberLiteral();(a=this.lexer.token)&&a.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(a.tokenType)+" in $top: '"+a.value+"'.","parseTopExpr");this.req.top=b},parseSelectExpr:function(){this.lexer=
new $data.oDataParser.RequestLexer(this.req.select);var b=[],e=this.parseExpr();b.push(e);for(e=this.lexer.token;e&&e.value==a.COMMA;){this.lexer.nextToken();e=this.parseExpr();b.push(e);e=this.lexer.token}e.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(e.tokenType)+" in $filter: '"+e.value+"'.","parseSelectExpr");this.req.select=b},parseExpandExpr:function(){this.lexer=new $data.oDataParser.RequestLexer(this.req.expand);this.req.expand=this.parseExpand();
var a=this.lexer.token;a.tokenType!=c.EOF&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Unexpected "+this.tokenName(a.tokenType)+" in $filter: '"+a.value+"'.","parseExpandExpr")},tokenName:function(a){var b,h;for(h in c)if(c[b=h]==a)break;return b},functionNames:{value:["substringof","endswith","startswith","length","indexof","replace","substring","tolower","toupper","trim","concat","day","hour","minute","month","second","year","round","floor","ceiling","IsOf"]},functionTypes:{value:["boolean",
"boolean","boolean","int","int","string","string","string","string","string","string","int","int","int","int","int","int","number","number","number","boolean"]},parseExpr:function(){return this.parseOrExpr()},parseOrExpr:function(){var a=this.parseAndExpr();if(this.lexer.token.value=="or"){this.lexer.nextToken();var b=this.parseOrExpr();b||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","parseOrExpr");a=this.builder.buildSimpleBinary(a,b,"or","or")}return a},parseAndExpr:function(){var a=
this.parseEqualityExpr();if(this.lexer.token.value=="and"){this.lexer.nextToken();var b=this.parseAndExpr();b||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","parseAndExpr");a=this.builder.buildSimpleBinary(a,b,"and","and")}return a},parseEqualityExpr:function(){var a=this.parseRelationalExpr(),b=this.lexer.token;if(b.value=="eq"||b.value=="ne"){this.lexer.nextToken();var c=this.parseEqualityExpr();c||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.",
"parseEqualityExpr");a=this.builder.buildSimpleBinary(a,c,b.value,b.value)}return a},parseRelationalExpr:function(){var a=this.parseAdditiveExpr(),b=this.lexer.token;if(b.value=="lt"||b.value=="gt"||b.value=="le"||b.value=="ge"){this.lexer.nextToken();var c=this.parseRelationalExpr();c||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","RelationalExpr");a=this.builder.buildSimpleBinary(a,c,b.value,b.value)}return a},parseAdditiveExpr:function(){var a=this.parseMultiplicativeExpr(),
b=this.lexer.token;if(b.value=="add"||b.value=="sub"){this.lexer.nextToken();var c=this.parseAdditiveExpr();c||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","AdditiveExpr");a=this.builder.buildSimpleBinary(a,c,b.value,b.value)}return a},parseMultiplicativeExpr:function(){var a=this.parseUnaryExpr(),b=this.lexer.token;if(b.value=="mul"||b.value=="div"||b.value=="mod"){this.lexer.nextToken();var c=this.parseMultiplicativeExpr();c||$data.oDataParser.RequestParser.SyntaxError.call(this,
"Expected: Expr.","MultiplicativeExpr");a=this.builder.buildSimpleBinary(a,c,b.value,b.value)}return a},parseUnaryExpr:function(){var b=this.parsePrimaryExpr();if(b)return b;b=this.lexer.token;if(b.value==a.MINUS){this.lexer.nextToken();(b=this.parseUnaryExpr())||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","parseUnaryExpr");return this.builder.buildUnary(b,"minus")}if(b.value==a.PLUS){this.lexer.nextToken();(b=this.parseUnaryExpr())||$data.oDataParser.RequestParser.SyntaxError.call(this,
"Expected: Expr.","parseUnaryExpr");return this.builder.buildUnary(b,"plus")}if(b.value=="not"){this.lexer.nextToken();(b=this.parseUnaryExpr())||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: Expr.","parseUnaryExpr");return this.builder.buildUnary(b,"not")}},parsePrimaryExpr:function(){var a;return(a=this.parseParenExpr())||(a=this.parseLiteralExpr())||(a=this.parseFunctionCall())||(a=this.parseMemberPath())?a:null},parseParenExpr:function(){if(this.lexer.token.value!=a.LPAREN)return null;
this.lexer.nextToken();var b=this.parseExpr();this.lexer.token.value!=a.RPAREN&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected ')'.","parseParenExpr");this.lexer.nextToken();return b},parseLiteralExpr:function(){var a;return(a=this.parseDatetimeLiteral())||(a=this.parseStringLiteral())||(a=this.parseBoolLiteral())||(a=this.parseNumberLiteral())?a:null},parseDatetimeLiteral:function(){if(this.lexer.token.value!="datetime")return null;this.lexer.nextToken();var a=this.lexer.token;a.tokenType!=
c.STRING&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Invalid date format.","parseDatetimeLiteral");var b;try{b=new Date(a.value)}catch(h){$data.oDataParser.RequestParser.SyntaxError.call(this,"Invalid date format.","parseDatetimeLiteral")}this.lexer.nextToken();return this.builder.buildConstant(b,"datetime")},parseStringLiteral:function(){if(this.lexer.token.tokenType!=c.STRING)return null;var a=this.lexer.token.value;this.lexer.nextToken();return this.builder.buildConstant(a,"string")},
parseBoolLiteral:function(){var a=this.lexer.token.value;if(a=="true"){this.lexer.nextToken();return this.builder.buildConstant(true,"boolean")}if(a=="false"){this.lexer.nextToken();return this.builder.buildConstant(false,"boolean")}return null},parseNumberLiteral:function(){var b,e,h;e=this.lexer.token;if(e.tokenType!=c.DIGITS)return null;h=""+e.value;var f=true;this.lexer.nextToken();e=this.lexer.token;if(e.value=="L"){this.lexer.nextToken();return this.builder.buildConstant(parseInt(h),"number")}if(e.value==
a.DOT){f=false;this.lexer.nextToken();e=this.lexer.token;e.tokenType!=c.DIGITS&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected DIGITS (after '.').","parseDoubleStrict");b=e.value;h=h+("."+b);this.lexer.nextToken();e=this.lexer.token}if(e.value=="f"){this.lexer.nextToken();return this.builder.buildConstant(parseFloat(h),"number")}if(e.value=="e"){f=false;this.lexer.nextToken();b=this.parseSign();e=this.lexer.token;e.tokenType!=c.DIGITS&&$data.oDataParser.RequestParser.SyntaxError.call(this,
"Expected DIGITS (after Sign).","parseDoubleStrict");e=e.value;h=h+("e"+(b?String.fromCharCode(b):"")+e);this.lexer.nextToken();e=this.lexer.token}(e.value=="m"||e.value=="M")&&this.lexer.nextToken();return this.builder.buildConstant(f?parseInt(h):parseFloat(h),"number")},parseSign:function(){var b=this.lexer.token;if(b.value!=a.PLUS&&b.value!=a.MINUS)return null;this.lexer.nextToken();return b.value},parseFunctionCall:function(){var b=this.parseFunctionName();if(b==null)return null;var c=this.lexer.token;
c.value!=a.LPAREN&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected '('.","parseFunctionCall");this.lexer.nextToken();var c=this.lexer.token,h;if(c.value!=a.RPAREN){h=this.parseArguments();c=this.lexer.token}c.value!=a.RPAREN&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected ')'.","parseFunctionCall");this.lexer.nextToken();return this.builder.buildGlobalCall(b.type,b.name,h)},parseFunctionName:function(){var a=this.lexer.token;if(a.tokenType==c.WORD){for(var a=a.value,
b=0;b<this.functionNames.length;b++)if(this.functionNames[b]==a){this.lexer.nextToken();return{name:a,type:this.functionTypes[b]}}return null}},parseArguments:function(){for(var b=[];;){var c=this.parseArgument();c||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: expression","parseArguments");b.push(c);if(this.lexer.token.value!=a.COMMA)break;this.lexer.nextToken()}return b},parseArgument:function(){return this.parseExpr()},parseMemberPath:function(){if(this.lexer.token.value=="not")return null;
var b=this.parseName(),c=this.lexer.token;if(!b)return null;for(var h=b,f=false;c.value==a.DOT;){h=h+".";f=true;this.lexer.nextToken();b=this.parseName();c=this.lexer.token;b||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: name after dot ('.').","parseMemberPath");h=h+b}var j=[];j.push(h);for(var m=false;c.value==a.SLASH;){h=h+"/";m=true;this.lexer.nextToken();b=this.parseName();c=this.lexer.token;b||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: name.","parseMemberPath");
h=h+b;j.push(b)}f&&!m&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: / after namespace.","parseMemberPath");if(this.lexer.token.value!=a.LPAREN)return this.builder.buildMemberPath(j);this.lexer.nextToken();this.lexer.token.value!=a.RPAREN&&$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: right parenthesis: ')'.","parseMemberPath");this.lexer.nextToken();return this.builder.buildMemberPath(j)},parseName:function(){var b=this.lexer.token;if(b.tokenType!=c.WORD&&b.value!=
a.UNDERSCORE)return null;b=b.toString()+this.getNextNamePart();this.lexer.nextToken();return b},getNextNamePart:function(){for(var c="",e=this.lexer.currentChar,h=this.lexer.currentCharType;h==b.DIGIT||h==b.ALPHA||e==a.UNDERSCORE;){c=c+String.fromCharCode(e);this.lexer.nextChar();e=this.lexer.currentChar;h=this.lexer.currentCharType}return c},parseOrderBy:function(){var b=this.parseExpr();if(!b)return null;var c=[],h="asc",f=this.lexer.token;if(f.value=="asc"||f.value=="desc"){h=f.value;this.lexer.nextToken();
f=this.lexer.token}for(c.push({expr:b,dir:h});f.value==a.COMMA;){this.lexer.nextToken();(b=this.parseExpr())||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: expr","parseOrderBy");h="asc";f=this.lexer.token;if(f.value=="asc"||f.value=="desc"){h=f.value;this.lexer.nextToken();f=this.lexer.token}c.push({expr:b,dir:h})}return this.builder.buildOrderBy(c)},parseExpand:function(){var b=this.parseMemberPath();if(!b)return null;var c=[],h=this.lexer.token;for(c.push(b);h.value==a.COMMA;){this.lexer.nextToken();
(b=this.parseMemberPath())||$data.oDataParser.RequestParser.SyntaxError.call(this,"Expected: expr","parseExpand");c.push(b);h=this.lexer.token}return c}},{SyntaxError:function(a,b){var c=this.lexer.src,f=this.lexer.token,c=" Source:"+c.substr(0,f.column)+">>>>"+c.substr(f.column,1)+"<<<<"+c.substr(f.column+1),c="Syntax error at line "+f.line+", char "+f.column+". "+a+c;b&&(c=c+(". Caller: "+b));throw{message:c,reason:a,source:b,line:f.line,column:f.column};}})})();
$data.Class.define("$data.oDataParser.EntityExpressionBuilder",null,null,{constructor:function(a,b){Guard.requireValue("scopeContext",a);this.scopeContext=a;this.entitySetName=b;this.lambdaTypes=[]},supportedParameters:{value:[{name:"expand",expType:$data.Expressions.IncludeExpression},{name:"filter",expType:$data.Expressions.FilterExpression},{name:"orderby",expType:$data.Expressions.OrderExpression},{name:"skip",expType:$data.Expressions.PagingExpression},{name:"top",expType:$data.Expressions.PagingExpression},
{name:"select",expType:$data.Expressions.ProjectionExpression},{name:"count",expType:$data.Expressions.CountExpression}]},parse:function(a){var b=new $data.oDataParser.QueryRequest,b=$data.typeSystem.extend(b,a);(new $data.oDataParser.RequestParser).parse(b);return{expression:this.buildExpression(b)}},buildExpression:function(a){var b=this.createRootExpression(this.entitySetName);this.lambdaTypes.push(b);for(var c=0;c<this.supportedParameters.length;c++){var d=this.supportedParameters[c].name,e=d+
"Converter";typeof this[e]==="function"&&a[d]&&(b=this[e].call(this,a[d],b))}return b=a.count===true?new $data.Expressions.CountExpression(b):new $data.Expressions.ToArrayExpression(b)},createRootExpression:function(a){var b=Container.createEntityContextExpression(this.scopeContext),c=this.scopeContext.getType().getMemberDefinition(a);return Container.createEntitySetExpression(b,Container.createMemberInfoExpression(c),null,this.scopeContext[a])},filterConverter:function(a,b){var c=new $data.Expressions.CodeToEntityConverter(this.scopeContext),
d=c.Visit(a,{queryParameters:void 0,lambdaParameters:this.lambdaTypes,frameType:$data.Expressions.FilterExpression}),c=Container.createParametricQueryExpression(d,c.parameters);return new $data.Expressions.FilterExpression(b,c)},orderbyConverter:function(a,b){for(var c=new $data.Expressions.CodeToEntityConverter(this.scopeContext),d=0;d<a.length;d++)var e=a[d],h=c.Visit(e.expression,{queryParameters:void 0,lambdaParameters:this.lambdaTypes,frameType:$data.Expressions.OrderExpression}),h=Container.createParametricQueryExpression(h,
c.parameters),b=new $data.Expressions.OrderExpression(b,h,$data.Expressions.ExpressionType[e.nodeType]);return b},selectConverter:function(a,b){for(var c=new $data.Expressions.CodeToEntityConverter(this.scopeContext),d=[],e=0;e<a.length;e++){var h=a[e],h=new $data.Expressions.ObjectFieldExpression(this.findMemberPathBaseName(h),h);d.push(h)}d=new $data.Expressions.ObjectLiteralExpression(d);d=c.Visit(d,{queryParameters:void 0,lambdaParameters:this.lambdaTypes,frameType:$data.Expressions.ProjectionExpression});
c=Container.createParametricQueryExpression(d,c.parameters);return new $data.Expressions.ProjectionExpression(b,c)},findMemberPathBaseName:function(a){return a.expression instanceof $data.Expressions.PropertyExpression?this.findMemberPathBaseName(a.expression):a.member.value},skipConverter:function(a,b){return new $data.Expressions.PagingExpression(b,a,$data.Expressions.ExpressionType.Skip)},topConverter:function(a,b){return new $data.Expressions.PagingExpression(b,a,$data.Expressions.ExpressionType.Take)},
expandConverter:function(a,b){if(a.length>0)for(var c=0;c<a.length;c++)b=new $data.Expressions.IncludeExpression(b,new $data.Expressions.ConstantExpression(this._getMemberPath(a[c]),"string"));return b},_getMemberPath:function(a){return a.expression instanceof $data.Expressions.PropertyExpression?this._getMemberPath(a.expression)+"."+a.member.value:a.member.value}});
$data.Class.define("$data.oDataParser.ODataEntityExpressionBuilder",$data.oDataParser.EntityExpressionBuilder,null,{parse:function(a){var b=new $data.oDataParser.QueryRequest,b=$data.typeSystem.extend(b,a);(new $data.oDataParser.RequestParser).parse(b);this.selectedFields=[];this.includes=[];return{expression:this.buildExpression(b),selectedFields:this.selectedFields,includes:this.includes}},selectConverter:function(a,b){for(var c=this.scopeContext[this.entitySetName].elementType,d=0;d<a.length;d++)this.selectedFields.push(this._getMemberPath(a[d]));
for(var e=new $data.oDataParser.RequestExpressionBuilder,c=c.memberDefinitions.getKeyProperties(),d=0;d<c.length;d++)this.selectedFields.indexOf(c[d].name)<0&&a.push(e.buildMemberPath([c[d].name]));return $data.oDataParser.EntityExpressionBuilder.prototype.selectConverter.apply(this,[a,b])},expandConverter:function(a,b){for(var c=0;c<a.length;c++)this.includes.push(this._getMemberPath(a[c]));return $data.oDataParser.EntityExpressionBuilder.prototype.expandConverter.apply(this,arguments)}});
