...
app.use('/', function (req, res) {
    ...
    if (req.url === "/favicon.ico") {
        ...
        if (req.method === 'GET') {
            ...
            var databsename = req._parsedUrl.pathname.substring(1);
            databsename = databsename || 'jayScrum';
console.log(databsename);
            $test.context = new LightSwitchApplication.ApplicationData({ name:'mongoDB', databaseName:databsename });
