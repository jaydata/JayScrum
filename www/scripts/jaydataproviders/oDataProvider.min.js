...
new Date(parseInt(b.substr(6))):void 0},"$data.String":function(b){return b},"$data.Boolean":function(b){return b},"$data.Blob":function(b){return b},"$data.Object":function(b){return void 0===b?new $data.Object:"string"===typeof b?JSON.parse(b):b},"$data.Array":function(b){return void 0===b?new $data.Array:b instanceof $data.Array?b:JSON.parse(b)}},toDb:{"$data.Entity":function(b){return"'"+JSON.stringify(b.initData)+"'"},"$data.Integer":function(b){return b},"$data.Number":function(b){return 0==
b%1?b:b+"m"},"$data.Date":function(b){return b?"datetime'"+b.toISOString()+"'":null},"$data.String":function(b){return"'"+b.replace(/'/g,"''")+"'"},"$data.Boolean":function(b){return b?"true":"false"},"$data.Blob":function(b){return b},"$data.Object":function(b){return JSON.stringify(b)},"$data.Array":function(b){return JSON.stringify(b)}}}},getEntityKeysValue:function(b){for(var a=[],c=void 0,e=b.entitySet.createNew.memberDefinitions.asArray(),d=0,g=e.length;d<g;d++){var f=e[d];if(f.key){c=b.data[f.name];
switch(f.dataType){case "Edm.Guid":c="guid'"+c+"'";break;case "Edm.Binary":c="binary'"+c+"'";break;case "Edm.Byte":c="0123456789ABCDEF"[d>>4&15]+"0123456789ABCDEF"[d&15];break;case "Edm.DateTime":c="datetime'"+c.toISOString()+"'";break;case "Edm.Decimal":c+="M";break;case "Edm.Single":c+="f";break;case "Edm.Int64":c+="L";break;case "Edm.String":case "string":c="'"+c+"'"}a.push(f.name+"="+c)}}return 1<a.length?a.join(","):c}},null);$data.StorageProviderBase.registerProvider("oData",$data.storageProviders.oData.oDataProvider);
...
a)},VisitServiceOperationExpression:function(b,a){a.urlText+="/"+b.cfg.serviceName;if(b.params)for(var c=0;c<b.params.length;c++)this.Visit(b.params[c],a)},VisitConstantExpression:function(b,a){a.$urlParams=a.$urlParams?a.$urlParams+"&":"";var c;b.value instanceof $data.Entity?c=this.provider.fieldConverter.toDb["$data.Entity"](b.value):(c=Container.getTypeName(b.value),c=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(c))](b.value));a.$urlParams+=b.name+"="+c},VisitCountExpression:function(b,
a){this.Visit(b.source,a);a.urlText+="/$count"}},{});
