...
JAYLINT=function(){function a(){return this}function b(){}function c(a){return Eb[a]||"\\u"+("0000"+a.charCodeAt().toString(16)).slice(-4)}function d(a){Object.keys(a).forEach(function(b){P[b]=a[b]})}function e(){if(!l.safe){if(l.rhino){d(Fb);l.rhino=false}if(l.devel){d(Gb);l.devel=false}if(l.browser){d(Hb);l.browser=false}if(l.windows){d(Ib);l.windows=false}if(l.node){d(Jb);l.node=false;Ka=true}if(l.widget){d(Kb);l.widget=false}}}function h(a,b,c){throw{name:"JSLintError",line:b,character:c,message:H.scanned_a_b.supplant({a:a,
b:Math.floor(b/ya.length*100)})};}function f(a,b,c,d,f,e){var j,k,b=b||g;k=b.line||0;j=b.from||0;a={id:"(error)",raw:H[a]||a,evidence:ya[k-1]||"",line:k,character:j,a:c||b.value,b:d,c:f,d:e};a.reason=a.raw.supplant(a);JAYLINT.errors.push(a);l.passfail&&h(H.stopping,k,j);La=La+1;La>=l.maxerr&&h(H.too_many,k,j);return a}function j(a,b,c,d,e,j,g){return f(a,{line:b,from:c},d,e,j,g)}function k(a,b,c,d,e,j){a=f(a,b,c,d,e,j);h(H.stopping,a.line,a.character)}function s(a,b,c,d,f,e,j){return k(a,{line:b,
from:c},d,f,e,j)}function o(a){!l.white&&g.from!==a&&f("expected_a_at_b_c",g,g.value,a,g.from)}function A(a,b,c){if(a[b]!==c){f("expected_a_b",a,c,a[b]);return true}return false}function F(a,b,c){c=c||a.value;if(p===Y){l.safe&&f("adsafe_a",a,c);if(typeof Y[c]!=="string"){a.writeable=typeof P[c]==="boolean"?P[c]:true;a.funct=p;za[c]=a}b==="becoming"&&(b="var")}else if(typeof p[c]==="string")if(p[c]==="undef"){l.undef||f("used_before_a",a,c);b="var"}else f("already_defined",a,c);else{a.funct=p;a.writeable=
true;E[c]=a}p[c]=b}function q(a){for(var b,c=0,a=a||0;c<=a;){(b=Aa[c])||(b=Aa[c]=Ba.token());c=c+1}return b}function m(a){a=a||n;if(a.comments){for(var b=a.prev;b.comments===null;)b=b.prev;b.comments=b.comments?b.comments.concat(a.comments):a.comments}a.comments=null}function i(a,b){if(x){if(ga&&g.line!==n.line){if((ga!==x||!g.edge)&&g.from===x.at-(g.edge?l.indent:0)){for(var c=x;;){c.at=c.at-l.indent;if(c===ga)break;c=c.was}c.open=false}ga=null}if(x.open)if(g.edge)g.edge==="label"?o(1):g.edge===
"case"?o(x.at-l.indent):(x.mode!=="array"||g.line!==n.line)&&o(x.at);else{if(g.line!==n.line){g.from<x.at+(x.mode==="expression"?0:l.indent)&&o(x.at+l.indent);x.wrap=true}}else if(g.line!==n.line)if(g.edge)o(x.at);else{x.wrap=true;x.mode==="statement"||x.mode==="var"?o(x.at+l.indent):g.from<x.at+(x.mode==="expression"?0:l.indent)&&o(x.at+l.indent)}}switch(n.id){case "(number)":g.id==="."&&f("trailing_decimal_a");break;case "-":(g.id==="-"||g.id==="--")&&f("confusing_a");break;case "+":(g.id==="+"||
g.id==="++")&&f("confusing_a")}if(n.id==="(string)"||n.identifier)$a=n.value;a&&g.id!==a&&(b?f("expected_a_b_from_c_d",g,a,b.id,b.line,g.value):(!g.identifier||g.value!==a)&&f("expected_a_b",g,a,g.value));U=n;n=g;g=Aa.shift()||Ba.token();n.id==="(end)"&&m()}function V(){if(l.adsafe)l.safe=true;if(l.safe){l.browser=l["continue"]=l.css=l.debug=l.devel=l.evil=l.forin=l.newcap=l.nomen=l.on=l.rhino=l.sloppy=l.sub=l.undef=l.widget=l.windows=false;delete P.Array;delete P.Date;delete P.Function;delete P.Object;
...
g.value;i();g.id!==":"&&k("expected_a_b",g,":",g.value);i(":");switch(a){case "indent":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&k("expected_small_a");l.indent=a;break;case "maxerr":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<=0||Math.floor(a)!==a)&&k("expected_small_a",g);l.maxerr=a;break;case "maxlen":a=+g.value;(typeof a!=="number"||!isFinite(a)||a<0||Math.floor(a)!==a)&&k("expected_small_a");l.maxlen=a;break;default:g.id==="true"?l[a]=true:g.id==="false"?l[a]=
false:k("unexpected_a");if(a==="adsafe"){l.adsafe=l.safe=true;V()}else a==="safe"&&V()}i();g.id===","&&i(",")}e();break;case "/*globals":case "/*global":l.safe&&f("adsafe_a",this);a:for(var c;;){if(g.id!=="(string)"&&!g.identifier)break a;a=g.value;i();c=false;if(g.id===":"){i(":");switch(g.id){case "true":c=P[a]!==false;i("true");break;case "false":i("false");break;default:k("unexpected_a")}}P[a]=c;if(g.id!==",")break a;i(",")}break;default:k("unpexpected_a",this)}Ca=b;i("*/")}function y(a){g.edge=
!x||x.open&&(a||true)}function G(a){var b,c;if(typeof a==="number")x={at:a,open:true,was:c};else if(x){c=x;b=a==="var"||g.line!==n.line&&a!=="statement";x={at:(b||a==="control"?c.at+l.indent:c.at)+(c.wrap?l.indent:0),mode:a,open:b,was:c};a==="var"&&b&&(ga=x)}else x={at:1,mode:"statement",open:true}}function v(a,b){if(a){if(x&&x.open){x.at=x.at-l.indent;y()}i(a,b)}if(x)x=x.was}function z(a,b){b=b||g;b.id!=="(end)"&&!l.white&&(n.line!==b.line||n.thru+1!==b.from)&&f("expected_space_a_b",b,n.value,b.value)}
function Q(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!l.white&&a.thru+1!==b.from)&&f("expected_space_a_b",b,a.value,b.value)}function w(a,b){a=a||n;b=b||g;(!l.white||t==="styleproperty"||t==="style")&&a.thru!==b.from&&a.line===b.line&&f("unexpected_space_a_b",b,a.value,b.value)}function C(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!l.white&&a.thru!==b.from)&&f("unexpected_space_a_b",b,a.value,b.value)}function I(a,b){if(!l.white){a=a||n;b=b||g;a.thru===b.from&&a.line===b.line&&
f("missing_space_a_b",b,a.value,b.value)}}function B(){if(g.id!==",")j("expected_a_b",n.line,n.thru,",",g.value);else{l.white||C();i(",");m();I()}}function W(){if(g.id!==";")j("expected_a_b",n.line,n.thru,";",g.value);else{l.white||C();i(";");m();Lb[g.id]!==true&&I()}}function Ma(){if(g.value==="use strict"){na&&f("unnecessary_use");y();i();W();na=true;l.newcap=false;l.undef=false;return true}return false}function S(a,b){if(a===b)return true;if(Array.isArray(a)){if(Array.isArray(b)&&a.length===b.length){var c;
...
b.second.value&&b.second.id==="(string)";if(a.id==="["&&a.arity==="infix"&&b.id===".")return a.second.value===b.second.value&&a.second.id==="(string)"}return false}function r(a,b){var c;g.id==="(end)"&&k("unexpected_a",n,g.id);i();l.safe&&E[n.value]&&E[n.value]===za[n.value]&&g.id!=="("&&g.id!=="."&&f("adsafe",n);if(b){$a="anonymous";p["(verb)"]=n.value}if(b===true&&n.fud)c=n.fud();else{if(n.nud)c=n.nud();else{if(g.id==="(number)"&&n.id==="."){f("leading_decimal_a",n,g.value);i();return n}k("expected_identifier_a",
n,n.id)}for(;a<g.lbp;){i();n.led?c=n.led(c):k("expected_operator_a",n,n.id)}}return c}function Da(a,b){var c=Z[a];if(!c||typeof c!=="object")Z[a]=c={id:a,lbp:b,value:a};return c}function L(a){return Da(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Da(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;b.value=a;return oa(b)}function R(a,b){var c=L(a);c.identifier=c.reserved=true;c.fud=b;return c}function Na(a,b){R(a,b).labeled=true}function Oa(a,b){R(a,b).disrupt=true}function sb(a){var b=
a.id.charAt(0);if(b>="a"&&b<="z"||b>="A"&&b<="Z")a.identifier=a.reserved=true;return a}function O(a,b,c){var d=Da(a,150);sb(d);d.nud=typeof b==="function"?b:function(){a==="typeof"?z():C();this.first=r(150);this.arity="prefix";if(this.id==="++"||this.id==="--")l.plusplus?(!this.first.identifier||this.first.reserved)&&this.first.id!=="."&&this.first.id!=="["&&f("bad_operand",this):f("unexpected_a",this);this.type=c;return this};return d}function ia(a,b,c){a=L(a);a.arity=a.type=b;if(c)a.nud=c;return a}
function bb(a){return(a=a.identifier&&E[a.value]||a)&&a.type}function K(a,b,c){var d="",e,j,g;if(typeof a!=="string"){j=a.identifier&&E[a.value]||a;a=j.type}g=b.identifier&&E[b.value]||b;e=g.type;if(a)e?a===e?d=a:l.type||f("type_inconsistency_a_b",c||b,a,e):g.type=d=a;else if(e){if(j)j.type=e;d=e}return d}function D(a,b){var c=L(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function ua(b,c,d){b=D(b);b.type=c;b.value=d;b.nud=a;return b}function db(a,b){return D(a,function(){typeof b===
"function"&&b(this);return this})}function M(a,b,c,d,e){a=Da(a,b);sb(a);a.led=function(a){this.arity="infix";if(!e){I(U,n);I()}!l.bitwise&&this.bitwise&&f("unexpected_a",this);if(typeof c==="function")return c(a,this);this.first=a;this.second=r(b);return this};if(d)a.type=d;return a}function ca(a,b){a.assign&&f(b||H.conditional_assignment,a);return a}function da(a,b){switch(a.id){case "[":case "-":a.arity!=="infix"&&f(b||H.weird_condition,a);break;case "false":case "function":case "Infinity":case "NaN":case "null":case "true":case "undefined":case "void":case "(number)":case "(regexp)":case "(string)":case "{":f(b||
H.weird_condition,a);break;case "(":a.first.id==="."&&Mb[a.first.second.value]===true&&f(b||H.weird_condition,a)}return a}function tb(a){switch(a.arity){case "prefix":switch(a.id){case "{":case "[":f("unexpected_a",a);break;case "!":f("confusing_a",a)}break;case "function":case "regexp":f("unexpected_a",a);break;default:a.id==="NaN"&&f("isnan",a)}return a}function ka(a,b){return M(a,100,function(a,c){tb(a);b&&!l.eqeq&&f("expected_a_b",c,b,c.id);var d=r(100);(S(a,d)||(a.id==="(string)"||a.id==="(number)")&&
(d.id==="(string)"||d.id==="(number)"))&&f("weird_relation",c);c.first=a;c.second=tb(d);K(a,c.second,c);return c},"boolean")}function aa(a,b){var c=M(a,20,function(a,b){var c;b.first=a;if(a.identifier)E[a.value]?E[a.value].writeable===false&&f("read_only",a):k("read_only");else if(l.safe){c=a;do{typeof P[c.value]==="boolean"&&f("adsafe",c);c=c.first}while(c)}a===Z["function"]&&f("identifier_function",n);if(a.id==="."||a.id==="["){(!a.first||a.first.value==="arguments")&&f("bad_assignment",b);b.second=
r(19);b.id==="="&&S(b.first,b.second)&&f("weird_assignment",b)}else if(a.identifier&&!a.reserved){p[a.value]==="exception"&&f("assign_exception",a);b.second=r(19);b.id==="="&&S(b.first,b.second)&&f("weird_assignment",b);if(b.type){K(a,b);K(b,b.second,b)}else K(a,b.second,b)}return b});c.assign=true;if(b){if(Z[b].type)c.type=Z[b].type;if(Z[b].bitwise)c.bitwise=true}return c}function va(a,b){var c=M(a,b,"number");c.bitwise=true;return c}function ub(a){a=Da(a,150);a.led=function(a){C(U,n);l.plusplus?
(!a.identifier||a.reserved)&&a.id!=="."&&a.id!=="["&&f("bad_operand",this):f("unexpected_a",this);this.first=a;this.arity="suffix";return this};return a}function pa(){if(g.identifier){i();l.safe&&Pa[n.value]?f("adsafe_a",n):n.reserved&&!l.es5&&f("expected_identifier_a_reserved",n);return n.value}}function eb(){var a,b=E;if(g.id===";"){f("unexpected_a");W()}else{if(g.identifier&&!g.reserved&&q().id===":"){y("label");a=g;i();m();i(":");m();E=Object.create(b);F(a,"label");g.labeled!==true?f("label_a_b",
g,a.value,g.value):fb.test(a.value+":")?f("url",a):p===Y&&k("unexpected_a",n);g.label=a}y();G("statement");if(a=r(0,true))if(a.arity==="statement")a.id==="switch"||a.block&&a.id!=="do"?I():W();else{a.id==="("?a.first.id==="new"&&f("bad_new"):!a.assign&&a.id!=="delete"&&a.id!=="++"&&a.id!=="--"&&f("assignment_function_expression",n);W()}v();E=b;return a}}function qa(){for(var a=[],b,c;g.postscript!==true;)if(g.id===";"){f("unexpected_a",g);W()}else{if(g.value==="use strict"){(!Ka||p!==Y||a.length>
0)&&f("function_strict");Ma()}if(b){f("unreachable_a_b",g,g.value,b.value);b=null}if(c=eb()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ea(a){var b,c=g,d=Ea,e=E,j=na;Ea=a;E=Object.create(E);I();if(g.id==="{"){i("{");G();!a&&!Ma()&&!j&&!l.sloppy&&p["(context)"]===Y&&f("missing_use_strict");b=qa();na=j;v("}",c);m()}else if(a){f("expected_a_b",g,"{",g.value);b=[eb()];b.disrupt=b[0].disrupt}else k("expected_a_b",g,"{",g.value);p["(verb)"]=null;E=e;Ea=d;a&&b.length===0&&f("empty_block");
return b}function Qa(a){ha&&typeof ha[a]!=="boolean"&&f("unexpected_property_a",n,a);ra[a]=typeof ra[a]==="number"?ra[a]+1:1}function gb(){var a=pa(true);if(!a)if(g.id==="(string)"){a=g.value;l.safe&&(Pa[a]?f("adsafe_a"):(a.charAt(0)==="_"||a.charAt(a.length-1)==="_")&&f("dangling_a"));i()}else if(g.id==="(number)"){a=g.value.toString();i()}return a}function J(a){var b=0;if(a)if(Array.isArray(a))a.forEach(function(a){b=b+J(a)});else switch(a.arity){case "statement":switch(a.id){case "if":b=b+(J(a.first)+
...
b+J(a.first);break;case "case":case "infix":b=b+(J(a.first)+J(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(J(a.first)+J(a.second)+J(a.third))}return b}function Ra(a,b){var d=p,f=l,e=ha,j=E;p={"(name)":b||"'"+($a||"").replace(vb,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":E,"(token)":a};ha=e&&Object.create(e);l=Object.create(f);E=Object.create(j);Sa.push(p);(a.name=b)&&F(a,"function",b);a.writeable=false;var h=p,k;a:{var s=g,o=[];i("(");G();
m();w();if(g.id===")"){w();v(")",s);m();k=void 0}else for(;;){y();pa();o.push(n);F(n,l.unparam?"parameter":"unparam");if(g.id===",")B();else{w();v(")",s);m();k=o;break a}}}a.first=h["(params)"]=k;a.type="function";z();a.block=ea(false);p["(complexity)"]=J(a.block)+1;p=d;l=f;ha=e;E=j}function hb(){function a(){var b=g,c={};i("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);B()}g.id!=="(string)"&&f("expected_string_a");c[g.value]===true?f("duplicate_a"):g.value==="__proto__"?
f("dangling_a"):c[g.value]=true;i();i(":");hb();if(g.id!==",")break;B();if(g.id==="}"){f("unexpected_a",n);break}}i("}",b)}function b(){var a=g;i("[");if(g.id!=="]")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);B()}hb();if(g.id!==",")break;B();if(g.id==="]"){f("unexpected_a",n);break}}i("]",a)}switch(g.id){case "{":a();break;case "[":b();break;case "true":case "false":case "null":case "(number)":case "(string)":i();break;case "-":i("-");C();i("(number)");break;default:k("unexpected_a")}}
function ib(){if(g.identifier){i();return true}}function Ta(){if(g.id==="-"){i("-");C()}if(g.id==="(number)"){i("(number)");return true}}function jb(){if(g.id==="(string)"){i();return true}}function ja(){var a,b,c,d;if(g.identifier){d=g.value;if(d==="rgb"||d==="rgba"){i();c=g;i("(");for(a=0;a<3;a=a+1){a&&B();b=g.value;if(g.id!=="(string)"||b<0){f("expected_positive_a",g);i()}else{i();if(g.id==="%"){i("%");b>100&&f("expected_percent_a",n,b)}else b>255&&f("expected_small_a",n,b)}}if(d==="rgba"){B();
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&f("expected_fraction_a",g);i();if(g.id==="%"){f("unexpected_a");i("%")}}i(")",c);return true}if(Nb[g.value]===true){i();return true}}else if(g.id==="(color)"){i();return true}return false}function u(){if(g.id==="-"){i("-");C()}if(g.id==="(number)"){i();if(g.id!=="(string)"&&wb[g.value]===true){C();i()}else+n.value!==0&&f("expected_linear_a");return true}return false}function wa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":i();return true}else return u()}
function Fa(){if(g.identifier){if(g.value==="auto"){i();return true}}else return u()}function sa(){var a,b;if(g.identifier&&g.value==="url"){g=Ba.range("(",")");b=g.value;a=b.charAt(0);if(a==='"'||a==="'")if(b.slice(-1)!==a)f("bad_url");else{b=b.slice(1,-1);b.indexOf(a)>=0&&f("bad_url")}b||f("missing_url");l.safe&&xb.test(b)&&k("adsafe_a",g,b);Ga.push(b);i();return true}return false}function kb(a){var b=0,c,d,f,e=0;switch(typeof a){case "function":return a();case "string":if(g.identifier&&g.value===
a){i();return true}return false}for(;;){if(b>=a.length)return false;f=a[b];b=b+1;if(typeof f==="boolean")break;else if(typeof f==="number"){c=f;f=a[b];b=b+1}else c=1;for(d=false;c>0;)if(kb(f)){d=true;c=c-1}else break;if(d)return true}e=b;for(c=[];;){f=false;for(b=e;b<a.length;b=b+1)if(!c[b]&&kb(Ua[a[b]])){f=d=true;c[b]=true;break}if(!f)return d}}function yb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){f("unexpected_a");W()}for(a=void 0;g.id==="*"||g.id==="#"||
g.value==="_";){l.css||f("unexpected_a");i()}if(g.id==="-"){l.css||f("unexpected_a");i("-");g.identifier||f("expected_nonstandard_style_attribute");i();a=lb}else{if(g.identifier)if(Object.prototype.hasOwnProperty.call(Ua,g.value))a=Ua[g.value];else{a=lb;l.css||f("unrecognized_style_attribute_a")}else f("expected_style_attribute");i()}i(":");if(g.identifier&&g.value==="inherit")i();else if(!kb(a)){f("unexpected_a");i()}if(g.id==="!"){i("!");C();g.identifier&&g.value==="important"?i():f("expected_a_b",
g,"important",g.value)}g.id==="}"||g.id===T?f("expected_a_b",g,";",g.value):W()}}function mb(){if(g.identifier){Object.prototype.hasOwnProperty.call(nb,l.cap?g.value.toLowerCase():g.value)||f("expected_tagname_a");i()}else switch(g.id){case ">":case "+":i();mb();break;case ":":i(":");switch(g.value){case "active":case "after":case "before":case "checked":case "disabled":case "empty":case "enabled":case "first-child":case "first-letter":case "first-line":case "first-of-type":case "focus":case "hover":case "last-child":case "last-of-type":case "link":case "only-of-type":case "root":case "target":case "visited":i();
break;case "lang":i();i("(");g.identifier||f("expected_lang_a");i(")");break;case "nth-child":case "nth-last-child":case "nth-last-of-type":case "nth-of-type":i();i("(");if(g.id==="(number)"){i();if(g.value==="n"&&g.identifier){C();i();if(g.id==="+"){C();i("+");C();i("(number)")}}}else g.identifier&&(g.value==="odd"||g.value==="even")?i():f("unexpected_a");i(")");break;case "not":i();i("(");g.id===":"&&q(0).value==="not"&&f("not");mb();i(")");break;default:f("expected_pseudo_a")}break;case "#":i("#");
g.identifier||f("expected_id_a");i();break;case "*":i("*");break;case ".":i(".");g.identifier||f("expected_class_a");i();break;case "[":i("[");g.identifier||f("expected_attribute_a");i();if(g.id==="="||g.value==="~="||g.value==="$="||g.value==="|="||g.id==="*="||g.id==="^="){i();g.id!=="(string)"&&f("expected_string_a");i()}i("]");break;default:k("expected_selector_a")}}function zb(){for(;g.id!=="</"&&g.id!=="(end)";){a:for(g.id==="{"&&f("expected_style_pattern");;){mb();if(g.id==="</"||g.id==="{"||
g.id==="(end)")break a;g.id===","&&B()}t="styleproperty";if(g.id===";")W();else{i("{");yb();t="style";i("}")}}}function Ab(){for(;g.id==="@";){q();i("@");if(g.identifier)switch(g.value){case "import":i();if(!sa()){f("expected_a_b",g,"url",g.value);i()}W();break;case "media":for(i();;){(!g.identifier||Bb[g.value]===true)&&k("expected_media_a");i();if(g.id!==",")break;B()}i("{");zb();i("}");break;default:f("expected_at_a")}else f("expected_at_a")}zb()}var X,Ha,Ia,la,$a,Va,Ob={"<":true,"<=":true,"==":true,
...
buttonshadow:true,buttontext:true,captiontext:true,graytext:true,highlight:true,highlighttext:true,inactiveborder:true,inactivecaption:true,inactivecaptiontext:true,infobackground:true,infotext:true,menu:true,menutext:true,scrollbar:true,threeddarkshadow:true,threedface:true,threedhighlight:true,threedlightshadow:true,threedshadow:true,window:true,windowframe:true,windowtext:true},xa,pb,wb={"%":true,cm:true,em:true,ex:true,"in":true,mm:true,pc:true,pt:true,px:true},Bb,Wa,Pb={b:"\u0008",t:"\t",n:"\n",
f:"\u000c",r:"\r",'"':'"',"/":"/","\\":"\\"},Gb={alert:false,confirm:false,console:false,Debug:false,opera:false,prompt:false},Eb={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r","'":"\\'",'"':'\\"',"/":"\\/","\\":"\\\\"},p,Ja=["closure","exception","global","label","outer","undef","unused","var"],Sa,Y,za,nb={a:{},abbr:{},acronym:{},address:{},applet:{},area:{empty:true,parent:" map "},article:{},aside:{},audio:{},b:{},base:{empty:true,parent:" head "},bdo:{},big:{},blockquote:{},body:{parent:" html noframes "},
...
tt:{},u:{},ul:{},"var":{},video:{}},Xa,Ea,x,fa,ma,Ba,ya,Aa,ra,Jb={Buffer:false,clearInterval:false,clearTimeout:false,console:false,exports:false,global:false,module:false,process:false,querystring:false,require:false,setInterval:false,setTimeout:false,__dirname:false,__filename:false},Ka,Mb={indexOf:true,lastIndexOf:true,search:true},g,ta,l,P,qb,U,ha,Qb={g:true,i:true,m:true},Fb={defineClass:false,deserialize:false,gc:false,help:false,load:false,loadClass:false,print:false,quit:false,readFile:false,
readUrl:false,runCommand:false,seal:false,serialize:false,spawn:false,sync:false,toint32:false,version:false},E,Lb={";":true,'"':true,"'":true,")":true},rb,N,Rb={Array:false,Boolean:false,Date:false,decodeURI:false,decodeURIComponent:false,encodeURI:false,encodeURIComponent:false,Error:false,eval:false,EvalError:false,Function:false,isFinite:false,isNaN:false,JSON:false,Math:false,Number:false,Object:false,parseInt:false,parseFloat:false,RangeError:false,ReferenceError:false,RegExp:false,String:false,
SyntaxError:false,TypeError:false,URIError:false},Sb={E:true,LN2:true,LN10:true,LOG2E:true,LOG10E:true,MAX_VALUE:true,MIN_VALUE:true,NEGATIVE_INFINITY:true,PI:true,POSITIVE_INFINITY:true,SQRT1_2:true,SQRT2:true},na,Z={},Ya,n,Ga,ga,La,Kb={alert:true,animator:true,appleScript:true,beep:true,bytesToUIString:true,Canvas:true,chooseColor:true,chooseFile:true,chooseFolder:true,closeWidget:true,COM:true,convertPathToHFS:true,convertPathToPlatform:true,CustomAnimation:true,escape:true,FadeAnimation:true,
...
savePreferences:true,screen:true,ScrollBar:true,showWidgetPreferences:true,sleep:true,speak:true,Style:true,suppressUpdates:true,system:true,tellWidget:true,Text:true,TextArea:true,Timer:true,unescape:true,updateNow:true,URL:true,Web:true,widget:true,Window:true,XMLDOM:true,XMLHttpRequest:true,yahooCheckLogin:true,yahooLogin:true,yahooLogout:true},Ib={ActiveXObject:false,CScript:false,Debug:false,Enumerator:false,System:false,VBArray:false,WScript:false},t,T,Tb=/@cc|<\/?|script|\]\s*\]|<\s*!|&lt/i,
...
function(){return this>="a"&&this<="z\uffff"||this>="A"&&this<="Z\uffff"};if(typeof String.prototype.isDigit!=="function")String.prototype.isDigit=function(){return this>="0"&&this<="9"};if(typeof String.prototype.supplant!=="function")String.prototype.supplant=function(a){return this.replace(/\{([^{}]*)\}/g,function(b,c){var d=a[c];return typeof d==="string"||typeof d==="number"?d:b})};Ba=function(){function a(b,c,d,f){c={comment:b,quote:c,at:f,line:d};Ca||rb||t&&t!=="script"&&t!=="style"&&t!=="styleproperty"?
j("unexpected_comment",d,e):t==="script"&&/<\//i.test(m)?j("unexpected_a",d,e,"</"):l.safe&&Tb.test(b)&&j("dangerous_comment",d,f);ta.comments?ta.comments.push(c):ta.comments=[c];JAYLINT.comments.push(c)}function b(){var a;if(i>=ya.length)return false;e=1;m=ya[i];i=i+1;a=m.search(/ \t/);a>=0&&j("mixed",i,a+1);m=m.replace(/\t/g,Ya);a=m.search(Wb);a>=0&&j("unsafe",i,a);l.maxlen&&l.maxlen<m.length&&j("too_long",i,m.length);return true}function c(a,b,d){var f;(a==="(string)"||a==="(range)")&&fb.test(b)&&
j("url",i,h);f=Object.create(Z[a==="(punctuator)"||a==="(identifier)"&&Object.prototype.hasOwnProperty.call(Z,b)?b:a]||Z["(error)"]);if(a==="(identifier)"){f.identifier=true;b==="__iterator__"||b==="__proto__"?s("reserved_a",i,h,b):!l.nomen&&(b.charAt(0)==="_"||b.charAt(b.length-1)==="_")&&j("dangling_a",i,h,b)}if(b!==void 0)f.value=b;if(d)f.quote=d;f.line=i;f.from=h;f.thru=e;f.prev=ta;qb=(a=f.id)&&("(,=:[!&|?{};".indexOf(a.charAt(a.length-1))>=0||a==="return");return ta=ta.next=f}function d(a){function f(a){var b=
parseInt(m.substr(k+1,a),16);k=k+a;b>=32&&b<=126&&b!==34&&b!==92&&b!==39&&j("unexpected_a",i,e,"\\");e=e+a;g=String.fromCharCode(b)}var g,k,Za="";ma&&a!=='"'&&j("expected_a",i,e,'"');if(T===a||t==="scriptstring"&&!T)return c("(punctuator)",a);for(k=0;;){for(;k>=m.length;){k=0;(t!=="html"||!b())&&s("unclosed",i,h)}g=m.charAt(k);if(g===a){e=e+1;m=m.slice(k+1);return c("(string)",Za,a)}if(g<" "){if(g==="\n"||g==="\r")break;j("control_a",i,e+o,m.slice(0,o))}else if(g===T)j("bad_html",i,e+k);else if(g===
"<")l.safe&&t==="html"?j("adsafe_a",i,e+o,g):m.charAt(o+1)==="/"&&(t||l.safe)?j("expected_a_b",i,e,"<\\/","</"):m.charAt(o+1)==="!"&&(t||l.safe)&&j("unexpected_a",i,e,"<!");else if(g==="\\")if(t==="html")l.safe&&j("adsafe_a",i,e+o,g);else if(t==="styleproperty"){k=k+1;e=e+1;g=m.charAt(k);g!==a&&j("unexpected_a",i,e,"\\")}else{k=k+1;e=e+1;g=m.charAt(k);switch(g){case "":l.es5||j("es5",i,e);b();k=-1;break;case T:j("bad_html",i,e+k);break;case "'":ma&&j("unexpected_a",i,e,"\\'");break;case "u":f(4);
break;case "v":ma&&j("unexpected_a",i,e,"\\v");g="\v";break;case "x":ma&&j("unexpected_a",i,e,"\\x");f(2);break;default:g=Pb[g];typeof g!=="string"&&j("unexpected_a",i,e,"\\")}}Za=Za+g;e=e+1;k=k+1}}function f(){for(var a,b,d=0,k=0;;){a=true;g=m.charAt(k);k=k+1;switch(g){case "":s("unclosed_regexp",i,h);return;case "/":d>0&&j("unescaped_a",i,h+k,"/");g=m.slice(0,k-1);for(d=Object.create(Qb);d[m.charAt(k)]===true;){d[m.charAt(k)]=false;k=k+1}m.charAt(k).isAlpha()&&s("unexpected_a",i,h,m.charAt(k));
e=e+k;m=m.slice(k);k=m.charAt(0);(k==="/"||k==="*")&&s("confusing_regexp",i,h);return c("(regexp)",g);case "\\":g=m.charAt(k);g<" "?j("control_a",i,h+k,""+g):g==="<"&&j(H.unexpected_a,i,h+k,"\\");k=k+1;break;case "(":d=d+1;a=false;if(m.charAt(k)==="?"){k=k+1;switch(m.charAt(k)){case ":":case "=":case "!":k=k+1;break;default:j(H.expected_a_b,i,h+k,":",m.charAt(k))}}break;case "|":a=false;break;case ")":d===0?j("unescaped_a",i,h+k,")"):d=d-1;break;case " ":for(o=1;m.charAt(k)===" ";){k=k+1;o=o+1}o>
1&&j("use_braces",i,h+k,o);break;case "[":g=m.charAt(k);if(g==="^"){k=k+1;l.regexp?m.charAt(k)==="]"&&s("unescaped_a",i,h+k,"^"):j("insecure_a",i,h+k,g)}b=false;if(g==="]"){j("empty_class",i,h+k-1);b=true}a:do{g=m.charAt(k);k=k+1;switch(g){case "[":case "^":j("unescaped_a",i,h+k,g);b=true;break;case "-":if(b)b=false;else{j("unescaped_a",i,h+k,"-");b=true}break;case "]":b||j("unescaped_a",i,h+k-1,"-");break a;case "\\":g=m.charAt(k);g<" "?j(H.control_a,i,h+k,""+g):g==="<"&&j(H.unexpected_a,i,h+k,"\\");
k=k+1;b=true;break;case "/":j("unescaped_a",i,h+k-1,"/");b=true;break;case "<":if(t==="script"){g=m.charAt(k);(g==="!"||g==="/")&&j(H.html_confusion_a,i,h+k,g)}b=true;break;default:b=true}}while(g);break;case ".":l.regexp||j("insecure_a",i,h+k,g);break;case "]":case "?":case "{":case "}":case "+":case "*":j("unescaped_a",i,h+k,g);break;case "<":if(t==="script"){g=m.charAt(k);(g==="!"||g==="/")&&j(H.html_confusion_a,i,h+k,g)}}if(a)switch(m.charAt(k)){case "?":case "+":case "*":k=k+1;m.charAt(k)===
"?"&&(k=k+1);break;case "{":k=k+1;g=m.charAt(k);(g<"0"||g>"9")&&j(H.expected_number_a,i,h+k,g);k=k+1;for(b=+g;;){g=m.charAt(k);if(g<"0"||g>"9")break;k=k+1;b=+g+b*10}a=b;if(g===","){k=k+1;a=Infinity;g=m.charAt(k);if(g>="0"&&g<="9"){k=k+1;for(a=+g;;){g=m.charAt(k);if(g<"0"||g>"9")break;k=k+1;a=+g+a*10}}}m.charAt(k)!=="}"?j(H.expected_a_b,i,h+k,"}",g):k=k+1;m.charAt(k)==="?"&&(k=k+1);b>a&&j(H.not_greater,i,h+k,b,a)}}g=m.slice(0,k-1);e=e+k;m=m.slice(k);return c("(regexp)",g)}var e,g,h,k,i,o,m;return{init:function(a){ya=
typeof a==="string"?a.replace(Vb,"\n").replace(Ub,"\n").split("\n"):a;i=0;b();h=1},range:function(a,b){var d,f="";h=e;for(m.charAt(0)!==a&&s("expected_a_b",i,e,a,m.charAt(0));;){m=m.slice(1);e=e+1;d=m.charAt(0);switch(d){case "":s("missing_a",i,e,d);break;case b:m=m.slice(1);e=e+1;return c("(range)",f);case T:case "\\":j("unexpected_a",i,e,d)}f=f+d}},token:function(){for(var l,o,q;;){for(;!m;)if(!b())return c("(end)");for(;t==="outer";){o=m.search(Zb);if(o===0)break;else if(o>0){e=e+1;m=m.slice(o);
break}else if(!b())return c("(end)","")}l=(bc[t]||ac).exec(m);q=void 0;if(l){k=l[0].length;q=l[1];g=q.charAt(0);m=m.slice(k);h=e+k-q.length;e=e+k}else q=void 0;if(q){l=q.charAt(0);if(l.isAlpha()||l==="_"||l==="$")return c("(identifier)",q);if(l.isDigit()){o=q;l=void 0;t!=="style"&&t!=="styleproperty"&&m.charAt(0).isAlpha()&&j("expected_space_a_b",i,e,g,m.charAt(0));if(g==="0"){l=o.charAt(1);l.isDigit()?n.id!=="."&&t!=="styleproperty"&&j("unexpected_a",i,e,o):ma&&(l==="x"||l==="X")&&j("unexpected_a",
i,e,"0x")}o.slice(o.length-1)==="."&&j("trailing_decimal_a",i,e,o);if(t!=="style"){l=+o;isFinite(l)||j("bad_number",i,e,o);o=l}return c("(number)",o)}switch(q){case '"':case "'":return d(q);case "//":a(m,"//",i,e);m="";break;case "/*":for(l="/*";;){o=m.search(Yb);if(o>=0)break;a(m,l,i,e);l="";b()||s("unclosed_comment",i,e)}a(m.slice(0,o),l,e,i);e=e+(o+2);m.charAt(o)==="/"&&s("nested_comment",i,e);m=m.slice(o+2);break;case "":break;case "/":n.id==="/="&&s(H.slash_equal,i,h);return qb?f():c("(punctuator)",
q);case "<\!--":for(k=i;;){o=m.indexOf("--");if(o>=0)break;o=m.indexOf("<!");o>=0&&s("nested_comment",i,e+o);b()||s("unclosed_comment",k,l)}k=m.indexOf("<!");k>=0&&k<o&&s("nested_comment",i,e+k);e=e+o;m.charAt(o+2)!==">"&&s("expected_a",i,e,"--\>");e=e+3;m=m.slice(o+3);break;case "#":if(t==="html"||t==="styleproperty"){for(;;){l=m.charAt(0);if((l<"0"||l>"9")&&(l<"a"||l>"f")&&(l<"A"||l>"F"))break;e=e+1;m=m.slice(1);q=q+l}q.length!==4&&q.length!==7&&j("bad_color_a",i,h+k,q);return c("(color)",q)}return c("(punctuator)",
q);default:if(t==="outer"&&l==="&"){e=e+1;for(m=m.slice(1);;){l=m.charAt(0);e=e+1;m=m.slice(1);if(l===";")break;l>="0"&&l<="9"||l>="a"&&l<="z"||l==="#"||s("bad_entity",i,h+k,e)}break}return c("(punctuator)",q)}}else{for(;m&&m<"!";)m=m.slice(1);if(m){if(t==="html")return c("(error)",m.charAt(0));s("unexpected_a",i,e,m.charAt(0))}}}}}}();Z["(identifier)"]={lbp:0,identifier:true,nud:function(){var a=this.value,b=E[a];if(typeof b!=="object"){b=P[a];if(typeof b==="boolean"){za[a]=b={value:a,writeable:b,
funct:Y};Y[a]="var"}else{l.undef||f("used_before_a",n);E[a]=b={value:a,writeable:true,funct:p};p[a]="undef"}}b=b.funct;if(p===b)switch(p[a]){case "becoming":f("unexpected_a",n);p[a]="var";break;case "unused":p[a]="var";break;case "unparam":p[a]="parameter";break;case "unction":p[a]="function";break;case "label":f("a_label",n,a)}else switch(p[a]){case "closure":case "function":case "var":case "unused":f("a_scope",n,a);break;case "label":f("a_label",n,a);break;case "outer":case "global":break;default:switch(b[a]){case "function":case "unction":case "var":case "unused":case "becoming":case "closure":case "parameter":b[a]=
...
L("--\>");oa(L("}"));L(")");L("]");oa(L('"'));oa(L("'"));L(";");L(":");L(",");L("#");L("@");L("*/");oa(D("case"));D("catch");oa(D("default"));D("else");D("finally");db("arguments",function(a){na&&p===Y?f("strict",a):l.safe&&f("adsafe",a)});db("eval",function(a){l.safe&&f("adsafe",a)});ua("false","boolean",false);ua("Infinity","number",Infinity);ua("NaN","number",NaN);ua("null","",null);db("this",function(a){na&&(p["(statement)"]&&p["(name)"].charAt(0)>"Z"||p===Y)?f("strict",a):l.safe&&f("adsafe",
a)});ua("true","boolean",true);ua("undefined","",void 0);M("?",30,function(a,b){b.first=da(ca(a));b.second=r(0);I();var c=g;i(":");m();I();b.third=r(10);b.arity="ternary";b.type=K(b.second,b.third);S(b.second,b.third)?f("weird_ternary",c):S(b.first,b.second)&&f("use_or",b);return b});M("||",40,function(a,b){function c(a){a.id==="&&"&&!a.paren&&f("and",a);return a}b.first=c(da(ca(a)));b.second=c(ca(r(40)));S(b.first,b.second)&&f("weird_condition",b);return b});M("&&",50,function(a,b){b.first=da(ca(a));
b.second=ca(r(50));S(b.first,b.second)&&f("weird_condition",b);return b});O("void",function(){this.first=r(0);if(this.first.id!=="(number)"||this.first.value){f("unexpected_a",this);return this}this.type="undefined";return this});va("|",70);va("^",80);va("&",90);ka("==","===");ka("===");ka("!=","!==");ka("!==");ka("<");ka(">");ka("<=");ka(">=");va("<<",120);va(">>",120);va(">>>",120);M("in",120,function(a,b){f("infix_in",b);b.left=a;b.right=r(130);return b},"boolean");M("instanceof",120,null,"boolean");
M("+",130,function(a,b){a.value||(a.id==="(number)"?f("unexpected_a",a):a.id==="(string)"&&f("expected_a_b",a,"String","''"));var c=r(130);c.value||(c.id==="(number)"?f("unexpected_a",c):c.id==="(string)"&&f("expected_a_b",c,"String","''"));if(a.id===c.id&&(a.id==="(string)"||a.id==="(number)")){a.value=a.value+c.value;a.thru=c.thru;a.id==="(string)"&&fb.test(a.value)&&f("url",a);m(c);m(b);return a}b.first=a;b.second=c;b.type=K(a,c,b);return b});O("+","num");O("+++",function(){f("confusing_a",n);
...
a)})}else(a.second.value==="toString"||a.second.value==="stringify")&&K("string",b);else a.identifier&&a.value==="String"&&K("string",b);return b},"",true);O("(",function(){G("expression");m();w();y();if(g.id==="function")g.immed=true;var a=r(0);a.paren=true;w();v(")",this);m();a.id==="function"&&(g.id==="("?f("move_invocation"):f("bad_wrap",this));return a});M(".",170,function(a,b){w(U,n);w();var c=pa();typeof c==="string"&&Qa(c);b.first=a;b.second=n;if(a&&a.value==="arguments"&&(c==="callee"||c===
...
"boolean"||g.id==="(")break;if(Sb[c]===true){g.id==="."&&f("adsafe",b);break}if(g.id!=="."){f("adsafe",b);break}i(".");n.first=b;n.second=c;b=n;c=pa();typeof c==="string"&&Qa(c)}c==="length"&&K("number",b);return b},"",true);M("[",170,function(a,b){var c=bb(a),d;C(U,n);w();G();y();d=r(0);switch(bb(d)){case "number":d.id==="(number)"&&a.id==="arguments"&&f("use_param",a);c||K("array",a);break;case "string":if(d.id==="(string)"){if(l.safe&&(Pa[d.value]||d.value.charAt(0)==="_"||d.value.slice(-1)===
"_"))f("adsafe_subscript_a",d);else if(!l.evil&&(d.value==="eval"||d.value==="execScript"))f("evil",d);else if(!l.sub&&Db.test(d.value)){c=Z[d.value];(!c||!c.reserved)&&f("subscript",d)}Qa(d.value)}else l.safe&&d.id!=="typeof"&&f("adsafe_subscript_a",d);K("object",a);break;case void 0:switch(bb(a)){case "array":K("number",d);break;case "object":K("string",d);break;case "string":l.type||f("use_charAt",b);b.type="string"}l.safe&&f("adsafe_subscript_a",d);break;default:l.safe?f("adsafe_subscript_a",
d):f("bad_type")}v("]",b);m();w(U,n);b.first=a;b.second=d;return b},"",true);O("[",function(){this.arity="prefix";this.first=[];this.type="array";for(G("array");g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);i(",");m()}if(g.id==="]")break;x.wrap=false;y();this.first.push(r(10));if(g.id===","){B();if(g.id==="]"&&!l.es5){f("unexpected_a",n);break}}else break}v("]",this);m();return this},170);aa("=");aa("+=","+");aa("-=","-");aa("*=","*");aa("/=","/").nud=function(){k("slash_equal")};aa("%=",
"%");aa("&=","&");aa("|=","|");aa("^=","^");aa("<<=","<<");aa(">>=",">>");aa(">>>=",">>>");O("{",function(){var a,b,c,d,e,j={};this.arity="prefix";this.first=[];this.type="object";for(G();g.id!=="}";){x.wrap=false;y();if(g.value==="get"&&q().id!==":"){l.es5||f("es5");a=g;i("get");Q();d=g;(b=gb())||k("missing_property");a.value="";Ra(a);p["(loopage)"]&&f("function_loop",a);(c=a.first)&&f("parameter_a_get_b",c[0],c[0].value,b);B();e=g;e.value="";I();y();i("set");Q();c=gb();b!==c&&k("expected_a_b",n,
b,c||g.value);Ra(e);c=e.first;!c||c.length!==1?k("parameter_set_a",e,"value"):c[0].value!=="value"&&k("expected_a_b",c[0],"value",c[0].value);d.first=[a,e]}else{d=g;b=gb();typeof b!=="string"&&k("missing_property");i(":");m();I();d.first=r(10)}this.first.push(d);j[b]===true&&f("duplicate_a",g,b);j[b]=true;Qa(b);if(g.id!==",")break;for(;;){B();if(g.id!==",")break;f("unexpected_a",g)}g.id==="}"&&!l.es5&&f("unexpected_a",n)}v("}",this);m();return this});R("{",function(){m();f("statement_block");this.arity=
"statement";this.block=qa();this.disrupt=this.block.disrupt;i("}",this);m();return this});R("/*global",ba);R("/*globals",ba);R("/*jslint",ba);R("/*member",ba);R("/*members",ba);R("/*property",ba);R("/*properties",ba);R("var",function(){var a,b,c;p["(vars)"]&&!l.vars?f("combine_var"):p!==Y&&(p["(vars)"]=true);this.arity="statement";this.first=[];for(G("var");;){c=g;b=pa();F(c,"becoming");if(g.id==="="){a=g;a.first=c;I();i("=");I();g.id==="undefined"&&f("unnecessary_initialize",n,b);q(0).id==="="&&
g.identifier&&k("var_a_not");a.second=r(0);a.arity="infix";this.first.push(a);if(a.second.type)c.type=a.second.type}else this.first.push(c);p[b]==="becoming"&&(p[b]="unused");if(g.id!==",")break;B();x.wrap=false;if(ga&&g.line===n.line&&this.first.length===1){ga=null;x.open=false;x.at=x.at-l.indent}I();y()}ga=null;v();return this});R("function",function(){z();Ea&&f("function_block",n);var a=g,b=pa();F(a,"unction");w();Ra(this,b);g.id==="("&&g.line===n.line&&k("function_statement");this.arity="statement";
return this});O("function",function(){z();var a=pa();a?w():a="";Ra(this,a);p["(loopage)"]&&f("function_loop");this.arity="function";return this});R("if",function(){var a=g;z();i("(");G("control");m();w();y();this.arity="statement";this.first=da(ca(r(0)));w();v(")",a);m();z();this.block=ea(true);if(g.id==="else"){z();i("else");m();z();this["else"]=g.id==="if"||g.id==="switch"?eb(true):ea(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});R("try",function(){var a,b,c;
l.adsafe&&f("adsafe_a",this);z();this.arity="statement";this.block=ea(false);if(g.id==="catch"){z();i("catch");m();z();c=g;i("(");G("control");m();w();y();b=E;E=Object.create(b);this.first=a=g.value;g.identifier?F(g,"exception"):f("expected_identifier_a",g);i();w();v(")",c);m();z();this.second=ea(false);E=b}if(g.id==="finally"){m();z();i("finally");m();z();this.third=ea(false)}else this.second||k("expected_a_b",g,"catch",g.value);return this});Na("while",function(){z();var a=g;p["(breakage)"]=p["(breakage)"]+
1;p["(loopage)"]=p["(loopage)"]+1;i("(");G("control");m();w();y();this.arity="statement";this.first=ca(r(0));this.first.id!=="true"&&da(this.first,H.unexpected_a);w();v(")",a);m();z();this.block=ea(true);this.block.disrupt&&f("strange_loop",U);p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});D("with");Na("switch",function(){var a,b=g,c=true;p["(breakage)"]=p["(breakage)"]+1;z();i("(");m();w();G();this.arity="statement";this.first=da(ca(r(0)));w();v(")",b);m();z();i("{");
G();for(this.second=[];g.id==="case";){b=g;b.first=[];b.arity="case";I();y("case");for(i("case");;){z();a=r(0);b.first.push(a);a.id==="NaN"&&f("unexpected_a",a);C();i(":");m();if(g.id!=="case")break;I();y("case");i("case");m()}I();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];a.disrupt?a.id==="break"&&(c=false):f("missing_a_after_b",g,"break","case")}else f("empty_case");this.second.push(b)}this.second.length===0&&f("missing_a",g,"case");if(g.id==="default"){I();b=g;
b.arity="case";y("case");i("default");m();C();i(":");m();I();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];if(c&&a.disrupt&&a.id!=="break")this.disrupt=true}this.second.push(b)}p["(breakage)"]=p["(breakage)"]-1;I();v("}",this);return this});R("debugger",function(){l.debug||f("unexpected_a",this);this.arity="statement";return this});Na("do",function(){p["(breakage)"]=p["(breakage)"]+1;p["(loopage)"]=p["(loopage)"]+1;z();this.arity="statement";this.block=ea(true);this.block.disrupt&&
f("strange_loop",U);z();i("while");m();var a=g;z();i("(");G();m();w();y();this.first=da(ca(r(0)),H.unexpected_a);w();v(")",a);m();p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});Na("for",function(){var a,b,c=false;a=g;var d;this.arity="statement";p["(breakage)"]=p["(breakage)"]+1;p["(loopage)"]=p["(loopage)"]+1;i("(");G("control");m();I(this,a);w();g.id==="var"&&k("move_var");y();if(q(0).id==="in"){b=g;switch(p[b.value]){case "unused":p[b.value]="var";break;case "closure":case "var":break;
default:f("bad_in_a",b)}K("string",b);i();d=g;i("in");d.first=b;d.second=r(20);K("object",d.second);v(")",a);m();this.first=d;a=ea(true);if(!l.forin){if(a.length===1&&typeof a[0]==="object"&&a[0].value==="if"&&!a[0]["else"]){for(b=a[0].first;b.id==="&&";)b=b.first;switch(b.id){case "===":case "!==":c=b.first.id==="["?b.first.first.value===d.second.value&&b.first.second.value===d.first.value:b.first.id==="typeof"&&b.first.first.id==="["&&b.first.first.first.value===d.second.value&&b.first.first.second.value===
...
"call"&&b.second[0].value===d.second.value&&b.second[1].value===d.first.value)}}c||f("for_if",this)}}else{if(g.id!==";"){y();for(this.first=[];;){this.first.push(r(0,"for"));if(g.id!==",")break;B()}}W();if(g.id!==";"){y();this.second=ca(r(0));this.second.id!=="true"&&da(this.second,H.unexpected_a)}W(n);g.id===";"&&k("expected_a_b",g,")",";");if(g.id!==")"){this.third=[];for(y();;){this.third.push(r(0,"for"));if(g.id!==",")break;B()}}w();v(")",a);m();z();a=ea(true)}a.disrupt&&f("strange_loop",U);this.block=
a;p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});Oa("break",function(){var a=g.value;this.arity="statement";p["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){Q();p[a]!=="label"?f("not_a_label",g):E[a].funct!==p&&f("not_a_scope",g);this.first=g;i()}return this});Oa("continue",function(){l["continue"]||f("unexpected_a",this);var a=g.value;this.arity="statement";p["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){Q();
p[a]!=="label"?f("not_a_label",g):E[a].funct!==p&&f("not_a_scope",g);this.first=g;i()}return this});Oa("return",function(){this.arity="statement";if(g.id!==";"&&g.line===n.line){Q();(g.id==="/"||g.id==="(regexp)")&&f("wrap_regexp");this.first=r(20)}return this});Oa("throw",function(){this.arity="statement";Q();this.first=r(20);return this});D("class");D("const");D("enum");D("export");D("extends");D("import");D("super");D("let");D("yield");D("implements");D("interface");D("package");D("private");D("protected");
D("public");D("static");lb=[sa,function(){for(;;)if(g.identifier)switch(g.value.toLowerCase()){case "url":sa();break;case "expression":f("unexpected_a");i();break;default:i()}else{if(g.id===";"||g.id==="!"||g.id==="(end)"||g.id==="}")return true;i()}}];xa=["none","dashed","dotted","double","groove","hidden","inset","outset","ridge","solid"];pb=["auto","always","avoid","left","right"];Bb={all:true,braille:true,embossed:true,handheld:true,print:true,projection:true,screen:true,speech:true,tty:true,
tv:true};Wa=["auto","hidden","scroll","visible"];Ua={background:[true,"background-attachment","background-color","background-image","background-position","background-repeat"],"background-attachment":["scroll","fixed"],"background-color":["transparent",ja],"background-image":["none",sa],"background-position":[2,[u,"top","bottom","left","right","center"]],"background-repeat":["repeat","repeat-x","repeat-y","no-repeat"],border:[true,"border-color","border-style","border-width"],"border-bottom":[true,
...
"border-right-width":wa,"border-spacing":[2,u],"border-style":[4,xa],"border-top":[true,"border-top-color","border-top-style","border-top-width"],"border-top-color":ja,"border-top-style":xa,"border-top-width":wa,"border-width":[4,wa],bottom:[u,"auto"],"caption-side":["bottom","left","right","top"],clear:["both","left","none","right"],clip:[function(){var a;if(g.identifier&&g.value==="rect"){i();i("(");for(a=0;a<4;a=a+1)if(!u()){f("expected_number_a");break}i(")");return true}return false},"auto"],
color:ja,content:["open-quote","close-quote","no-open-quote","no-close-quote",jb,sa,function(){if(g.identifier&&g.value==="counter"){i();i("(");i();if(g.id===","){B();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}if(g.identifier&&g.value==="counters"){i();i("(");g.identifier||f("expected_name_a");i();if(g.id===","){B();g.id!=="(string)"&&f("expected_string_a");i()}if(g.id===","){B();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}return false},function(){if(g.identifier&&
g.value==="attr"){i();i("(");g.identifier||f("expected_name_a");i();i(")");return true}return false}],"counter-increment":[ib,"none"],"counter-reset":[ib,"none"],cursor:[sa,"auto","crosshair","default","e-resize","help","move","n-resize","ne-resize","nw-resize","pointer","s-resize","se-resize","sw-resize","w-resize","text","wait"],direction:["ltr","rtl"],display:["block","compact","inline","inline-block","inline-table","list-item","marker","none","run-in","table","table-caption","table-cell","table-column",
"table-column-group","table-footer-group","table-header-group","table-row","table-row-group"],"empty-cells":["show","hide"],"float":["left","none","right"],font:["caption","icon","menu","message-box","small-caption","status-bar",true,"font-size","font-style","font-weight","font-family"],"font-family":function(){for(;g.id!==";";){!ib()&&!jb()&&f("expected_name_a");if(g.id!==",")return true;B()}},"font-size":["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",u],"font-size-adjust":["none",
Ta],"font-stretch":["normal","wider","narrower","ultra-condensed","extra-condensed","condensed","semi-condensed","semi-expanded","expanded","extra-expanded"],"font-style":["normal","italic","oblique"],"font-variant":["normal","small-caps"],"font-weight":["normal","bold","bolder","lighter",Ta],height:[u,"auto"],left:[u,"auto"],"letter-spacing":["normal",u],"line-height":["normal",function(){if(g.id==="-"){i("-");C()}if(g.id==="(number)"){i();if(g.id!=="(string)"&&wb[g.value]===true){C();i()}return true}return false}],
"list-style":[true,"list-style-image","list-style-position","list-style-type"],"list-style-image":["none",sa],"list-style-position":["inside","outside"],"list-style-type":["circle","disc","square","decimal","decimal-leading-zero","lower-roman","upper-roman","lower-greek","lower-alpha","lower-latin","upper-alpha","upper-latin","hebrew","katakana","hiragana-iroha","katakana-oroha","none"],margin:[4,Fa],"margin-bottom":Fa,"margin-left":Fa,"margin-right":Fa,"margin-top":Fa,"marker-offset":[u,"auto"],
"max-height":[u,"none"],"max-width":[u,"none"],"min-height":u,"min-width":u,opacity:Ta,outline:[true,"outline-color","outline-style","outline-width"],"outline-color":["invert",ja],"outline-style":["dashed","dotted","double","groove","inset","none","outset","ridge","solid"],"outline-width":wa,overflow:Wa,"overflow-x":Wa,"overflow-y":Wa,padding:[4,u],"padding-bottom":u,"padding-left":u,"padding-right":u,"padding-top":u,"page-break-after":pb,"page-break-before":pb,position:["absolute","fixed","relative",
"static"],quotes:[8,jb],right:[u,"auto"],"table-layout":["auto","fixed"],"text-align":["center","justify","left","right"],"text-decoration":["none","underline","overline","line-through","blink"],"text-indent":u,"text-shadow":["none",4,[ja,u]],"text-transform":["capitalize","uppercase","lowercase","none"],top:[u,"auto"],"unicode-bidi":["normal","embed","bidi-override"],"vertical-align":["baseline","bottom","sub","super","top","text-top","middle","text-bottom",u],visibility:["visible","hidden","collapse"],
"white-space":["normal","nowrap","pre","pre-line","pre-wrap","inherit"],width:[u,"auto"],"word-spacing":["normal",u],"word-wrap":["break-word","normal"],"z-index":["auto",Ta]};fa=function(a,b){var c,j,h;JAYLINT.comments=[];JAYLINT.errors=[];JAYLINT.tree="";ob=ta=U=n=g=Object.create(Z["(begin)"]);P={};d(Rb);if(b){l=Object.create(b);if(j=l.predef)if(Array.isArray(j))for(c=0;c<j.length;c=c+1)P[j[c]]=true;else typeof j==="object"&&d(j);V()}else l={};l.indent=+l.indent||0;l.maxerr=l.maxerr||50;X="";Ha=
Ia=la=false;Va={};if(l.approved)for(c=0;c<l.approved.length;c=c+1)Va[l.approved[c]]=l.approved[c];else Va.test="test";Ya="";for(c=0;c<l.indent;c=c+1)Ya=Ya+" ";za=E={};Y=p={"(scope)":E,"(breakage)":0,"(loopage)":0};Sa=[p];Ca=false;Xa={};Ea=false;x=null;ma=false;Aa=[];ra={};Ka=false;ha=null;qb=true;rb=false;N=null;na=false;Ga=[];ga=null;La=0;t="";Ba.init(a);e();try{i();if(g.id==="(number)")k("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var m,o,s,q,F=l.white,r,w,v,z;t="html";T="";for(N=null;;){switch(g.value){case "<":t=
"html";i("<");o={};w=g;w.identifier||f("bad_name_a",w);q=w.value;l.cap&&(q=q.toLowerCase());w.name=q;i();if(!N){N=[];c=q;c!=="html"&&!l.fragment&&(c==="div"&&l.adsafe?k("adsafe_fragment"):k("expected_a_b",n,"html",c));if(l.adsafe){c==="html"&&k("adsafe_html",n);l.fragment?c!=="div"&&k("adsafe_div",n):k("adsafe_fragment",n)}l.browser=true}v=nb[q];typeof v!=="object"&&k("unrecognized_tag_a",w,q);s=v.empty;for(w.type=q;;){if(g.id==="/"){i("/");g.id!==">"&&f("expected_a_b",g,">",g.value);break}if(g.id&&
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&f("expected_a_b",g,">",g.value);f("bad_name_a")}l.white=false;I();m=g.value;l.white=F;i();!l.cap&&m!==m.toLowerCase()&&f("attribute_case_a",n);m=m.toLowerCase();T="";Object.prototype.hasOwnProperty.call(o,m)&&f("duplicate_a",n,m);if(m.slice(0,2)==="on"){l.on||f("html_handlers");t="scriptstring";i("=");r=g.id;r!=='"'&&r!=="'"&&k("expected_a_b",g,'"',g.value);T=r;z=l.white;l.white=true;i(r);Ma();qa();l.white=z;g.id!==r&&
k("expected_a_b",g,r,g.value);t="html";T="";i(r);v=false}else if(m==="style"){t="scriptstring";i("=");r=g.id;r!=='"'&&r!=="'"&&k("expected_a_b",g,'"',g.value);t="styleproperty";T=r;i(r);yb();t="html";T="";i(r);v=false}else if(g.id==="="){i("=");v=g.value;!g.identifier&&g.id!=='"'&&g.id!=="'"&&g.id!=="(string)"&&g.id!=="(string)"&&g.id!=="(color)"&&f("expected_attribute_value_a",n,m);i()}else v=true;o[m]=v;c=m;j=v;var u=h=void 0;if(c==="id"){h=typeof j==="string"?j.toUpperCase():"";Xa[h]===true&&f("duplicate_a",
g,j);if(/^[A-Za-z][A-Za-z0-9._:\-]*$/.test(j)){if(l.adsafe)if(X)j.slice(0,X.length)!==X?f("adsafe_prefix_a",g,X):/^[A-Z]+_[A-Z]+$/.test(j)||f("adsafe_bad_id");else{X=j;/^[A-Z]+_$/.test(j)||f("adsafe_bad_id")}}else f("bad_id_a",g,j);u=j.search(Xb);u>=0&&f("unexpected_char_a_b",n,j.charAt(u),c);Xa[h]=true}else if(c==="class"||c==="type"||c==="name"){u=j.search($b);u>=0&&f("unexpected_char_a_b",n,j.charAt(u),c);Xa[h]=true}else if(c==="href"||c==="background"||c==="content"||c==="data"||c.indexOf("src")>=
0||c.indexOf("url")>=0){l.safe&&xb.test(j)&&k("bad_url",g,j);Ga.push(j)}else c==="for"?l.adsafe&&(X?j.slice(0,X.length)!==X?f("adsafe_prefix_a",g,X):/^[A-Z]+_[A-Z]+$/.test(j)||f("adsafe_bad_id"):f("adsafe_bad_id")):c==="name"&&l.adsafe&&j.indexOf("_")>=0&&f("adsafe_name_a",g,j)}c=q;j=o;h=void 0;var C=nb[c],B=u=void 0;rb=false;C||k(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(N.length>0){c==="html"&&k("unexpected_a",n,c);if(B=C.parent)B.indexOf(" "+N[N.length-1].name+
" ")<0&&k("tag_a_in_b",n,c,B);else if(!l.adsafe&&!l.fragment){h=N.length;do{h<=0&&k("tag_a_in_b",n,c,"body");h=h-1}while(N[h].name!=="body")}}switch(c){case "div":l.adsafe&&N.length===1&&!X&&f("adsafe_missing_id");break;case "script":t="script";i(">");j.lang&&f("lang",n);l.adsafe&&N.length!==1&&f("adsafe_placement",n);if(j.src){l.adsafe&&(!Ha||!Va[j.src])&&f("adsafe_source",n);j.type&&f("type",n)}else{G(g.from);y();Ma();Ia=true;u=qa();if(l.adsafe){la&&k("adsafe_script",n);(u.length!==1||A(u[0],"id",
"(")||A(u[0].first,"id",".")||A(u[0].first.first,"value","ADSAFE")||A(u[0].second[0],"value",X))&&k("adsafe_id_go");switch(u[0].first.second.value){case "id":(Ha||la||u[0].second.length!==1)&&k("adsafe_id",g);Ha=true;break;case "go":la&&k("adsafe_go");(u[0].second.length!==2||A(u[0].second[1],"id","function")||!u[0].second[1].first||u[0].second[1].first.length!==2||A(u[0].second[1].first[0],"value","dom")||A(u[0].second[1].first[1],"value","lib"))&&k("adsafe_go",g);la=true;break;default:k("adsafe_id_go")}}x=
null}t="html";i("</");!g.identifier&&g.value!=="script"&&f("expected_a_b",g,"script",g.value);i();t="outer";break;case "style":t="style";i(">");Ab();t="html";i("</");!g.identifier&&g.value!=="style"&&f("expected_a_b",g,"style",g.value);i();t="outer";break;case "input":switch(j.type){case "radio":case "checkbox":case "button":case "reset":case "submit":break;case "text":case "file":case "password":case "file":case "hidden":case "image":l.adsafe&&j.autocomplete!=="off"&&f("adsafe_autocomplete");break;
default:f("bad_type")}break;case "applet":case "body":case "embed":case "frame":case "frameset":case "head":case "iframe":case "noembed":case "noframes":case "object":case "param":l.adsafe&&f("adsafe_tag",g,c)}s||N.push(w);t="outer";i(">");break;case "</":t="html";i("</");g.identifier||f("bad_name_a");q=g.value;l.cap&&(q=q.toLowerCase());i();N||k("unexpected_a",g,"</"+q+">");(w=N.pop())||k("unexpected_a",g,"</"+q+">");w.name!==q&&k("expected_a_b",g,"</"+w.name+">","</"+q+">");g.id!==">"&&k("expected_a_b",
g,">",g.value);t="outer";i(">");break;case "<!":l.safe&&f("adsafe_a");for(t="html";;){i();if(g.id===">"||g.id==="(end)")break;g.value.indexOf("--")>=0&&k("unexpected_a",g,"--");g.value.indexOf("<")>=0&&k("unexpected_a",g,"<");g.value.indexOf(">")>=0&&k("unexpected_a",g,">")}t="outer";i(">");break;case "(end)":break a;default:g.id==="(end)"?k("missing_a",g,"</"+N[N.length-1].value+">"):i()}if(N&&N.length===0&&(l.adsafe||!l.fragment||g.id==="(end)"))break}g.id!=="(end)"&&k("unexpected_a")}l.adsafe&&
!la&&f("adsafe_go",this)}else switch(g.id){case "{":case "[":ma=true;hb();break;case "@":case "*":case "#":case ".":case ":":t="style";i();(n.id!=="@"||!g.identifier||g.value!=="charset"||n.line!==1||n.from!==1)&&k("css");i();g.id!=="(string)"&&g.value!=="UTF-8"&&k("css");i();W();Ab();break;default:l.adsafe&&l.fragment&&k("expected_a_b",g,"<div>",g.value);G(1);g.id===";"&&!Ka&&W();Ia=true;h=qa();ob.first=h;JAYLINT.tree=ob;l.adsafe&&(h.length!==1||A(h[0],"id","(")||A(h[0].first,"id",".")||A(h[0].first.first,
"value","ADSAFE")||A(h[0].first.second,"value","lib")||h[0].second.length!==2||h[0].second[0].id!=="(string)"||A(h[0].second[1],"id","function"))&&k("adsafe_lib");h.disrupt&&f("weird_program",U)}x=null;i("(end)")}catch(D){D&&JAYLINT.errors.push({reason:D.message,line:D.line||g.line,character:D.character||g.from},null)}return JAYLINT.errors.length===0};fa.data=function(){var a={functions:[]},b,c,d,e,f,g=[],j=[];if(fa.errors.length)a.errors=fa.errors;if(ma)a.json=true;if(Ga.length>0)a.urls=Ga;b=Object.keys(za).filter(function(a){return a.charAt(0)!==
...
b.param=f["(params)"];b.line=f["(line)"];b["(complexity)"]=f["(complexity)"];a.functions.push(b)}if(j.length>0)a.unused=j;if(g.length>0)a.undef=g;for(e in ra)if(typeof ra[e]==="number"){a.member=ra;break}return a};fa.report=function(a){function b(a,c){var d,e;if(Array.isArray(c)){h.push("<div><i>"+a+"</i> ");c=c.sort().forEach(function(a){if(a!==e){e=a;h.push((d?", ":"")+e);d=true}});h.push("</div>")}else c&&h.push("<div><i>"+a+"</i> "+c+"</div>")}var d=fa.data(),e,f,g,j;f="";var k,h=[];if(d.errors||
d.unused||d.undef){e=true;h.push("<div id=errors><i>Error:</i>");if(d.errors)for(g=0;g<d.errors.length;g=g+1)if(j=d.errors[g]){f=j.evidence||"";h.push("<p>Problem"+(isFinite(j.line)?" at line "+j.line+" character "+j.character:"")+": "+j.reason.entityify()+"</p><p class=evidence>"+(f&&(f.length>80?f.slice(0,77)+"...":f).entityify())+"</p>")}if(d.undef){f=[];for(g=0;g<d.undef.length;g=g+1)f[g]="<code><u>"+d.undef[g].name+"</u></code>&nbsp;<i>"+d.undef[g].line+" </i> <small>"+d.undef[g]["function"]+
...
e.exception);b("Outer",e.outer);b("Global",e.global);b("Label",e.label);b("Complexity",e["(complexity)"])}if(d.member){e=Object.keys(d.member);if(e.length){e=e.sort();f="<br><pre id=properties>/*properties ";j=13;for(g=0;g<e.length;g=g+1){a=e[g];k=Db.test(a)?a:"'"+a.entityify().replace(vb,c)+"'";if(j+k.length>72){h.push(f+"<br>");f="    ";j=1}j=j+(k.length+2);d.member[a]===1&&(k="<i>"+k+"</i>");g<e.length-1&&(k=k+", ");f=f+k}h.push(f+"<br>*/</pre>")}h.push("</div>")}}return h.join("")};fa.jslint=
...
a);Guard.requireValue("realType",b);var c=this.getType(a),f=this.getType(b),c=d.indexOf(c),f=d.indexOf(f);e[c]=f};this.resolve=function(a,b){return new (this.resolveType(a,b))(b)};this.resolveName=function(a){a=this.resolveType(a);a=d.indexOf(a);return c[a]};this.isPrimitiveType=function(b){b=this.resolveType(b);return b===Number||b===String||b===Date||b===String||b===Boolean||b===Array||b===Object||b===a.Number||b===a.String||b===a.Date||b===a.String||b===a.Boolean||b===a.Array||b===a.Object};this.resolveType=
function(a){var a=this.getType(a),b=d.indexOf(a);return typeof e[b]==="undefined"?a:d[e[b]]};this.getTypes=function(){for(var a=Object.keys(b),c=[],e=0;e<a.length;e++){var f=a[e];c.push({name:f,type:d[b[f]],toString:function(){return this.name}})}return c};this.getTypeName=function(a){switch(typeof a){case "object":if(a==null)return"$data.Object";if(a instanceof Array)return"$data.Array";if(a.getType)return a.getType().fullName;if(a instanceof Date)return"$data.Date";default:return typeof a}};this.isTypeRegistered=
function(a){return typeof a==="function"?d.indexOf(a)>-1:a in b};this.unregisterType=function(){Guard.raise("Unimplemented")};this.getType=function(a){Guard.requireValue("typeOrName",a);if(typeof a==="function")return a;a in b||Guard.raise(new Exception("Unable to resolve type:"+a));return d[b[a]]};this.getName=function(a){var b=this.getType(a),b=d.indexOf(b);b==-1&&Guard.raise("unknown type to request name for: "+a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;
case a.Integer:return 0;case a.String:return null;case a.Boolean:return false;default:return null}};this.registerType=function(a,e,h){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var j=[];j.push(a);a=j}for(j=0;j<a.length;j++){var A=a[j].split("."),y={};y.shortName=A[A.length-1];y.fullName=a[j];a[j]=y}A=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(A,e);for(var j=
0,G=a.length;j<G;j++){y=a[j];"create"+y.shortName in f?console&&console.warn("warning: short names overlap:"+y.shortName+", Container.create"+y.shortName+" has not been updated"):f["create"+y.shortName]=typeof h==="function"?h:A;var v=d.indexOf(e);if(v==-1){v=d.push(e)-1;c[v]=y.fullName}y.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+y.fullName);b[y.fullName]=v}if(!e.name)e.name=a[0].shortName}}};b.registerType(["$data.Number","number","float","real","decimal",
"JayNumber"],a.Number);b.registerType(["$data.Integer","int","integer","int16","int32","int64","JayInteger"],a.Integer);b.registerType(["$data.String","string","text","character","JayString"],a.String);b.registerType(["$data.Array","array","Array","[]","JayArray"],a.Array,function(){return a.Array.apply(void 0,arguments)});b.registerType(["$data.Date","datetime","date","JayDate"],a.Date);b.registerType(["$data.Boolean","bool","boolean","JayBoolean"],a.Boolean);b.registerType(["$data.Blob","blob",
"JayBlob"],a.Blob);b.registerType(["$data.Object","Object","object","{}","JayObject"],a.Object);b.registerType(["$data.Function","Function","function"],a.Function);b.registerType(["$data.ObjectID","ObjectID","objectId","objectid","ID","Id","id","JayObjectID"],a.ObjectID)})(window);b.$C=function(){Class.define.apply(Class,arguments)};a.Class.ConstructorParameter=ConstructorParameter=a.Class.define("ConstructorParameter",null,null,{constructor:function(a){this.paramIndex=a},paramIndex:{}})})($data,
window);$data.defaultErrorCallback=function(){Guard.raise(new Exception("DEFAULT ERROR CALLBACK!","DefaultError",arguments))};$data.defaultSuccessCallback=function(){};$data.defaultNotifyCallback=function(){};
...
$data.Class.define("$data.StorageModel",null,null,{constructor:function(){this.ComplexTypes=[];this.Associations=[]},LogicalType:{},LogicalTypeName:{},PhysicalType:{},PhysicalTypeName:{},EventHandlers:{},TableName:{},ComplexTypes:{},Associations:{},EntitySetReference:{}},null);
...
return b}return a},_initializeEntitySets:function(){for(var a=0,b=this._storageModel.length;a<b;a++){var c=this._storageModel[a];this[c.ItemName]=new $data.EntitySet(c.LogicalType,this,c.ItemName,c.EventHandlers);var d=this[c.ItemName];d.name=c.ItemName;d.tableName=c.TableName;d.eventHandlers=c.EventHandlers;this._entitySetReferences[c.LogicalType.name]=d;c.EntitySetReference=d}},_initializeStorageModel:function(){for(var a=this.getType().memberDefinitions.asArray(),b=0;b<a.length;b++){var c=a[b];
if("dataType"in c){var d=Container.resolveType(c.dataType);if(d&&d.isAssignableTo&&d.isAssignableTo($data.EntitySet)){d=new $data.StorageModel;d.TableName=c.tableName||c.name;d.ItemName=c.name;d.LogicalType=Container.resolveType(c.elementType);d.LogicalTypeName=d.LogicalType.name;d.PhysicalTypeName=$data.EntityContext._convertLogicalTypeNameToPhysical(d.LogicalTypeName);if(c.beforeCreate){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.beforeCreate=c.beforeCreate}if(c.beforeRead){if(!d.EventHandlers)d.EventHandlers=
{};d.EventHandlers.beforeRead=c.beforeRead}if(c.beforeUpdate){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.beforeUpdate=c.beforeUpdate}if(c.beforeDelete){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.beforeDelete=c.beforeDelete}if(c.afterCreate){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.afterCreate=c.afterCreate}if(c.afterRead){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.afterRead=c.afterRead}if(c.afterUpdate){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.afterUpdate=
c.afterUpdate}if(c.afterDelete){if(!d.EventHandlers)d.EventHandlers={};d.EventHandlers.afterDelete=c.afterDelete}this._storageModel.push(d)}}}if(typeof intellisense==="undefined")for(b=0;b<this._storageModel.length;b++){d=this._storageModel[b];a={};d.Associations=d.Associations||[];d.ComplexTypes=d.ComplexTypes||[];for(c=0;c<d.LogicalType.memberDefinitions.getPublicMappedProperties().length;c++){var e=d.LogicalType.memberDefinitions.getPublicMappedProperties()[c],h=Container.resolveType(e.dataType);
if(this.storageProvider.supportedDataTypes.indexOf(h)>-1&&Object.isNullOrUndefined(e.inverseProperty)){var f=JSON.parse(JSON.stringify(e));f.dataType=h;a[e.name]=f}else{this._buildDbType_navigationPropertyComplite(e,h,d);if((h===$data.Array||h.isAssignableTo&&h.isAssignableTo($data.EntitySet))&&e.inverseProperty&&e.inverseProperty!=="$$unbound")this._buildDbType_Collection_OneManyDefinition(a,d,h,e);else if(e.inverseProperty)if(e.inverseProperty==="$$unbound")h===$data.Array?this._buildDbType_Collection_OneManyDefinition(a,
d,h,e):this._buildDbType_ElementType_OneManyDefinition(a,d,h,e);else(f=h.memberDefinitions.getMember(e.inverseProperty))?f.elementType?Container.resolveType(f.elementType)===d.LogicalType?this._buildDbType_ElementType_OneManyDefinition(a,d,h,e):typeof intellisense==="undefined"&&Guard.raise(new Exception("Inverse property not valid, refereed item element type not match: "+d.LogicalTypeName,", property: "+e.name)):this._buildDbType_ElementType_OneOneDefinition(a,d,h,e):typeof intellisense==="undefined"&&
...
a.expression.nodeType===$data.Expressions.ExpressionType.Some||a.expression.nodeType===$data.Expressions.ExpressionType.Every){if(a.result.length!==1){b.error(new Exception("result count failed"));return}c=a.result[0]}else if(a.expression.nodeType===$data.Expressions.ExpressionType.First){if(a.result.length===0){b.error(new Exception("result count failed"));return}c=a.result[0]}else c=a.result;var e=function(){b.success(c)},f=0,h=a.getEntitySets(),F=function(){var b=h[f];if(b.afterRead){f++;b=b.afterRead.call(this,
c,h,a);typeof b==="function"?b.call(this,f<h.length?F:e,c,h,a):f<h.length?F():e()}else e()};h.length?F():e()}};e.error=b.error;var h=c.getEntitySets(),f=function(){var a=true,b=function(b){b===false&&(a=false);if(a)d.storageProvider.executeQuery(c,e);else{c.rawDataList=[];c.result=[];e.success(c)}},f=0,o=function(d){d===false&&(a=false);d=h[f];if(d.beforeRead){f++;d=d.beforeRead.call(this,h,c);if(typeof d==="function")d.call(this,f<h.length&&a?o:b,h,c);else{d===false&&(a=false);f<h.length&&a?o():
b()}}else b()};h.length?o():b()};this.user&&this.checkPermission?this.checkPermission(c.expression.nodeType===$data.Expressions.ExpressionType.BatchDelete?$data.Access.DeleteBatch:$data.Access.Read,this.user,h,{success:f,error:e.error}):f()},saveChanges:function(a){for(var b=[],c=this.stateManager.trackedEntities,d=new $data.PromiseHandler,e=d.createCallback(a),a=d.getPromise(),d=[];c.length>0;){for(var h=[],f=0;f<c.length;f++){var j=c[f],k=this._storageModel.getStorageModel(j.data.getType());if(j.data.entityState==
$data.EntityState.Unchanged){j.skipSave=true;d.push(j.data)}else if(j.data.entityState==$data.EntityState.Modified&&j.data.changedProperties&&!j.data.changedProperties.some(function(a){a=k.PhysicalType.memberDefinitions.getMember(a.name);if(a.kind==$data.MemberTypes.navProperty){a=k.Associations[a.association];a=a.FromMultiplicity+a.ToMultiplicity;return a=="*0..1"||a=="0..11"}return true})){j.skipSave=true;d.push(j.data)}for(var s=[],o=k.PhysicalType.memberDefinitions.asArray(),A=0;A<o.length;A++){var F=
o[A];F.kind==$data.MemberTypes.navProperty&&s.push(F)}for(o=0;o<s.length;o++)for(var q=s[o],A=k.Associations[q.name],F=A.ToPropertyName,q=[].concat(j.data[q.name]),m=0;m<q.length;m++){var i=q[m];if(i){var V=i[F],ba=A.FromMultiplicity+A.ToMultiplicity;if(A.FromMultiplicity==="$$unbound")if(i instanceof $data.Array){j.dependentOn=j.dependentOn||[];for(V=0;V<i.length;V++)j.dependentOn.indexOf(i)<0&&i.skipSave!==true&&j.dependentOn.push(i)}else{j.dependentOn=j.dependentOn||[];j.dependentOn.indexOf(i)<
0&&i.skipSave!==true&&j.dependentOn.push(i)}else{switch(ba){case "*0..1":V?V instanceof Array?V.indexOf(j.data)==-1&&V.push(j.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):i[F]=[j.data];break;default:V?V!==j.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):i[F]=j.data}switch(ba){case "*0..1":case "0..11":j.dependentOn=j.dependentOn||[];j.dependentOn.indexOf(i)<0&&i.skipSave!==true&&j.dependentOn.push(i)}}if(!i.entityState)i.entityState=
$data.EntityState.Added;h.indexOf(i)==-1&&h.push(i)}}}for(f=0;f<c.length;f++){j=c[f];j.skipSave!==true&&b.push(j)}c=[];for(f=0;f<h.length;f++){var y=h[f];d.some(function(a){return a==y})||b.some(function(a){return a.data==y})||c.push({data:y,entitySet:this.getEntitySetFromElementType(y.getType().name)})}}for(o=0;o<b.length;o++){c=b[o];if(c.dependentOn){h=[];for(f=0;f<c.dependentOn.length;f++)d.indexOf(c.dependentOn[f])<0&&h.push(c.dependentOn[f]);c.dependentOn=h}}var d=null,G=this;if(b.length==0){this.stateManager.trackedEntities.length=
0;e.success(0);return a}c=[];for(f=0;f<b.length;f++){j=b[f];if(j.data.entityState===$data.EntityState.Added)for(o=0;o<j.data.getType().memberDefinitions.getPublicMappedProperties().length;o++){d=j.data.getType().memberDefinitions.getPublicMappedProperties()[o];d.required&&!d.computed&&!j.data[d.name]&&(j.data[d.name]=Container.getDefault(d.dataType))}(j.data.entityState===$data.EntityState.Added||j.data.entityState===$data.EntityState.Modified)&&!j.data.isValid()&&c.push({item:j.data,errors:j.data.ValidationErrors})}if(c.length>
0){e.error(c);return a}for(var c=$data.Access.None,v={},f=0;f<b.length;f++){d=b[f];o=d.entitySet.elementType.name;h=this._entitySetReferences[o];if(h.beforeCreate||h.beforeUpdate||h.beforeDelete||this.user&&this.checkPermission){v[o]||(v[o]={});switch(d.data.entityState){case $data.EntityState.Added:c=c|$data.Access.Create;if(h.beforeCreate){if(!v[o].createAll)v[o].createAll=[];v[o].createAll.push(d)}break;case $data.EntityState.Modified:c=c|$data.Access.Update;if(h.beforeUpdate){if(!v[o].modifyAll)v[o].modifyAll=
[];v[o].modifyAll.push(d)}break;case $data.EntityState.Deleted:c=c|$data.Access.Delete;if(h.beforeDelete){if(!v[o].deleteAll)v[o].deleteAll=[];v[o].deleteAll.push(d)}}}}var z=function(a){if(a){Q="async";b.length=0}b.length?G.storageProvider.saveChanges({success:function(){G._postProcessSavedItems(e,b)},error:e.error},b):Q?e.error(new Exception("Cancelled event in "+Q,"CancelEvent")):e.success(0)},Q,w=Object.getOwnPropertyNames(v),f=0,C=["beforeUpdate","beforeDelete","beforeCreate"],I={beforeCreate:"createAll",
beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},B=function(a){if(a){Q="async";b.length=0;z(a)}else{var c=G._entitySetReferences[w[f]],d=C.pop();if(a=v[w[f]][I[d]]){for(var e=[],h=0;h<a.length;h++)e.push(a[h].data);if(!C.length){C=["beforeUpdate","beforeDelete","beforeCreate"];f++}h=c[d].call(G,e);if(typeof h==="function")h.call(G,f<w.length&&!Q?B:z,e);else if(h===false){Q=c.name+"."+d;for(c=0;c<a.length;c++){d=b.indexOf(a[c]);b.splice(d,1)}z()}else f<w.length&&!Q?B():z()}else{if(!C.length){C=["beforeUpdate",
"beforeDelete","beforeCreate"];f++}f<w.length&&!Q?B():z()}}};this.user&&this.checkPermission?this.checkPermission(c,this.user,w,{success:function(){f<w.length?B():z()},error:e.error}):f<w.length?B():z();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);for(var c={},d=this,e=0;e<b.length;e++){var h=b[e],f=h.data.entityState;h.data.entityState=
$data.EntityState.Unchanged;h.data.changedProperties=[];h.physicalData=void 0;var j=h.entitySet.elementType.name,k=d._entitySetReferences[j],s=void 0;switch(f){case $data.EntityState.Added:s="added";break;case $data.EntityState.Deleted:s="deleted";break;case $data.EntityState.Modified:s="updated"}s&&this.raiseEvent(s,h);if(k.afterCreate||k.afterUpdate||k.afterDelete){c[j]||(c[j]={});switch(f){case $data.EntityState.Added:if(k.afterCreate){if(!c[j].createAll)c[j].createAll=[];c[j].createAll.push(h)}break;
case $data.EntityState.Modified:if(k.afterUpdate){if(!c[j].modifyAll)c[j].modifyAll=[];c[j].modifyAll.push(h)}break;case $data.EntityState.Deleted:if(k.afterDelete){if(!c[j].deleteAll)c[j].deleteAll=[];c[j].deleteAll.push(h)}}}}var o=Object.getOwnPropertyNames(c),e=0,d=this,A=["afterUpdate","afterDelete","afterCreate"],F={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},q=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},m=function(){var a=d._entitySetReferences[o[e]],
b=A.pop(),f=c[o[e]][F[b]];if(f){for(var h=[],j=0;j<f.length;j++)h.push(f[j].data);if(!A.length){A=["afterUpdate","afterDelete","afterCreate"];e++}a=a[b].call(d,h);typeof a==="function"?a.call(d,e<o.length?m:q,h):e<o.length?m():q()}else{if(!A.length){A=["afterUpdate","afterDelete","afterCreate"];e++}e<o.length?m():q()}};e<o.length?m():q()},forEachEntitySet:function(a,b){for(var c in this._entitySetReferences)a.call(b,this._entitySetReferences[c])},loadItemProperty:function(a,b,c){Guard.requireType("entity",
a,$data.Entity);b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b;if(a[b.name]!=void 0){var d=new $data.PromiseHandler;callBack=d.createCallback(c);c.success(a[b.name]);return d.getPromise()}var e=true,d=this._storageModel.getStorageModel(a.getType().fullName),h=Container.resolveType(b.dataType);if(h===$data.Array||h.isAssignableTo&&h.isAssignableTo($data.EntitySet)){h=Container.resolveType(b.elementType);e=false}else{for(var f,j=0;j<d.Associations.length;j++){var k=d.Associations[j];
if(k.FromPropertyName==b.name){f=k;break}}f&&f.FromMultiplicity==="0..1"&&f.ToMultiplicity==="1"&&(e=false)}f=d.LogicalType.memberDefinitions.getKeyProperties();if(e===true){e="function (e) { return";j={};for(k=0;k<f.length;k++){var s=f[k];k>0&&(e=e+" &&");e=e+(" e."+s.name+" == this.key"+k);j["key"+k]=a[s.name]}return d.EntitySetReference.map("function (e) { return e."+b.name+" }").single(e+"; }",j,c)}e="function (e) { return";j={};for(k=0;k<f.length;k++){s=f[k];k>0&&(e=e+" &&");e=e+(" e."+b.inverseProperty+
"."+s.name+" == this.key"+k);j["key"+k]=a[s.name]}return this.getEntitySetFromElementType(h).filter(e+"; }",j).toArray(c)},getTraceString:function(a){return this.storageProvider.getTraceString(new $data.Query(a.expression,a.defaultType,this))},log:function(){},resolveBinaryOperator:function(a,b,c){return this.storageProvider.resolveBinaryOperator(a,b,c)},resolveUnaryOperator:function(a,b,c){return this.storageProvider.resolveUnaryOperator(a,b,c)},resolveFieldOperation:function(a,b,c){return this.storageProvider.resolveFieldOperation(a,
b,c)},resolveSetOperations:function(a,b,c){return this.storageProvider.resolveSetOperations(a,b,c)},_generateServiceOperationQueryable:function(a,b,c,d){typeof console!=="undefined"&&console.log&&console.log("Obsolate: _generateServiceOperationQueryable, $data.EntityContext");for(var e=[],h=0;h<d.length;h++){var f={};f[d[h]]=Container.resolveType(Container.getTypeName(c[h]));e.push(f)}return $data.EntityContext.generateServiceOperation({serviceName:a,returnType:$data.Queryable,elementType:this[b].elementType,
params:e}).apply(this,c)},attach:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());return this.getEntitySetFromElementType(a.getType()).attach(a)},attachOrGet:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());return this.getEntitySetFromElementType(a.getType()).attachOrGet(a)},add:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());return this.getEntitySetFromElementType(a.getType()).add(a)},remove:function(a){a instanceof $data.EntityWrapper&&(a=a.getEntity());
return this.getEntitySetFromElementType(a.getType()).remove(a)}},{generateServiceOperation:function(a){var b;if(a.serviceMethod){b=a.returnType?Container.resolveType(a.returnType):{};b=b.isAssignableTo&&b.isAssignableTo($data.Queryable)?a.serviceMethod:function(){var b=arguments[arguments.length-1],c=new $data.PromiseHandler;if(typeof b==="function"){b=c.createCallback(b);arguments[arguments.length-1]=b}else{b=c.createCallback();arguments.push(b)}try{var d=a.serviceMethod.apply(this,arguments);d!==
void 0&&b.success(d)}catch(e){b.error(e)}return c.getPromise()}}else b=function(){var b=a.elementType?this.getEntitySetFromElementType(Container.resolveType(a.elementType)):null,c=null;if(a.params)for(var c=[],d=0;d<a.params.length;d++)for(var e in a.params[d])c.push(Container.createConstantExpression(arguments[d],Container.resolveType(a.params[d][e]),e));d=Container.createEntityContextExpression(this);e=this.getType().getMemberDefinition(a.serviceName);c=Container.createServiceOperationExpression(d,
Container.createMemberInfoExpression(e),c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}e=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=e;if(e===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};var c=[];if(a.params)for(var d=
0;d<a.params.length;d++){var e=a.params[d],h;for(h in e)c.push({name:h,type:e[h]})}$data.typeSystem.extend(b,a,{params:c});return b},_convertLogicalTypeNameToPhysical:function(a){return a+"_$db$"},_storageModelCache:{get:function(){if(!this.__storageModelCache)this.__storageModelCache={};return this.__storageModelCache},set:function(){}}});
...
$data.Class.defineEx("$data.EntitySet",[{type:$data.Queryable,params:[new ConstructorParameter(1)]}],null,{constructor:function(a,b,c,d,e){this.createNew=this[a.name]=this.elementType=this.defaultType=a;this.stateManager=new $data.EntityStateManager(this);this.collectionName=c;this.roles=e;for(var h in d)this[h]=d[h]},find:function(a,b){return this.single("it."+this.defaultType.memberDefinitions.getKeyProperties()[0].name+" == this.value",{value:a},b)},addNew:function(a){$data.typeSystem.createCallbackSetting(cb);
a=new this.createNew(a);this.entityContext.saveChanges(cb);return a},executeQuery:function(a,b){var c=$data.typeSystem.createCallbackSetting(b);this.entityContext.executeQuery(a,c)},getTraceString:function(a){return this.entityContext.getTraceString(a)},setContext:function(a){this.entitySetState=$data.entitySetState.active;this.entityContext=a;this.entityContext[this.schema.name]=this[this.schema.name]},_trackEntity:function(a){for(var b=this.entityContext.stateManager.trackedEntities,c=0;c<b.length;c++)if(b[c].data===
a)return;b.push({entitySet:this,data:a})},add:function(a){var b=a;a instanceof $data.EntityWrapper?b=a.getEntity():a instanceof this.createNew||(b=new this.createNew(a));b.entityState=$data.EntityState.Added;b.changedProperties=void 0;b.context=this.entityContext;this._trackEntity(b)},remove:function(a){var b=a;a instanceof $data.EntityWrapper?b=a.getEntity():a instanceof this.createNew||(b=new this.createNew(a));b.entityState=$data.EntityState.Deleted;b.changedProperties=void 0;this._trackEntity(b)},
attach:function(a){var b=a;a instanceof $data.EntityWrapper?b=a.getEntity():a instanceof this.createNew||(b=new this.createNew(a));for(a=0;a<this.entityContext.stateManager.trackedEntities.length;a++){var c=this.entityContext.stateManager.trackedEntities[a];if(c.data===b)break;c.data.equals(b)&&Guard.raise(new Exception("Context already contains this entity!!!"))}b.entityState=$data.EntityState.Unchanged;b.changedProperties=void 0;b.context=this.entityContext;this._trackEntity(b)},detach:function(a){var b=
a;a instanceof $data.EntityWrapper?b=a.getEntity():a instanceof this.createNew||(b=new this.createNew(a));for(var c,d=this.entityContext.stateManager.trackedEntities,e=0;e<d.length;e++)d[e].data.equals(b)&&(c=d[e]);if(c){b=this.entityContext.stateManager.trackedEntities.indexOf(c);a.entityState=$data.EntityState.Detached;this.entityContext.stateManager.trackedEntities.splice(b,1)}},attachOrGet:function(a){var b=a;a instanceof $data.EntityWrapper?b=a.getEntity():a instanceof this.createNew||(b=new this.createNew(a));
for(var c,a=this.entityContext.stateManager.trackedEntities,d=0;d<a.length;d++)a[d].data.equals(b)&&(c=a[d]);if(c)return c.data;b.entityState=$data.EntityState.Unchanged;b.changedProperties=void 0;b.context=this.entityContext;this._trackEntity(b);return b},loadItemProperty:function(a,b,c){return this.entityContext.loadItemProperty(a,b,c)},expression:{get:function(){if(!this._expression){var a=Container.createEntityContextExpression(this.entityContext),b=this.entityContext.getType().getMemberDefinition(this.collectionName);
this._expression=Container.createEntitySetExpression(a,Container.createMemberInfoExpression(b),null,this)}return this._expression},set:function(a){this._expression=a}}},null);$data.EntityState={Detached:0,Unchanged:10,Added:20,Modified:30,Deleted:40};$data.Class.define("$data.EntityStateManager",null,null,{constructor:function(a){this.entityContext=null;this.trackedEntities=[];this.init(a)},init:function(a){this.entityContext=a},reset:function(){this.trackedEntities=[]}},null);
...
$data.FunctionImport.prototype={toServiceOperation:function(a){return new $data.FunctionImport(this.asFunction,a)},extend:function(a){for(var b in a)this[b]=a[b];return this},chain:function(a,b){var c=function(){var a=arguments.callee.chainFn,b=[];if(arguments.length)for(var c=0;c<arguments.length;c++)b.push(arguments[c]);var f=b.length,c=0,j=function(){if(b[b.length-1]&&b[b.length-1].success&&typeof b[b.length-1].success==="function")b[b.length-1].success.apply(this,arguments);else return arguments.length?
arguments[0]:void 0},k=function(){var s=a[c];c++;s=s.apply(this,b);if(typeof s==="function"){var o=arguments;b[f]=c<a.length?function(){return k.apply(this,o)}:function(){return j.apply(this,o)};s.apply(this,b)}else c<a.length?k.apply(this,arguments):j(this,arguments)};k()};if(!c.chainFn)c.chainFn=(a||[]).concat([this].concat(b||[]));return c},before:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.unshift(a);return b},after:function(a){var b=this;this.chainFn||(b=b.chain());b.chainFn.push(a);
return b},asResult:function(a,b){return this.extend({resultType:a,resultCfg:b})},returns:function(a,b){typeof a==="string"&&(a=Container.resolveType(a));typeof b==="string"&&(b=Container.resolveType(b));return this.extend({returnType:a,elementType:b})},params:function(a){return this.extend({params:a})},serviceName:function(a){return this.extend({serviceName:a})},httpMethod:function(a){return this.extend({method:a})},webGet:function(){return this.httpMethod("GET")},webInvoke:function(){return this.httpMethod("POST")},
authorize:function(a,b){var c={};if(a instanceof Array)for(var d=0;d<a.length;d++)typeof a[d]==="string"&&(c[a[d]]=true);else c=a;this.roles=c;var e=this;return ret=function(){var a=new $data.PromiseHandler,c=a.createCallback(b),a=a.getPromise(),d=arguments;c.success=c.success.after(function(){e.apply(this,d)});$data.Access.isAuthorized($data.Access.Execute,this.user,e.roles,c);return a}},toPromise:function(){return this}};
...
h||{},k=-1,s=0;s<a.length;s++)if(a[s].data==j){k=s;break}k==-1&&Guard.raise(new Exception("Dependent object not found","ObjectNotFound",e.dependentOn[f]));h[k]=true;from=c[k]||{};from[d]=true;c[k]=from}}h!==null&&(b[d]=h)}}d=[];e=[];for(h=0;h<a.length;h++)b.hasOwnProperty(h)||e.push(h);for(;e.length>0;){h=[].concat(e);e=[];for(f=0;f<h.length;f++){j=c[h[f]];if(typeof j!=="undefined")for(var o in j){delete b[o][h[f]];a:{k=b[o];s=void 0;for(s in k)if(k.hasOwnProperty(s)){k=true;break a}k=false}if(!k){delete b[o];
e.push(o)}}delete c[h[f]]}f=[];for(j=0;j<h.length;j++){k=a[h[j]];k.data.entityState!=$data.EntityState.Unchanged&&f.push(k)}f.length>0&&d.push(f)}return d},getTraceString:function(){Guard.raise("Pure class")},setContext:function(a){this.context=a},supportedFieldOperations:{value:{length:{dataType:"number",allowedIn:"filter, map"},substr:{dataType:"string",allowedIn:"filter",parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}]},toLowerCase:{dataType:"string"}},enumerable:!0,
