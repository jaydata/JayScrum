...
n,n.id)}for(;a<g.lbp;){i();n.led?c=n.led(c):k("expected_operator_a",n,n.id)}}return c}function Da(a,b){var c=Z[a];if(!c||typeof c!=="object")Z[a]=c={id:a,lbp:b,value:a};return c}function L(a){return Da(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Da(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;b.value=a;return oa(b)}function Q(a,b){var c=L(a);c.identifier=c.reserved=true;c.fud=b;return c}function Na(a,b){Q(a,b).labeled=true}function Oa(a,b){Q(a,b).disrupt=true}function sb(a){var b=
...
"%");aa("&=","&");aa("|=","|");aa("^=","^");aa("<<=","<<");aa(">>=",">>");aa(">>>=",">>>");O("{",function(){var a,b,c,d,e,j={};this.arity="prefix";this.first=[];this.type="object";for(G();g.id!=="}";){x.wrap=false;y();if(g.value==="get"&&q().id!==":"){l.es5||f("es5");a=g;i("get");R();d=g;(b=gb())||k("missing_property");a.value="";Ra(a);p["(loopage)"]&&f("function_loop",a);(c=a.first)&&f("parameter_a_get_b",c[0],c[0].value,b);B();e=g;e.value="";I();y();i("set");R();c=gb();b!==c&&k("expected_a_b",n,
b,c||g.value);Ra(e);c=e.first;!c||c.length!==1?k("parameter_set_a",e,"value"):c[0].value!=="value"&&k("expected_a_b",c[0],"value",c[0].value);d.first=[a,e]}else{d=g;b=gb();typeof b!=="string"&&k("missing_property");i(":");m();I();d.first=r(10)}this.first.push(d);j[b]===true&&f("duplicate_a",g,b);j[b]=true;Qa(b);if(g.id!==",")break;for(;;){B();if(g.id!==",")break;f("unexpected_a",g)}g.id==="}"&&!l.es5&&f("unexpected_a",n)}v("}",this);m();return this});Q("{",function(){m();f("statement_block");this.arity=
"statement";this.block=qa();this.disrupt=this.block.disrupt;i("}",this);m();return this});Q("/*global",ba);Q("/*globals",ba);Q("/*jslint",ba);Q("/*member",ba);Q("/*members",ba);Q("/*property",ba);Q("/*properties",ba);Q("var",function(){var a,b,c;p["(vars)"]&&!l.vars?f("combine_var"):p!==Y&&(p["(vars)"]=true);this.arity="statement";this.first=[];for(G("var");;){c=g;b=pa();F(c,"becoming");if(g.id==="="){a=g;a.first=c;I();i("=");I();g.id==="undefined"&&f("unnecessary_initialize",n,b);q(0).id==="="&&
g.identifier&&k("var_a_not");a.second=r(0);a.arity="infix";this.first.push(a);if(a.second.type)c.type=a.second.type}else this.first.push(c);p[b]==="becoming"&&(p[b]="unused");if(g.id!==",")break;B();x.wrap=false;if(ga&&g.line===n.line&&this.first.length===1){ga=null;x.open=false;x.at=x.at-l.indent}I();y()}ga=null;v();return this});Q("function",function(){z();Ea&&f("function_block",n);var a=g,b=pa();F(a,"unction");w();Ra(this,b);g.id==="("&&g.line===n.line&&k("function_statement");this.arity="statement";
return this});O("function",function(){z();var a=pa();a?w():a="";Ra(this,a);p["(loopage)"]&&f("function_loop");this.arity="function";return this});Q("if",function(){var a=g;z();i("(");G("control");m();w();y();this.arity="statement";this.first=da(ca(r(0)));w();v(")",a);m();z();this.block=ea(true);if(g.id==="else"){z();i("else");m();z();this["else"]=g.id==="if"||g.id==="switch"?eb(true):ea(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});Q("try",function(){var a,b,c;
...
b.arity="case";y("case");i("default");m();C();i(":");m();I();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];if(c&&a.disrupt&&a.id!=="break")this.disrupt=true}this.second.push(b)}p["(breakage)"]=p["(breakage)"]-1;I();v("}",this);return this});Q("debugger",function(){l.debug||f("unexpected_a",this);this.arity="statement";return this});Na("do",function(){p["(breakage)"]=p["(breakage)"]+1;p["(loopage)"]=p["(loopage)"]+1;z();this.arity="statement";this.block=ea(true);this.block.disrupt&&
...
a;p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});Oa("break",function(){var a=g.value;this.arity="statement";p["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){R();p[a]!=="label"?f("not_a_label",g):E[a].funct!==p&&f("not_a_scope",g);this.first=g;i()}return this});Oa("continue",function(){l["continue"]||f("unexpected_a",this);var a=g.value;this.arity="statement";p["(breakage)"]===0&&f("unexpected_a",this);if(g.identifier&&n.line===g.line){R();
p[a]!=="label"?f("not_a_label",g):E[a].funct!==p&&f("not_a_scope",g);this.first=g;i()}return this});Oa("return",function(){this.arity="statement";if(g.id!==";"&&g.line===n.line){R();(g.id==="/"||g.id==="(regexp)")&&f("wrap_regexp");this.first=r(20)}return this});Oa("throw",function(){this.arity="statement";R();this.first=r(20);return this});D("class");D("const");D("enum");D("export");D("extends");D("import");D("super");D("let");D("yield");D("implements");D("interface");D("package");D("private");D("protected");
...
[];v[o].modifyAll.push(d)}break;case $data.EntityState.Deleted:c=c|$data.Access.Delete;if(h.beforeDelete){if(!v[o].deleteAll)v[o].deleteAll=[];v[o].deleteAll.push(d)}}}}var z=function(a){if(a){R="async";b.length=0}b.length?G.storageProvider.saveChanges({success:function(){G._postProcessSavedItems(e,b)},error:e.error},b):e.error(new Exception("Cancelled event in "+R,"CancelEvent"))},R,w=Object.getOwnPropertyNames(v),f=0,C=["beforeUpdate","beforeDelete","beforeCreate"],I={beforeCreate:"createAll",beforeDelete:"deleteAll",
beforeUpdate:"modifyAll"},B=function(a){if(a){R="async";b.length=0;z(a)}else{var c=G._entitySetReferences[w[f]],d=C.pop();if(a=v[w[f]][I[d]]){for(var e=[],h=0;h<a.length;h++)e.push(a[h].data);if(!C.length){C=["beforeUpdate","beforeDelete","beforeCreate"];f++}h=c[d].call(G,e);if(typeof h==="function")h.call(G,f<w.length&&!R?B:z,e);else if(h===false){R=c.name+"."+d;for(c=0;c<a.length;c++){d=b.indexOf(a[c]);b.splice(d,1)}z()}else f<w.length&&!R?B():z()}else{if(!C.length){C=["beforeUpdate","beforeDelete",
"beforeCreate"];f++}f<w.length&&!R?B():z()}}};this.user&&this.checkPermission?this.checkPermission(c,this.user,w,{success:function(){f<w.length?B():z()},error:e.error}):f<w.length?B():z();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);for(var c={},d=this,e=0;e<b.length;e++){var h=b[e],f=h.data.entityState;h.data.entityState=$data.EntityState.Unchanged;
h.data.changedProperties=[];h.physicalData=void 0;var j=h.entitySet.elementType.name,k=d._entitySetReferences[j],s=void 0;switch(f){case $data.EntityState.Added:s="added";break;case $data.EntityState.Deleted:s="deleted";break;case $data.EntityState.Modified:s="updated"}s&&this.raiseEvent(s,h);if(k.afterCreate||k.afterUpdate||k.afterDelete){c[j]||(c[j]={});switch(f){case $data.EntityState.Added:if(k.afterCreate){if(!c[j].createAll)c[j].createAll=[];c[j].createAll.push(h)}break;case $data.EntityState.Modified:if(k.afterUpdate){if(!c[j].modifyAll)c[j].modifyAll=
[];c[j].modifyAll.push(h)}break;case $data.EntityState.Deleted:if(k.afterDelete){if(!c[j].deleteAll)c[j].deleteAll=[];c[j].deleteAll.push(h)}}}}var o=Object.getOwnPropertyNames(c),e=0,d=this,A=["afterUpdate","afterDelete","afterCreate"],F={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},q=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},m=function(){var a=d._entitySetReferences[o[e]],b=A.pop(),f=c[o[e]][F[b]];if(f){for(var h=[],j=0;j<f.length;j++)h.push(f[j].data);
if(!A.length){A=["afterUpdate","afterDelete","afterCreate"];e++}a=a[b].call(d,h);typeof a==="function"?a.call(d,e<o.length?m:q,h):e<o.length?m():q()}else{if(!A.length){A=["afterUpdate","afterDelete","afterCreate"];e++}e<o.length?m():q()}};e<o.length?m():q()},forEachEntitySet:function(a,b){for(var c in this._entitySetReferences)a.call(b,this._entitySetReferences[c])},loadItemProperty:function(a,b,c){Guard.requireType("entity",a,$data.Entity);b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):
b;if(a[b.name]!=void 0){var d=new $data.PromiseHandler;callBack=d.createCallback(c);c.success(a[b.name]);return d.getPromise()}var e=true,d=this._storageModel.getStorageModel(a.getType().fullName),h=Container.resolveType(b.dataType);if(h===$data.Array||h.isAssignableTo&&h.isAssignableTo($data.EntitySet)){h=Container.resolveType(b.elementType);e=false}else{for(var f,j=0;j<d.Associations.length;j++){var k=d.Associations[j];if(k.FromPropertyName==b.name){f=k;break}}f&&f.FromMultiplicity==="0..1"&&f.ToMultiplicity===
"1"&&(e=false)}f=d.LogicalType.memberDefinitions.getKeyProperties();if(e===true){e="function (e) { return";j={};for(k=0;k<f.length;k++){var s=f[k];k>0&&(e=e+" &&");e=e+(" e."+s.name+" == this.key"+k);j["key"+k]=a[s.name]}return d.EntitySetReference.map("function (e) { return e."+b.name+" }").single(e+"; }",j,c)}e="function (e) { return";j={};for(k=0;k<f.length;k++){s=f[k];k>0&&(e=e+" &&");e=e+(" e."+b.inverseProperty+"."+s.name+" == this.key"+k);j["key"+k]=a[s.name]}return this.getEntitySetFromElementType(h).filter(e+
"; }",j).toArray(c)},getTraceString:function(a){return this.storageProvider.getTraceString(new $data.Query(a.expression,a.defaultType,this))},log:function(){},resolveBinaryOperator:function(a,b,c){return this.storageProvider.resolveBinaryOperator(a,b,c)},resolveUnaryOperator:function(a,b,c){return this.storageProvider.resolveUnaryOperator(a,b,c)},resolveFieldOperation:function(a,b,c){return this.storageProvider.resolveFieldOperation(a,b,c)},resolveSetOperations:function(a,b,c){return this.storageProvider.resolveSetOperations(a,
