...
return}c=a.result[0]}else if(a.expression.nodeType===$data.Expressions.ExpressionType.First){if(a.result.length===0){b.error(new Exception("result count failed"));return}c=a.result[0]}else c=a.result;var e=function(){b.success(c)},g=0,h=a.getEntitySets(),i=function(){var b=h[g];if(b.afterRead){g++;b=b.afterRead.call(this,c,h,a);typeof b==="function"?b.call(this,g<h.length?i:e,c,h,a):g<h.length?i():e()}else e()};h.length?i():e()}};e.error=b.error;var i=c.getEntitySets(),g=true,j=this,m=function(a){a===
...
new XMLHttpRequest:window.ActiveXObject?new ActiveXObject("MsXml2.XmlHttp"):void 0;c.onreadystatechange=function(){if(c.readyState==4)if(c.status==200||c.status==304){eval(c.responseText);typeof b==="function"&&b(true)}else typeof b==="function"&&b(false)};c.open("GET",a,true);c.send(null)}(function(a){switch(a){case "storm":a="Storm"}return"providers/"+a+"Provider.js"}(c),function(d){var i=$data.RegisteredStorageProviders[c];if(d&&i){i=$data.RegisteredStorageProviders[c];b.success(i)}else a.length>
0?this.load(a,b):b.error()}):this.load(a,b)}};$data.storageProviders={DbCreationType:{Merge:10,DropTableIfChanged:20,DropAllExistingTables:30}};$data.ConcurrencyMode={Fixed:"fixed",None:"nonde"};
